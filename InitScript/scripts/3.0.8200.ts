            ...
            for (const up of monitor.criteria.up) {
                if (
                    ...
                    if (up.and.and && up.and.and.length > 0) {
                        ...
                        up.and.and.forEach((and: $TSFixMe) => {
                            and.forEach((obj: $TSFixMe) => {
                                if (obj.collection) {
                                    if (
                                        obj.collection.and &&
            ...
            for (const down of monitor.criteria.down) {
                if (
                    ...
                    if (down.and.and && down.and.and.length > 0) {
                        ...
                        down.and.and.forEach((and: $TSFixMe) => {
                            and.forEach((obj: $TSFixMe) => {
                                if (obj.collection) {
                                    if (
                                        obj.collection.and &&
            ...
            for (const degraded of monitor.criteria.degraded) {
                if (
                    ...
                    if (degraded.and.and && degraded.and.and.length > 0) {
                        ...
                        degraded.and.and.forEach((and: $TSFixMe) => {
                            and.forEach((obj: $TSFixMe) => {
                                if (obj.collection) {
                                    if (
                                        obj.collection.and &&
                    ...
                    if (degraded.or.or && degraded.or.or.length > 0) {
                        ...
                        degraded.or.or.forEach((or: $TSFixMe) => {
                            or.forEach((obj: $TSFixMe) => {
                                if (obj.collection) {
                                    if (
                                        obj.collection.or &&
