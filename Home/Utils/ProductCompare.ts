  ...
  pagerduty: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "PagerDuty needs a separate monitoring solution that you need to buy which then sends data to PagerDuty for on-call and incident management. OneUptime has a built in monitoring solution as well. You use one product, your team has one dashboard, save time, simplify ops.",
      },
      {
        question:
    ...
    items: [
      ...
      },
      {
        ...
        data: [
          {
            title: "Integrations",
            description: "Integrate OneUptime with more than 2000+ apps.",
    ...
    faq: [
      {
        ...
        answer:
          "StatusPage.io is a status page tool whereas OneUptime is a complete Observability platform. OneUptime offers mostly everything that StatusPage.io offers, but a lot more like monitoring, incident management, on-call scheduling, security, performance-monitoring and more. Please check detailed comparision above for more info.",
      },
      {
        question:
          "Do I need to buy a monitoring solution to monitor my resources?",
        answer:
          "StatusPage.io needs a separate monitoring solution that you need to buy which then sends data to StatusPage.io. OneUptime has a built in monitoring solution as well. You use one product, your team has one dashboard, save time, simplify ops.",
      },
      {
        question:
          "I have already bought an external monitoring solution. Will OneUptime work with it?",
    ...
    faq: [
      {
        ...
        answer:
          "Pingdom is an monitoring tool whereas OneUptime is a complete Observability platform. OneUptime offers mostly everything that Pingdom offers, but a lot more like monitoring, StatusPage, security, performance-monitoring and more. Please check detailed comparision above for more info.",
      },
      {
        question:
          "Do I need to buy an incident management and on-call solution for alerts?",
        answer:
          "Pingdom is a monitoring solution and you need to buy an on-call solution and incident management solution which Pingdom sends data to. OneUptime has a built in monitoring, on-call and incident management. You use one product, your team has one dashboard, save time, simplify ops.",
      },
      {
        question:
    ...
    faq: [
      ...
      },
      {
        question:
          "Do I need to buy an incident management and on-call solution for alerts?",
        answer:
          "Incident.io is a incident management solution and you need to buy an on-call solution and monitoring solution which Incident.io receives data from. OneUptime has a built in monitoring, on-call and incident management. You use one product, your team has one dashboard, save time, simplify ops.",
      },
      {
        question:
