  ...
  xmatters: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes. OneUptime provides workflows, a REST API, native webhooks, and 2000+ integrations via Zapier to reproduce alert routing and toolchain automation, plus an AI Copilot to help configure them.",
      },
      {
