  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function c(t, e, n) {
        S(t).add(
          "switch",
          "switch-" + (C.includes(e.size) ? e.size : "default"),
          e.checked ? j : M,
        ),
          h.call(n),
          a.call(n),
      ...
      function a() {
        this._el.checked
          ? ((this._switch.style.boxShadow =
              "inset 0 0 0 " +
              this._switch.clientHeight / 1.8 +
              "px " +
              this._options.onSwitchColor),
            (this._switch.style.border =
              "1px solid " + this._options.onSwitchColor),
            (this._switch.style.transition =
              "border 0.4s, box-shadow 0.4s, background-color 1.4s"),
          ...
          : ((this._switch.style.boxShadow =
            ...
            (this._switch.style.border = "1px solid " + O),
      ...
      function h() {
        this._options.showText &&
          (this._jack.innerHTML = this._el.checked
            ? this._options.onText
            : this._options.offText);
      }
      function p(t, e) {
        return e
      ...
      var E = n(87),
        ...
        T = {
          ...
          changeSwitchStateFromKeyboard: function (t) {
            ...
            this._instance._options.disabled ||
              (13 === e && this._instance._toggle());
          },
        },
        O = "#dfdfdf",
        j = "switch-on",
        ...
        (r.prototype.remove = function () {
          ...
          try {
            this._el.setAttribute(
              ...
              this._el
                .getAttribute("style")
                .replace(/\s*display:\s*none;/g, ""),
            );
          } catch (t) {}
          this._switch.parentNode &&
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, _, m, w, k) {
        ...
        if (
          ...
          if (
            ((x = { values: T ? A : S(y), keys: w ? A : S(v), entries: L }), k)
          )
    ...
    function (t, e, n) {
      ...
      n(21)(c, n(48)("iterator"), function () {
        ...
        (t.exports = function (t, e, n) {
          (t.prototype = o(c, { next: r(1, n) })), i(t, e + " Iterator");
        });
    },
    function (t, e, n) {
      var o = n(23),
        ...
        a = function () {
          ...
          for (
            e.style.display = "none",
              ...
              t.open(),
              t.write(
                r + "script" + c + "document.F=Object" + r + "/script" + c,
              ),
              t.close(),
              a = t.F;
            o--;
      ...
      t.exports =
        ...
        function (t, e) {
          ...
          return (
            null !== t
              ? ((s[u] = o(t)), (n = new s()), (s[u] = null), (n[c] = t))
              : (n = a()),
            void 0 === e ? n : r(n, e)
          );
        };
    ...
    function (t, e, n) {
      ...
      t.exports = n(26)
        ...
        : function (t, e) {
            r(t);
            for (var n, c = i(e), s = c.length, u = 0; s > u; )
              o.f(t, (n = c[u++]), e[n]);
            return t;
          };
    },
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        return void 0 === t
          ...
          : null === t
            ? "Null"
            : "string" == typeof (n = c((e = Object(t)), r))
              ? n
              : i
                ? o(e)
            ...
            ? ((w = e(function (e, n) {
              ...
              d(
                ...
                function (t) {
                  ...
                  t in x &&
                    (!_ || "clear" != t) &&
                    s(w.prototype, t, function (n, o) {
                      if ((f(this, w, t), !e && _ && !l(n)))
                        return "get" == t && void 0;
          ...
          (r.prototype.onTouchEnd = function (t) {
            ...
            if (
              ...
              a &&
                ...
                (f.fastClickScrollParent =
                  this.targetElement.fastClickScrollParent)),
              (o = f.tagName.toLowerCase()),
              "label" === o)
            ) {
            ...
            return (
              !(
                !s ||
                u ||
                ((r = f.fastClickScrollParent),
                !r || r.fastClickLastScrollTop === r.scrollTop)
              ) ||
              (this.needsClick(f) || (t.preventDefault(), this.sendClick(f, t)),
              !1)
            );
          }),
    ...
    function (t, e, n) {
      ...
      (o.prototype.add = function () {
        ...
        for (e = 0; e < arguments.length; e += 1)
          (t = "" + arguments[e]), r(this, t) >= 0 || c.push.call(this, t);
        ...
        (o.prototype.toggle = function (t, e) {
          return (
            ...
            e === !0
              ...
              : e === !1
                ? this.remove(t)
                : this[this.contains(t) ? "remove" : "add"](t)
          );
        }),
