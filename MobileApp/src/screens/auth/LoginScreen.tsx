        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Sign in with your fingerprint, face, or device PIN. A secure
              ...
              {isPasskeyLoading && passkeyProgress !== "verifying" ? (
                ...
                >
                  <Text
                    style={{ color: theme.colors.actionPrimary, fontSize: 14 }}
                  >
                    Cancel
                  </Text>
                </TouchableOpacity>
              ...
              >
                <Text
                  style={{ fontSize: 14, color: theme.colors.actionPrimary }}
                >
                  New to passkeys?
                </Text>
              </TouchableOpacity>
              {showPasskeyHelp ? (
                ...
                >
                  Sign in on the OneUptime website with your password or SSO. In
                  your profile, open Passkeys &amp; Two Factor Auth to add a
                  passkey. Use that passkey here on the same server.
                </Text>
              ) : null}
            </View>
