#
# OneUptime-TelemetryIngestor Dockerfile
#
...
COPY ./TelemetryIngestor/package*.json /usr/src/app/
RUN npm install

# Expose ports.
#   - 3674: OneUptime-TelemetryIngestor
EXPOSE 3674
...
{{ else }}
# Copy app source
COPY ./TelemetryIngestor /usr/src/app
# Bundle app source
RUN npm run compile
#Run the app
CMD [ "npm", "start" ]
