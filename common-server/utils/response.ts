...
function logResponse(req: express.Request,
    res: express.Response, responsebody: $TSFixMe) {
...
export const sendEmptyResponse = (req: express.Request, res: express.Response) => {
