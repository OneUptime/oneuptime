...
const init: PromiseVoidFunction = async (): Promise<void> => {
  try {
    ...
    logger.info(
      `Probe Service - Monitoring workers: ${PROBE_MONITORING_WORKERS}, Monitor fetch limit: ${PROBE_MONITOR_FETCH_LIMIT}, Monitor fetch interval: ${PROBE_MONITOR_FETCH_INTERVAL_IN_SECONDS}s, Script timeout: ${PROBE_SYNTHETIC_MONITOR_SCRIPT_TIMEOUT_IN_MS}ms / ${PROBE_CUSTOM_CODE_MONITOR_SCRIPT_TIMEOUT_IN_MS}ms, Retry limit: ${PROBE_MONITOR_RETRY_LIMIT}`,
    );
