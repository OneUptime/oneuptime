...
@CrudApiEndpoint(new Route('/blocked-team-permission'))
@Entity({
    name: 'BlockedTeamPermission',
})
@EnableWorkflow({
    create: true,
    delete: true,
...
@TableMetadata({
    tableName: 'BlockedTeamPermission',
    singularName: 'BlockedTeam Permission',
    pluralName: 'BlockedTeam Permissions',
    icon: IconProp.Lock,
    tableDescription: 'Blocked Permissions for your OneUptime team',
})
export default class BlockedTeamPermission extends BaseModel {
    @ColumnAccessControl({
        create: [
            Permission.ProjectOwner,
            Permission.ProjectAdmin,
