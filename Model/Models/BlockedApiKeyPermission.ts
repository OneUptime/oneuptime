...
@CrudApiEndpoint(new Route('/blocked-api-key-permission'))
@Entity({
    name: 'BlockedApiKeyPermission',
})
@TableMetadata({
    tableName: 'BlockedApiKeyPermission',
    singularName: 'Blocked API Key Permission',
    pluralName: 'Blocked API Key Permissions',
    icon: IconProp.Lock,
    tableDescription: 'Blocked Permissions for your API Keys',
})
