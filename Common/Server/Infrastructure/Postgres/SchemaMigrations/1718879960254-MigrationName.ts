...
export class MigrationName1718879960254 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2333094e9d86acd253c95f55c5" ON "CopilotAction" ("projectId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d1f62129e09784b750ef9143bf" ON "CopilotAction" ("codeRepositoryId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2ffc457556fee646554bea0577" ON "CopilotAction" ("serviceCatalogId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_786400c4dce05f85bbbd524424" ON "CopilotAction" ("serviceRepositoryId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "CopilotAction" ADD CONSTRAINT "FK_2333094e9d86acd253c95f55c5b" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "CopilotAction" ADD CONSTRAINT "FK_2ffc457556fee646554bea05771" FOREIGN KEY ("serviceCatalogId") REFERENCES "ServiceCatalog"("_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "CopilotAction" DROP CONSTRAINT "FK_2ffc457556fee646554bea05771"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "CopilotAction" DROP CONSTRAINT "FK_2333094e9d86acd253c95f55c5b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_786400c4dce05f85bbbd524424"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2ffc457556fee646554bea0577"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d1f62129e09784b750ef9143bf"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2333094e9d86acd253c95f55c5"`,
    );
