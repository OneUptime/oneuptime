...
export class MigrationName1765834537501 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "LlmLog" ADD "totalTokens" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "LlmLog" DROP COLUMN "totalTokens"`);
        await queryRunner.query(`ALTER TABLE "LlmLog" ADD "totalTokens" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "LlmLog" ADD "outputTokens" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "LlmLog" ADD "inputTokens" integer NOT NULL DEFAULT '0'`);
    }
