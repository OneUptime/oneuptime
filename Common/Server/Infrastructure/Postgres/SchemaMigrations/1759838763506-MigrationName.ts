...
export class MigrationName1759838763506 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" DROP COLUMN "whatsAppText"`);
        ...
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" ALTER COLUMN "whatsAppCostInUSDCents" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" ALTER COLUMN "whatsAppCostInUSDCents" SET DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "UserWhatsApp" ALTER COLUMN "verificationCode" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_98e71cf97956e7938195be8451" ON "WhatsAppLog" ("whatsAppCostInUSDCents") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_98e71cf97956e7938195be8451"`);
        await queryRunner.query(`ALTER TABLE "UserWhatsApp" ALTER COLUMN "verificationCode" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" ALTER COLUMN "whatsAppCostInUSDCents" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" ALTER COLUMN "whatsAppCostInUSDCents" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "OnCallDutyPolicyScheduleLayer" ALTER COLUMN "restrictionTimes" SET DEFAULT '{"_type": "RestrictionTimes", "value": {"restictionType": "None", "dayRestrictionTimes": null, "weeklyRestrictionTimes": []}}'`);
        await queryRunner.query(`ALTER TABLE "OnCallDutyPolicyScheduleLayer" ALTER COLUMN "rotation" SET DEFAULT '{"_type": "Recurring", "value": {"intervalType": "Day", "intervalCount": {"_type": "PositiveNumber", "value": 1}}}'`);
        ...
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" DROP COLUMN "messageText"`);
        await queryRunner.query(`ALTER TABLE "Project" DROP COLUMN "enableWhatsAppNotifications"`);
        await queryRunner.query(`ALTER TABLE "WhatsAppLog" ADD "whatsAppText" character varying(500) NOT NULL`);
    }
