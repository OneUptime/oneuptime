...
export class MigrationName1759839342566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "GlobalConfig" ADD "metaWhatsAppAccessToken" text`);
        ...
        await queryRunner.query(`ALTER TABLE "GlobalConfig" ADD "metaWhatsAppAppSecret" text`);
