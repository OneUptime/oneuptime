...
export class MigrationName1781545058502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "PodmanHost" DROP CONSTRAINT "FK_podman_host_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHost" DROP CONSTRAINT "FK_podman_host_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHost" DROP CONSTRAINT "FK_podman_host_deletedByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_team_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_team_teamId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_team_podmanHostId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_team_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_team_deletedByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_user_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_user_userId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_user_podmanHostId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_user_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_user_deletedByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" DROP CONSTRAINT "FK_podman_resource_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" DROP CONSTRAINT "FK_podman_resource_podmanHostId"`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" DROP CONSTRAINT "FK_podman_resource_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" DROP CONSTRAINT "FK_podman_resource_deletedByUserId"`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" DROP CONSTRAINT "FK_podman_host_owner_rule_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" DROP CONSTRAINT "FK_podman_host_owner_rule_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" DROP CONSTRAINT "FK_podman_host_owner_rule_deletedByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" DROP CONSTRAINT "FK_podman_host_label_rule_projectId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" DROP CONSTRAINT "FK_podman_host_label_rule_createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" DROP CONSTRAINT "FK_podman_host_label_rule_deletedByUserId"`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostLabel" DROP CONSTRAINT "FK_podman_host_label_podmanHostId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabel" DROP CONSTRAINT "FK_podman_host_label_labelId"`);
        ...
        await queryRunner.query(`ALTER TABLE "IncidentPodmanHost" DROP CONSTRAINT "FK_incident_podman_host_incident"`);
        await queryRunner.query(`ALTER TABLE "IncidentPodmanHost" DROP CONSTRAINT "FK_incident_podman_host_podmanHost"`);
        ...
        await queryRunner.query(`ALTER TABLE "IncidentPodmanResource" DROP CONSTRAINT "FK_incident_podman_resource_incident"`);
        await queryRunner.query(`ALTER TABLE "IncidentPodmanResource" DROP CONSTRAINT "FK_incident_podman_resource_podmanResource"`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanHost" DROP CONSTRAINT "FK_alert_podman_host_alert"`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanHost" DROP CONSTRAINT "FK_alert_podman_host_podmanHost"`);
        ...
        await queryRunner.query(`ALTER TABLE "AlertPodmanResource" DROP CONSTRAINT "FK_alert_podman_resource_alert"`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanResource" DROP CONSTRAINT "FK_alert_podman_resource_podmanResource"`);
        await queryRunner.query(`ALTER TABLE "ScheduledMaintenancePodmanHost" DROP CONSTRAINT "FK_scheduled_maintenance_podman_host_sm"`);
        await queryRunner.query(`ALTER TABLE "ScheduledMaintenancePodmanHost" DROP CONSTRAINT "FK_scheduled_maintenance_podman_host_podmanHost"`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRulePodmanHostLabel" DROP CONSTRAINT "FK_podman_host_owner_rule_label_ruleId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRulePodmanHostLabel" DROP CONSTRAINT "FK_podman_host_owner_rule_label_labelId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_rule_owner_user_ruleId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerUser" DROP CONSTRAINT "FK_podman_host_owner_rule_owner_user_userId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_rule_owner_team_ruleId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerTeam" DROP CONSTRAINT "FK_podman_host_owner_rule_owner_team_teamId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRulePodmanHostLabel" DROP CONSTRAINT "FK_podman_host_label_rule_label_ruleId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRulePodmanHostLabel" DROP CONSTRAINT "FK_podman_host_label_rule_label_labelId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRuleLabelToAdd" DROP CONSTRAINT "FK_podman_host_label_rule_label_to_add_ruleId"`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRuleLabelToAdd" DROP CONSTRAINT "FK_podman_host_label_rule_label_to_add_labelId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_hostIdentifier"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_slug"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_team_projectId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_team_teamId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_team_podmanHostId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_team_isOwnerNotified"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_user_projectId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_user_userId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_user_podmanHostId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_user_isOwnerNotified"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_resource_projectId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_resource_podmanHostId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_resource_projectId_podmanHostId_kind_name"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_projectId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_name"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_isEnabled"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_projectId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_name"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_isEnabled"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_podmanHostId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_labelId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_incident_podman_host_incidentId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_incident_podman_host_podmanHostId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_incident_podman_resource_incidentId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_incident_podman_resource_podmanResourceId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_alert_podman_host_alertId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_alert_podman_host_podmanHostId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_alert_podman_resource_alertId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_alert_podman_resource_podmanResourceId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_scheduled_maintenance_podman_host_smId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_scheduled_maintenance_podman_host_podmanHostId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_label_ruleId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_label_labelId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_owner_user_ruleId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_owner_user_userId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_owner_team_ruleId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_owner_rule_owner_team_teamId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_label_ruleId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_label_labelId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_label_to_add_ruleId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_podman_host_label_rule_label_to_add_labelId"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_label_to_add_labelId" ON "PodmanHostLabelRuleLabelToAdd" ("labelId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_label_to_add_ruleId" ON "PodmanHostLabelRuleLabelToAdd" ("podmanHostLabelRuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_label_labelId" ON "PodmanHostLabelRulePodmanHostLabel" ("labelId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_label_ruleId" ON "PodmanHostLabelRulePodmanHostLabel" ("podmanHostLabelRuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_owner_team_teamId" ON "PodmanHostOwnerRuleOwnerTeam" ("teamId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_owner_team_ruleId" ON "PodmanHostOwnerRuleOwnerTeam" ("podmanHostOwnerRuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_owner_user_userId" ON "PodmanHostOwnerRuleOwnerUser" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_owner_user_ruleId" ON "PodmanHostOwnerRuleOwnerUser" ("podmanHostOwnerRuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_label_labelId" ON "PodmanHostOwnerRulePodmanHostLabel" ("labelId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_label_ruleId" ON "PodmanHostOwnerRulePodmanHostLabel" ("podmanHostOwnerRuleId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_scheduled_maintenance_podman_host_podmanHostId" ON "ScheduledMaintenancePodmanHost" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_scheduled_maintenance_podman_host_smId" ON "ScheduledMaintenancePodmanHost" ("scheduledMaintenanceId") `);
        await queryRunner.query(`CREATE INDEX "IDX_alert_podman_resource_podmanResourceId" ON "AlertPodmanResource" ("podmanResourceId") `);
        await queryRunner.query(`CREATE INDEX "IDX_alert_podman_resource_alertId" ON "AlertPodmanResource" ("alertId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_alert_podman_host_podmanHostId" ON "AlertPodmanHost" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_alert_podman_host_alertId" ON "AlertPodmanHost" ("alertId") `);
        await queryRunner.query(`CREATE INDEX "IDX_incident_podman_resource_podmanResourceId" ON "IncidentPodmanResource" ("podmanResourceId") `);
        await queryRunner.query(`CREATE INDEX "IDX_incident_podman_resource_incidentId" ON "IncidentPodmanResource" ("incidentId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_incident_podman_host_podmanHostId" ON "IncidentPodmanHost" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_incident_podman_host_incidentId" ON "IncidentPodmanHost" ("incidentId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_labelId" ON "PodmanHostLabel" ("labelId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_podmanHostId" ON "PodmanHostLabel" ("podmanHostId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_isEnabled" ON "PodmanHostLabelRule" ("isEnabled") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_name" ON "PodmanHostLabelRule" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_label_rule_projectId" ON "PodmanHostLabelRule" ("projectId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_isEnabled" ON "PodmanHostOwnerRule" ("isEnabled") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_name" ON "PodmanHostOwnerRule" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_rule_projectId" ON "PodmanHostOwnerRule" ("projectId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_podman_resource_projectId_podmanHostId_kind_name" ON "PodmanResource" ("projectId", "podmanHostId", "kind", "name") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_resource_podmanHostId" ON "PodmanResource" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_resource_projectId" ON "PodmanResource" ("projectId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_user_isOwnerNotified" ON "PodmanHostOwnerUser" ("isOwnerNotified") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_user_podmanHostId" ON "PodmanHostOwnerUser" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_user_userId" ON "PodmanHostOwnerUser" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_user_projectId" ON "PodmanHostOwnerUser" ("projectId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_team_isOwnerNotified" ON "PodmanHostOwnerTeam" ("isOwnerNotified") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_team_podmanHostId" ON "PodmanHostOwnerTeam" ("podmanHostId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_team_teamId" ON "PodmanHostOwnerTeam" ("teamId") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_owner_team_projectId" ON "PodmanHostOwnerTeam" ("projectId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_podman_host_slug" ON "PodmanHost" ("slug") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_hostIdentifier" ON "PodmanHost" ("hostIdentifier") `);
        await queryRunner.query(`CREATE INDEX "IDX_podman_host_projectId" ON "PodmanHost" ("projectId") `);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRuleLabelToAdd" ADD CONSTRAINT "FK_podman_host_label_rule_label_to_add_labelId" FOREIGN KEY ("labelId") REFERENCES "Label"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRuleLabelToAdd" ADD CONSTRAINT "FK_podman_host_label_rule_label_to_add_ruleId" FOREIGN KEY ("podmanHostLabelRuleId") REFERENCES "PodmanHostLabelRule"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRulePodmanHostLabel" ADD CONSTRAINT "FK_podman_host_label_rule_label_labelId" FOREIGN KEY ("labelId") REFERENCES "Label"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRulePodmanHostLabel" ADD CONSTRAINT "FK_podman_host_label_rule_label_ruleId" FOREIGN KEY ("podmanHostLabelRuleId") REFERENCES "PodmanHostLabelRule"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_rule_owner_team_teamId" FOREIGN KEY ("teamId") REFERENCES "Team"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_rule_owner_team_ruleId" FOREIGN KEY ("podmanHostOwnerRuleId") REFERENCES "PodmanHostOwnerRule"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_rule_owner_user_userId" FOREIGN KEY ("userId") REFERENCES "User"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRuleOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_rule_owner_user_ruleId" FOREIGN KEY ("podmanHostOwnerRuleId") REFERENCES "PodmanHostOwnerRule"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRulePodmanHostLabel" ADD CONSTRAINT "FK_podman_host_owner_rule_label_labelId" FOREIGN KEY ("labelId") REFERENCES "Label"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRulePodmanHostLabel" ADD CONSTRAINT "FK_podman_host_owner_rule_label_ruleId" FOREIGN KEY ("podmanHostOwnerRuleId") REFERENCES "PodmanHostOwnerRule"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "ScheduledMaintenancePodmanHost" ADD CONSTRAINT "FK_scheduled_maintenance_podman_host_podmanHost" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ScheduledMaintenancePodmanHost" ADD CONSTRAINT "FK_scheduled_maintenance_podman_host_sm" FOREIGN KEY ("scheduledMaintenanceId") REFERENCES "ScheduledMaintenance"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanResource" ADD CONSTRAINT "FK_alert_podman_resource_podmanResource" FOREIGN KEY ("podmanResourceId") REFERENCES "PodmanResource"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanResource" ADD CONSTRAINT "FK_alert_podman_resource_alert" FOREIGN KEY ("alertId") REFERENCES "Alert"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "AlertPodmanHost" ADD CONSTRAINT "FK_alert_podman_host_podmanHost" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "AlertPodmanHost" ADD CONSTRAINT "FK_alert_podman_host_alert" FOREIGN KEY ("alertId") REFERENCES "Alert"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "IncidentPodmanResource" ADD CONSTRAINT "FK_incident_podman_resource_podmanResource" FOREIGN KEY ("podmanResourceId") REFERENCES "PodmanResource"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "IncidentPodmanResource" ADD CONSTRAINT "FK_incident_podman_resource_incident" FOREIGN KEY ("incidentId") REFERENCES "Incident"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "IncidentPodmanHost" ADD CONSTRAINT "FK_incident_podman_host_podmanHost" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "IncidentPodmanHost" ADD CONSTRAINT "FK_incident_podman_host_incident" FOREIGN KEY ("incidentId") REFERENCES "Incident"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostLabel" ADD CONSTRAINT "FK_podman_host_label_labelId" FOREIGN KEY ("labelId") REFERENCES "Label"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabel" ADD CONSTRAINT "FK_podman_host_label_podmanHostId" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" ADD CONSTRAINT "FK_podman_host_label_rule_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" ADD CONSTRAINT "FK_podman_host_label_rule_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostLabelRule" ADD CONSTRAINT "FK_podman_host_label_rule_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" ADD CONSTRAINT "FK_podman_host_owner_rule_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" ADD CONSTRAINT "FK_podman_host_owner_rule_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerRule" ADD CONSTRAINT "FK_podman_host_owner_rule_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "PodmanResource" ADD CONSTRAINT "FK_podman_resource_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" ADD CONSTRAINT "FK_podman_resource_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" ADD CONSTRAINT "FK_podman_resource_podmanHostId" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanResource" ADD CONSTRAINT "FK_podman_resource_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_user_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_user_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_user_podmanHostId" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_user_userId" FOREIGN KEY ("userId") REFERENCES "User"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerUser" ADD CONSTRAINT "FK_podman_host_owner_user_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_team_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_team_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_team_podmanHostId" FOREIGN KEY ("podmanHostId") REFERENCES "PodmanHost"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_team_teamId" FOREIGN KEY ("teamId") REFERENCES "Team"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHostOwnerTeam" ADD CONSTRAINT "FK_podman_host_owner_team_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "PodmanHost" ADD CONSTRAINT "FK_podman_host_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "PodmanHost" ADD CONSTRAINT "FK_podman_host_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "User"("_id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "PodmanHost" ADD CONSTRAINT "FK_podman_host_projectId" FOREIGN KEY ("projectId") REFERENCES "Project"("_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
