...
export class Service extends DatabaseService<VMwareVCenterFeed> {
  public constructor() {
    super(VMwareVCenterFeed);
  ...
  @CaptureSpan()
  public async createVMwareVCenterFeedItem(data: {
     ...
     */
    try {
      const feed: VMwareVCenterFeed = new VMwareVCenterFeed();
      ...
      if (!data.vmwareVCenterFeedEventType) {
        throw new BadDataException("vCenter feed event is required");
      }
      ...
      feed.vmwareVCenterId = data.vmwareVCenterId;
      feed.feedInfoInMarkdown = data.feedInfoInMarkdown;
      feed.vmwareVCenterFeedEventType = data.vmwareVCenterFeedEventType;
      ...
      logger.error("Error in creating vCenter feed", {
        projectId: data.projectId?.toString(),
        vmwareVCenterId: data.vmwareVCenterId?.toString(),
      } as LogAttributes);
      logger.error(e, {
        projectId: data.projectId?.toString(),
        vmwareVCenterId: data.vmwareVCenterId?.toString(),
