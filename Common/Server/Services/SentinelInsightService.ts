...
export class Service extends DatabaseService<SentinelInsight> {
  public constructor() {
    super(SentinelInsight);
  }
  ...
  public async applyHumanVerdict(data: {
    ...
    byUserId: ObjectID;
  }): Promise<{ insightId: ObjectID; verdict: SentinelInsightHumanVerdict }> {
    await this.updateOneById({
      ...
      data: {
        ...
        ...(data.verdict === SentinelInsightHumanVerdict.Dismissed
  ...
  public async resolveInsight(data: {
    insightId: ObjectID;
    byUserId: ObjectID;
  }): Promise<{ insightId: ObjectID; status: SentinelInsightStatus }> {
    const insight: SentinelInsight | null = await this.findOneById({
      id: data.insightId,
    ...
    return { insightId: insight.id, status: SentinelInsightStatus.Resolved };
  }
