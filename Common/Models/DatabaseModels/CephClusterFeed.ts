...
/*
 * Every state change worth remembering about a Ceph cluster. The overview page
 * answers "what does this Ceph cluster look like right now"; the feed answers
 ...
 */
export enum CephClusterFeedEventType {
  CephClusterCreated = "CephClusterCreated",
  CephClusterUpdated = "CephClusterUpdated",
  CephClusterArchived = "CephClusterArchived",
  CephClusterRestored = "CephClusterRestored",
...
@EnableDocumentation()
@CanAccessIfCanReadOn("cephCluster")
...
@TableAccessControl({
  create: [
    ...
    Permission.CreateCephClusterFeed,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadCephClusterFeed,
  ],
  delete: [],
  update: [],
})
@CrudApiEndpoint(new Route("/ceph-cluster-feed"))
@OwnedThrough("cephClusterId", CephCluster)
@Entity({
  name: "CephClusterFeed",
})
@TableMetadata({
  tableName: "CephClusterFeed",
  singularName: "Ceph Cluster Feed",
  pluralName: "Ceph Cluster Feeds",
  icon: IconProp.List,
  tableDescription:
    "Log of everything that happened to this Ceph cluster - creation, updates, owner changes and the rules that made them.",
})
@Index(["cephClusterId", "postedAt"]) // Ceph Cluster feed page: feed sorted by postedAt
export default class CephClusterFeed extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    title: "Ceph Cluster",
    description: "Relation to Ceph Cluster in which this resource belongs",
  ...
  @TableColumn({
    ...
    description: "Relation to Ceph Cluster ID in which this resource belongs",
    example: "e5f6a7b8-d9c0-1234-5678-901234efab56",
  })
  @Column({
    type: ColumnType.ObjectID,
  ...
  @TableColumn({
    ...
    description: "Log of the Ceph cluster change in Markdown",
    example: "👨🏻‍💻 Added **Jane Doe** as the owner of this Ceph cluster.",
  })
  @Column({
  ...
  @TableColumn({
    ...
    example:
      "### Additional Context\n\nThis Ceph cluster was discovered from incoming telemetry.",
  })
  @Column({
    type: ColumnType.Markdown,
    nullable: true,
  ...
  @TableColumn({
    ...
    required: true,
    title: "Ceph Cluster Feed Event",
    description: "Ceph Cluster Feed Event",
    example: "CephClusterCreated",
  })
  @Column({
  ...
  public cephClusterFeedEventType?: CephClusterFeedEventType = undefined;
