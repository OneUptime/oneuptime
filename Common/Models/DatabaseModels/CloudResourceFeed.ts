...
/*
 * Every state change worth remembering about a cloud resource. The overview page
 * answers "what does this cloud resource look like right now"; the feed answers
 ...
 */
export enum CloudResourceFeedEventType {
  CloudResourceCreated = "CloudResourceCreated",
  CloudResourceUpdated = "CloudResourceUpdated",
  CloudResourceArchived = "CloudResourceArchived",
  CloudResourceRestored = "CloudResourceRestored",
...
@EnableDocumentation()
@CanAccessIfCanReadOn("cloudResource")
...
@TableAccessControl({
  create: [
    ...
    Permission.CreateCloudResourceFeed,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadCloudResourceFeed,
  ],
  delete: [],
  update: [],
})
@CrudApiEndpoint(new Route("/cloud-resource-feed"))
@OwnedThrough("cloudResourceId", CloudResource)
@Entity({
  name: "CloudResourceFeed",
})
@TableMetadata({
  tableName: "CloudResourceFeed",
  singularName: "Cloud Resource Feed",
  pluralName: "Cloud Resource Feeds",
  icon: IconProp.List,
  tableDescription:
    "Log of everything that happened to this cloud resource - creation, updates, owner changes and the rules that made them.",
})
@Index(["cloudResourceId", "postedAt"]) // Cloud Resource feed page: feed sorted by postedAt
export default class CloudResourceFeed extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    description: "Relation to Cloud Resource in which this resource belongs",
  ...
  @TableColumn({
    ...
    description: "Relation to Cloud Resource ID in which this resource belongs",
    example: "e5f6a7b8-d9c0-1234-5678-901234efab56",
  })
  @Column({
    type: ColumnType.ObjectID,
  ...
  @TableColumn({
    ...
    description: "Log of the cloud resource change in Markdown",
    example: "👨🏻‍💻 Added **Jane Doe** as the owner of this cloud resource.",
  })
  @Column({
  ...
  @TableColumn({
    ...
    example:
      "### Additional Context\n\nThis cloud resource was discovered from incoming telemetry.",
  })
  @Column({
    type: ColumnType.Markdown,
    nullable: true,
  ...
  @TableColumn({
    ...
    required: true,
    title: "Cloud Resource Feed Event",
    description: "Cloud Resource Feed Event",
    example: "CloudResourceCreated",
  })
  @Column({
  ...
  public cloudResourceFeedEventType?: CloudResourceFeedEventType = undefined;
