...
@TableAccessControl({
  create: [
    ...
    Permission.CreateHostOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.Viewer,
    Permission.ReadHostOwnerRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteHostOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditHostOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/host-owner-rule"))
@Entity({
  name: "HostOwnerRule",
})
@EnableWorkflow({
...
@TableMetadata({
  tableName: "HostOwnerRule",
  singularName: "Host Owner Rule",
  pluralName: "Host Owner Rules",
  icon: IconProp.User,
  tableDescription:
    "Configure rules for automatically assigning owner users and teams when matching hosts are created",
})
export default class HostOwnerRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this host owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this host owner rule",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    title: "Host Labels",
    description:
      "Only trigger for hosts that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "HostOwnerRuleHostLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "hostOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    modelType: User,
    title: "Owner Users",
    description: "Users to add as owners on the host when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @TableColumn({
    ...
    modelType: Team,
    title: "Owner Teams",
    description: "Teams to add as owners on the host when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
