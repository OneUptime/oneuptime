...
@TableAccessControl({
  ...
  update: [
    ...
    Permission.OnCallAdmin,
    Permission.OnCallMember,
    Permission.EditIncomingCallPolicyOwnerTeam,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/incoming-call-policy-owner-team"))
@TableMetadata({
  tableName: "IncomingCallPolicyOwnerTeam",
  singularName: "Incoming Call Policy Team Owner",
  pluralName: "Incoming Call Policy Team Owners",
  icon: IconProp.IncomingCall,
  tableDescription: "Add teams as owners to your incoming call policies.",
})
@Entity({
  name: "IncomingCallPolicyOwnerTeam",
})
@Index(["incomingCallPolicyId", "teamId", "projectId"], { unique: true })
export default class IncomingCallPolicyOwnerTeam extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
