...
@TableAccessControl({
  create: [
    ...
    Permission.CreateDockerHostOwnerTeam,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadDockerHostOwnerTeam,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteDockerHostOwnerTeam,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditDockerHostOwnerTeam,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/docker-host-owner-team"))
@TableMetadata({
  tableName: "DockerHostOwnerTeam",
  singularName: "Docker Host Team Owner",
  pluralName: "Docker Host Team Owners",
  icon: IconProp.Cube,
  tableDescription: "Add teams as owners to your Docker hosts.",
})
@Entity({
  name: "DockerHostOwnerTeam",
})
@Index(["dockerHostId", "teamId", "projectId"], {
  unique: true,
...
export default class DockerHostOwnerTeam extends BaseModel {
  ...
  @UniqueColumnBy(["dockerHostId", "projectId"])
