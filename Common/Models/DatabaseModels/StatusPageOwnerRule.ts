...
@TableAccessControl({
  create: [
    ...
    Permission.CreateStatusPageOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadStatusPageOwnerRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteStatusPageOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditStatusPageOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/status-page-owner-rule"))
@Entity({
  name: "StatusPageOwnerRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "StatusPageOwnerRule",
  singularName: "Status Page Owner Rule",
  pluralName: "Status Page Owner Rules",
  icon: IconProp.User,
  tableDescription:
    "Configure rules for automatically assigning owner users and teams when matching status pages are created",
})
export default class StatusPageOwnerRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this status page owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this status page owner rule",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    description:
      "Only trigger for status pages that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "StatusPageOwnerRuleStatusPageLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "statusPageOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the status page when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @JoinTable({
    name: "StatusPageOwnerRuleOwnerUser",
    inverseJoinColumn: {
      name: "userId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the status page when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
  ...
  @JoinTable({
    name: "StatusPageOwnerRuleOwnerTeam",
    inverseJoinColumn: {
      name: "teamId",
      referencedColumnName: "_id",
    },
