...
@TableAccessControl({
  create: [
    ...
    Permission.CreateAlertEpisodeOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
  ...
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteAlertEpisodeOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditAlertEpisodeOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/alert-episode-owner-rule"))
@Entity({
  name: "AlertEpisodeOwnerRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "AlertEpisodeOwnerRule",
  singularName: "Alert Episode Owner Rule",
  pluralName: "Alert Episode Owner Rules",
  icon: IconProp.User,
  tableDescription:
    "Configure rules for automatically assigning owner users and teams when matching alert episodes are created",
})
export default class AlertEpisodeOwnerRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this alert episode owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this alert episode owner rule",
  })
  @Column({
    nullable: true,
  ...
  @JoinTable({
    name: "AlertEpisodeOwnerRuleAlertSeverity",
    inverseJoinColumn: {
      name: "alertSeverityId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "alertEpisodeOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @JoinTable({
    name: "AlertEpisodeOwnerRuleEpisodeLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the alert episode when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @JoinTable({
    name: "AlertEpisodeOwnerRuleOwnerUser",
    inverseJoinColumn: {
      name: "userId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the alert episode when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
  ...
  @JoinTable({
    name: "AlertEpisodeOwnerRuleOwnerTeam",
    inverseJoinColumn: {
      name: "teamId",
      referencedColumnName: "_id",
    },
