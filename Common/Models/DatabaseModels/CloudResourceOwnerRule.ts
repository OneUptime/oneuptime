...
@TableAccessControl({
  create: [
    ...
    Permission.CreateCloudResourceOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.Viewer,
    Permission.ReadCloudResourceOwnerRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteCloudResourceOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditCloudResourceOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/cloud-resource-owner-rule"))
@Entity({
  name: "CloudResourceOwnerRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "CloudResourceOwnerRule",
  singularName: "Cloud Resource Owner Rule",
  pluralName: "Cloud Resource Owner Rules",
  icon: IconProp.User,
  tableDescription:
...
export default class CloudResourceOwnerRule extends BaseModel {
  ...
  @TableColumn({
    ...
    title: "Match Labels",
    description:
      "Only trigger for resources that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "CloudResOwnerRuleMatchLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "cloudResourceOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the resource when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the resource when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
