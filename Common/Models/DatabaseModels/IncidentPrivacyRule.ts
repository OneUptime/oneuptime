...
@TableAccessControl({
  create: [
    ...
    Permission.CreateIncidentPrivacyRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
  ...
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteIncidentPrivacyRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditIncidentPrivacyRule,
  ],
})
@CrudApiEndpoint(new Route("/incident-privacy-rule"))
@Entity({
  name: "IncidentPrivacyRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "IncidentPrivacyRule",
  singularName: "Incident Privacy Rule",
  pluralName: "Incident Privacy Rules",
  icon: IconProp.Lock,
  tableDescription:
    "Configure rules for automatically marking matching incidents as private",
})
export default class IncidentPrivacyRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this incident privacy rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this incident privacy rule",
  })
  @Column({
    nullable: true,
  ...
  @JoinTable({
    name: "IncidentPrivacyRuleMonitor",
    inverseJoinColumn: {
      name: "monitorId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "incidentPrivacyRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @JoinTable({
    name: "IncidentPrivacyRuleIncidentSeverity",
    inverseJoinColumn: {
  ...
  @JoinTable({
    name: "IncidentPrivacyRuleIncidentLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
  ...
  @JoinTable({
    name: "IncidentPrivacyRuleMonitorLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
