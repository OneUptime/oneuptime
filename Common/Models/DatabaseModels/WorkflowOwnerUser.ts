...
@TableAccessControl({
  ...
  read: [
    ...
    Permission.Viewer,
    Permission.WorkflowManager,
    Permission.ReadWorkflowOwnerUser,
...
@CrudApiEndpoint(new Route("/workflow-owner-user"))
@TableMetadata({
  tableName: "WorkflowOwnerUser",
  singularName: "Workflow User Owner",
  pluralName: "Workflow User Owners",
  icon: IconProp.Workflow,
  tableDescription: "Add users as owners to your workflows.",
})
@Entity({
