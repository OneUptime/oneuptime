...
@TableAccessControl({
  ...
  delete: [
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteNetworkDeviceLink,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
...
@CrudApiEndpoint(new Route("/network-device-link"))
@Index(["projectId", "fromDeviceId"])
@TableMetadata({
  tableName: "NetworkDeviceLink",
  singularName: "Network Device Link",
  pluralName: "Network Device Links",
  icon: IconProp.Link,
  tableDescription:
...
export default class NetworkDeviceLink extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    manyToOneRelationColumn: "fromDeviceId",
    type: TableColumnType.Entity,
    modelType: NetworkDevice,
    title: "From Device",
    description: "Relation to the Network Device this link starts from",
  })
  @ManyToOne(
    () => {
  ...
  public fromDevice?: NetworkDevice = undefined;
  ...
  @TableColumn({
    ...
    description: "ID of the Network Device this link starts from",
  })
  @Column({
    type: ColumnType.ObjectID,
    nullable: false,
  ...
  public fromDeviceId?: ObjectID = undefined;
  ...
  @TableColumn({
    manyToOneRelationColumn: "toDeviceId",
    type: TableColumnType.Entity,
    modelType: NetworkDevice,
    title: "To Device",
    description: "Relation to the Network Device this link ends at",
  })
  @ManyToOne(
    () => {
      return NetworkDevice;
  ...
  public toDevice?: NetworkDevice = undefined;
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "To Device ID",
    description: "ID of the Network Device this link ends at",
  })
  @Column({
    type: ColumnType.ObjectID,
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "From Port",
    description:
      "Port on the starting device, as free text. Nothing resolves it to an interface row — a hand-drawn link usually exists precisely because the port is not discoverable.",
    example: "Gi1/0/24",
  })
  @Column({
    nullable: true,
  ...
  public fromPortName?: string = undefined;
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "To Port",
    description: "Port on the ending device, as free text.",
    example: "eth0",
  })
  @Column({
    nullable: true,
  ...
  public toPortName?: string = undefined;
  ...
  @TableColumn({
    ...
    title: "Monitor",
    description:
      "Relation to the Monitor whose status colors this link on the topology map",
  })
  @ManyToOne(
    () => {
      return Monitor;
  ...
  @TableColumn({
    ...
    title: "Monitor ID",
    description:
      "ID of the Monitor whose status colors this link on the topology map",
  })
  @Column({
    type: ColumnType.ObjectID,
    nullable: true,
