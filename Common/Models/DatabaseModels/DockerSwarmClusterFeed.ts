...
/*
 * Every state change worth remembering about a Docker Swarm cluster. The overview page
 * answers "what does this Docker Swarm cluster look like right now"; the feed answers
 ...
 */
export enum DockerSwarmClusterFeedEventType {
  DockerSwarmClusterCreated = "DockerSwarmClusterCreated",
  DockerSwarmClusterUpdated = "DockerSwarmClusterUpdated",
  DockerSwarmClusterArchived = "DockerSwarmClusterArchived",
  DockerSwarmClusterRestored = "DockerSwarmClusterRestored",
...
@EnableDocumentation()
@CanAccessIfCanReadOn("dockerSwarmCluster")
...
@TableAccessControl({
  create: [
    ...
    Permission.CreateDockerSwarmClusterFeed,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadDockerSwarmClusterFeed,
  ],
  delete: [],
  update: [],
})
@CrudApiEndpoint(new Route("/docker-swarm-cluster-feed"))
@OwnedThrough("dockerSwarmClusterId", DockerSwarmCluster)
@Entity({
  name: "DockerSwarmClusterFeed",
})
@TableMetadata({
  tableName: "DockerSwarmClusterFeed",
  singularName: "Docker Swarm Cluster Feed",
  pluralName: "Docker Swarm Cluster Feeds",
  icon: IconProp.List,
  tableDescription:
    "Log of everything that happened to this Docker Swarm cluster - creation, updates, owner changes and the rules that made them.",
})
@Index(["dockerSwarmClusterId", "postedAt"]) // Docker Swarm Cluster feed page: feed sorted by postedAt
export default class DockerSwarmClusterFeed extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    description:
      "Relation to Docker Swarm Cluster in which this resource belongs",
  ...
  @TableColumn({
    ...
    description:
      "Relation to Docker Swarm Cluster ID in which this resource belongs",
    example: "e5f6a7b8-d9c0-1234-5678-901234efab56",
  })
  @Column({
    type: ColumnType.ObjectID,
  ...
  @TableColumn({
    ...
    description: "Log of the Docker Swarm cluster change in Markdown",
    example: "👨🏻‍💻 Added **Jane Doe** as the owner of this Docker Swarm cluster.",
  })
  @Column({
  ...
  @TableColumn({
    ...
    example:
      "### Additional Context\n\nThis Docker Swarm cluster was discovered from incoming telemetry.",
  })
  @Column({
    type: ColumnType.Markdown,
    nullable: true,
  ...
  @TableColumn({
    ...
    required: true,
    title: "Docker Swarm Cluster Feed Event",
    description: "Docker Swarm Cluster Feed Event",
    example: "DockerSwarmClusterCreated",
  })
  @Column({
  ...
  public dockerSwarmClusterFeedEventType?: DockerSwarmClusterFeedEventType =
    undefined;
