...
@TableAccessControl({
  create: [
    ...
    Permission.CreateWorkflowOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
  ...
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteWorkflowOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditWorkflowOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/workflow-owner-rule"))
@Entity({
  name: "WorkflowOwnerRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "WorkflowOwnerRule",
  singularName: "Workflow Owner Rule",
  pluralName: "Workflow Owner Rules",
  icon: IconProp.User,
  tableDescription:
    "Configure rules for automatically assigning owner users and teams when matching workflows are created",
})
export default class WorkflowOwnerRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this workflow owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this workflow owner rule",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    description:
      "Only trigger for workflows that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "WorkflowOwnerRuleWorkflowLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "workflowOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the workflow when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @JoinTable({
    name: "WorkflowOwnerRuleOwnerUser",
    inverseJoinColumn: {
      name: "userId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the workflow when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
  ...
  @JoinTable({
    name: "WorkflowOwnerRuleOwnerTeam",
    inverseJoinColumn: {
      name: "teamId",
      referencedColumnName: "_id",
    },
