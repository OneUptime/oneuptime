...
export default class SmsLog extends BaseModel {
  ...
  @TableColumn({
    ...
    description: "On-Call Duty Policy Escalation Rule associated with this SMS (if any)",
  })
  @ManyToOne(
    () => {
  ...
  @TableColumn({
    ...
    description: "On-Call Duty Policy Schedule associated with this SMS (if any)",
  })
  @ManyToOne(
    () => {
