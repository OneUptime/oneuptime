...
@TableAccessControl({
  ...
  delete: [
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteNetworkSiteType,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
...
@CrudApiEndpoint(new Route("/network-site-type"))
@SlugifyColumn("name", "slug")
@TableMetadata({
  tableName: "NetworkSiteType",
  singularName: "Network Site Type",
...
export default class NetworkSiteType extends BaseModel {
  ...
  @TableColumn({
    ...
    example: "A single store, restaurant or branch office",
  })
  @Column({
    nullable: true,
  ...
  /*
   * Load-bearing flag, not a label. Site types are renameable per project, so
   * no code may branch on the type's name - every "is this a leaf site?"
   * decision keys off this boolean instead.
   */
  @TableColumn({
    ...
    title: "Is Unit Level",
    description:
      "Sites of this type are the leaf level - the network map opens their device topology, and the health rollup counts them as units.",
    defaultValue: false,
  })
  @Column({
  ...
  public isUnitLevel?: boolean = undefined;
