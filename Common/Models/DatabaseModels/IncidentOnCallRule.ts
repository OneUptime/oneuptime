...
@TableAccessControl({
  create: [
    ...
    Permission.CreateIncidentOnCallRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
  ...
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteIncidentOnCallRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditIncidentOnCallRule,
  ],
})
@CrudApiEndpoint(new Route("/incident-on-call-rule"))
@Entity({
  name: "IncidentOnCallRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "IncidentOnCallRule",
  singularName: "Incident On-Call Rule",
  pluralName: "Incident On-Call Rules",
  icon: IconProp.Call,
  tableDescription:
    "Configure rules for automatically executing on-call duty policies when matching incidents are created",
})
export default class IncidentOnCallRule extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this incident on-call rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this incident on-call rule",
  })
  @Column({
    nullable: true,
  ...
  @JoinTable({
    name: "IncidentOnCallRuleMonitor",
    inverseJoinColumn: {
      name: "monitorId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "incidentOnCallRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @JoinTable({
    name: "IncidentOnCallRuleIncidentSeverity",
    inverseJoinColumn: {
  ...
  @JoinTable({
    name: "IncidentOnCallRuleIncidentLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
  ...
  @JoinTable({
    name: "IncidentOnCallRuleMonitorLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    description:
      "On-call duty policies to execute when an incident matches this rule.",
  })
  @ManyToMany(
    () => {
  ...
  @JoinTable({
    name: "IncidentOnCallRuleOnCallDutyPolicy",
    inverseJoinColumn: {
