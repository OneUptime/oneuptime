...
/*
 * Restores a UNIQUE index that an autogenerated migration deleted — one mapping row per (provider, project); duplicates would make the
 * project's SSO binding ambiguous.
 *
