import { UniqueOwnerRows1789700000000 } from "../../../Server/Infrastructure/Postgres/SchemaMigrations/1789700000000-UniqueOwnerRows";
...
async function captureSql(): Promise<CapturedSql> {
  const migration: UniqueOwnerRows1789700000000 =
    new UniqueOwnerRows1789700000000();
...
describe("UniqueOwnerRows migration", () => {
  it("is registered, so it actually runs on startup", () => {
    expect(SchemaMigrations).toContain(UniqueOwnerRows1789700000000);
  });
