import { UniqueOwnerRows1792700000000 } from "../../../Server/Infrastructure/Postgres/SchemaMigrations/1792700000000-UniqueOwnerRows";
...
async function captureSql(): Promise<CapturedSql> {
  const migration: UniqueOwnerRows1792700000000 =
    new UniqueOwnerRows1792700000000();
...
describe("UniqueOwnerRows migration", () => {
  it("is registered, so it actually runs on startup", () => {
    expect(SchemaMigrations).toContain(UniqueOwnerRows1792700000000);
  });
