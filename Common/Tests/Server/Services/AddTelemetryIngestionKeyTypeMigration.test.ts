import { AddTelemetryIngestionKeyType1791000000000 } from "../../../Server/Infrastructure/Postgres/SchemaMigrations/1791000000000-AddTelemetryIngestionKeyType";
...
const MIGRATION_NAME: string = "AddTelemetryIngestionKeyType1791000000000";
...
const runUp: RunMigrationFunction = async (): Promise<Array<string>> => {
  ...
  await new AddTelemetryIngestionKeyType1791000000000().up(runner);
...
const runDown: RunMigrationFunction = async (): Promise<Array<string>> => {
  ...
  await new AddTelemetryIngestionKeyType1791000000000().down(runner);
