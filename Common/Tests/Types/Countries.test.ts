...
describe("enum Countries", () => {
  test("each country should have a valid corresponding name ", () => {
    ...
    expect(Countries["Netherlands Antilles"]).toEqual("Netherlands Antilles");
    ...
    expect(Countries["Saint Kitts and Nevis"]).toEqual("Saint Kitts and Nevis");
    ...
    expect(Countries["Sao Tome and Principe"]).toEqual("Sao Tome and Principe");
    expect(Countries["Saudi Arabia"]).toEqual("Saudi Arabia");
    expect(Countries["Senegal"]).toEqual("Senegal");
    expect(Countries["Serbia and Montenegro"]).toEqual("Serbia and Montenegro");
    ...
    expect(Countries["South Georgia and the South Sandwich Islands"]).toEqual(
    ...
    expect(Countries["Syrian Arab Republic"]).toEqual("Syrian Arab Republic");
    ...
    expect(Countries["United Arab Emirates"]).toEqual("United Arab Emirates");
    ...
    expect(Countries["Virgin Islands, U.S."]).toEqual("Virgin Islands, U.S.");
