...
const rawWhatsAppTemplateMessages: WhatsAppTemplateMessagesDefinition = {
  ...
  [WhatsAppTemplateIds.IncidentCreatedOwnerNotification]: `Incident #{{incident_number}} ({{incident_title}}) has been created for project {{project_name}}. View incident details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentNotePostedOwnerNotification]: `A new note was posted on incident #{{incident_number}} ({{incident_title}}). Review the incident: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentStateChangedOwnerNotification]: `Incident #{{incident_number}} ({{incident_title}}) state changed to {{incident_state}}. Track the incident status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentOwnerAddedNotification]: `You have been added as an owner of incident #{{incident_number}} ({{incident_title}}). Manage the incident: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertCreatedOwnerNotification]: `Alert #{{alert_number}} ({{alert_title}}) has been created for project {{project_name}}. View alert details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertNotePostedOwnerNotification]: `A new note was posted on alert #{{alert_number}} ({{alert_title}}). Review the alert: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertStateChangedOwnerNotification]: `Alert #{{alert_number}} ({{alert_title}}) state changed to {{alert_state}}. Track the alert status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertOwnerAddedNotification]: `You have been added as an owner of alert #{{alert_number}} ({{alert_title}}). Manage the alert: {{action_link}}. For more information, visit your OneUptime dashboard.`,
