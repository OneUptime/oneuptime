...
const rawWhatsAppTemplateMessages: WhatsAppTemplateMessagesDefinition = {
  ...
  [WhatsAppTemplateIds.VerificationCode]: `Your OneUptime verification code is {{verification_code}}. Enter this code in the dashboard to verify your WhatsApp number. For more information, please check out the OneUptime dashboard using {{dashboard_link}} for details.`,
  ...
  [WhatsAppTemplateIds.IncidentNotePostedOwnerNotification]: `A new note was posted on incident #{{incident_number}} ({{incident_title}}). Review the incident using {{incident_link}} on the OneUptime dashboard for the latest updates.`,
  [WhatsAppTemplateIds.IncidentStateChangedOwnerNotification]: `Incident #{{incident_number}} ({{incident_title}}) state changed to {{incident_state}}. Track the incident status using {{incident_link}} on the OneUptime dashboard to stay informed.`,
  [WhatsAppTemplateIds.IncidentOwnerAddedNotification]: `You have been added as an owner of incident #{{incident_number}} ({{incident_title}}). Manage the incident using {{incident_link}} on the OneUptime dashboard to act quickly.`,
  [WhatsAppTemplateIds.AlertCreatedOwnerNotification]: `Alert #{{alert_number}} ({{alert_title}}) has been created for project {{project_name}}. View alert details using {{alert_link}} on the OneUptime dashboard for more information.`,
  ...
  [WhatsAppTemplateIds.MonitorCreatedOwnerNotification]: `Monitor {{monitor_name}} has been created. View monitor details using {{monitor_link}} on the OneUptime dashboard for deeper insight.`,
  ...
  [WhatsAppTemplateIds.MonitorNoProbesMonitoringNotification]: `No probes are monitoring monitor {{monitor_name}}. Investigate the monitor using {{monitor_link}} on the OneUptime dashboard to restore coverage.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceCreatedOwnerNotification]: `Scheduled maintenance {{event_title}} has been created. View event details using {{maintenance_link}} on the OneUptime dashboard to prepare.`,
