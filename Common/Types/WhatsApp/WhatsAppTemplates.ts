...
const rawWhatsAppTemplateMessages: WhatsAppTemplateMessagesDefinition = {
  [WhatsAppTemplateIds.AlertCreated]: `A new alert #{{alert_number}} ({{alert_title}}) has been created for project {{project_name}}. To acknowledge this alert, click here: {{acknowledge_url}}. For more information, please check out this alert on the OneUptime dashboard: {{alert_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.IncidentCreated]: `A new incident #{{incident_number}} ({{incident_title}}) has been created for project {{project_name}}. To acknowledge this incident, click here: {{acknowledge_url}}. For more information, please check out this incident on the OneUptime dashboard: {{incident_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.VerificationCode]: `Your OneUptime verification code is {{verification_code}}. Enter this code in the dashboard to verify your WhatsApp number. For more information, please check out the OneUptime dashboard: {{oneuptime_dashboard_link}}.`,
  [WhatsAppTemplateIds.IncidentCreatedOwnerNotification]: `Incident #{{incident_number}} ({{incident_title}}) has been created for project {{project_name}}. View incident details: {{incident_link_on_dashboard}}. For more information, please check out this incident on the OneUptime dashboard: {{incident_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.IncidentNotePostedOwnerNotification]: `A new note was posted on incident #{{incident_number}} ({{incident_title}}). Review the incident: {{incident_link_on_dashboard}}. For more information, please check out this incident on the OneUptime dashboard: {{incident_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.IncidentStateChangedOwnerNotification]: `Incident #{{incident_number}} ({{incident_title}}) state changed to {{incident_state}}. Track the incident status: {{incident_link_on_dashboard}}. For more information, please check out this incident on the OneUptime dashboard: {{incident_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.IncidentOwnerAddedNotification]: `You have been added as an owner of incident #{{incident_number}} ({{incident_title}}). Manage the incident: {{incident_link_on_dashboard}}. For more information, please check out this incident on the OneUptime dashboard: {{incident_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.AlertCreatedOwnerNotification]: `Alert #{{alert_number}} ({{alert_title}}) has been created for project {{project_name}}. View alert details: {{alert_link_on_dashboard}}. For more information, please check out this alert on the OneUptime dashboard: {{alert_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.AlertNotePostedOwnerNotification]: `A new note was posted on alert #{{alert_number}} ({{alert_title}}). Review the alert: {{alert_link_on_dashboard}}. For more information, please check out this alert on the OneUptime dashboard: {{alert_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.AlertStateChangedOwnerNotification]: `Alert #{{alert_number}} ({{alert_title}}) state changed to {{alert_state}}. Track the alert status: {{alert_link_on_dashboard}}. For more information, please check out this alert on the OneUptime dashboard: {{alert_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.AlertOwnerAddedNotification]: `You have been added as an owner of alert #{{alert_number}} ({{alert_title}}). Manage the alert: {{alert_link_on_dashboard}}. For more information, please check out this alert on the OneUptime dashboard: {{alert_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.MonitorOwnerAddedNotification]: `You have been added as an owner of monitor {{monitor_name}}. Manage the monitor: {{monitor_link_on_dashboard}}. For more information, please check out this monitor on the OneUptime dashboard: {{monitor_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.MonitorCreatedOwnerNotification]: `Monitor {{monitor_name}} has been created. View monitor details: {{monitor_link_on_dashboard}}. For more information, please check out this monitor on the OneUptime dashboard: {{monitor_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.MonitorStatusChangedOwnerNotification]: `Monitor {{monitor_name}} status changed to {{monitor_status}}. Check monitor status: {{monitor_link_on_dashboard}}. For more information, please check out this monitor on the OneUptime dashboard: {{monitor_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.MonitorProbeStatusChangedNotification]: `Probes for monitor {{monitor_name}} are {{probe_status}}. Review probe details: {{monitor_link_on_dashboard}}. For more information, please check out this monitor on the OneUptime dashboard: {{monitor_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.MonitorNoProbesMonitoringNotification]: `No probes are monitoring monitor {{monitor_name}}. Investigate the monitor: {{monitor_link_on_dashboard}}. For more information, please check out this monitor on the OneUptime dashboard: {{monitor_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceCreatedOwnerNotification]: `Scheduled maintenance {{event_title}} has been created. View event details: {{scheduled_maintenance_link_on_dashboard}}. For more information, please check out this scheduled maintenance on the OneUptime dashboard: {{scheduled_maintenance_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceNotePostedOwnerNotification]: `A new note was posted on scheduled maintenance {{event_title}}. Review the event: {{scheduled_maintenance_link_on_dashboard}}. For more information, please check out this scheduled maintenance on the OneUptime dashboard: {{scheduled_maintenance_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceOwnerAddedNotification]: `You have been added as an owner of scheduled maintenance {{event_title}}. Manage the event: {{scheduled_maintenance_link_on_dashboard}}. For more information, please check out this scheduled maintenance on the OneUptime dashboard: {{scheduled_maintenance_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceStateChangedOwnerNotification]: `Scheduled maintenance {{event_title}} state changed to {{event_state}}. Track event status: {{scheduled_maintenance_link_on_dashboard}}. For more information, please check out this scheduled maintenance on the OneUptime dashboard: {{scheduled_maintenance_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.StatusPageAnnouncementCreatedOwnerNotification]: `Announcement {{announcement_title}} was published on status page {{status_page_name}}. View the announcement: {{status_page_link_on_dashboard}}. For more information, please check out this status page on the OneUptime dashboard: {{status_page_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.StatusPageCreatedOwnerNotification]: `Status page {{status_page_name}} has been created. View status page details: {{status_page_link_on_dashboard}}. For more information, please check out this status page on the OneUptime dashboard: {{status_page_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.StatusPageOwnerAddedNotification]: `You have been added as an owner of status page {{status_page_name}}. Manage the status page: {{status_page_link_on_dashboard}}. For more information, please check out this status page on the OneUptime dashboard: {{status_page_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ProbeStatusChangedOwnerNotification]: `Probe {{probe_name}} status is {{probe_status}}. Review the probe: {{probe_link_on_dashboard}}. For more information, please check out this probe on the OneUptime dashboard: {{probe_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.ProbeOwnerAddedNotification]: `You have been added as an owner of probe {{probe_name}}. Manage the probe: {{probe_link_on_dashboard}}. For more information, please check out this probe on the OneUptime dashboard: {{probe_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.OnCallUserIsOnRosterNotification]: `You are now on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. View the on-call schedule: {{on_call_schedule_link_on_dashboard}}. For more information, please check out your on-call schedule on the OneUptime dashboard: {{on_call_schedule_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.OnCallUserIsNextNotification]: `You are next on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. Prepare for your shift: {{on_call_schedule_link_on_dashboard}}. For more information, please check out your on-call schedule on the OneUptime dashboard: {{on_call_schedule_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.OnCallUserAddedToPolicyNotification]: `You have been added to on-call policy {{on_call_policy_name}} for {{on_call_context}}. Review the on-call policy: {{on_call_policy_link_on_dashboard}}. For more information, please check out this on-call policy on the OneUptime dashboard: {{on_call_policy_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.OnCallUserRemovedFromPolicyNotification]: `You have been removed from on-call policy {{on_call_policy_name}} for {{on_call_context}}. View on-call policies: {{on_call_policy_link_on_dashboard}}. For more information, please check out your on-call policies on the OneUptime dashboard: {{on_call_policy_link_on_dashboard}}.`,
  [WhatsAppTemplateIds.OnCallUserNoLongerActiveNotification]: `You are no longer on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. Review your schedule: {{on_call_schedule_link_on_dashboard}}. For more information, please check out your on-call schedule on the OneUptime dashboard: {{on_call_schedule_link_on_dashboard}}.`,
};
