...
const WhatsAppTemplateMessages = {
  [WhatsAppTemplateIds.AlertCreated]: `A new alert {{alert_title}} has been created for project {{project_name}}. To acknowledge this alert, click here: {{acknowledge_url}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentCreated]: `A new incident {{incident_title}} has been created for project {{project_name}}. To acknowledge this incident, click here: {{acknowledge_url}}. For more information, visit your OneUptime dashboard.`,
  ...
  [WhatsAppTemplateIds.IncidentCreatedOwnerNotification]: `Incident {{incident_title}} has been created for project {{project_name}}. View incident details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentNotePostedOwnerNotification]: `A new note was posted on incident {{incident_title}}. Review the incident: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentStateChangedOwnerNotification]: `Incident {{incident_title}} state changed to {{incident_state}}. Track the incident status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.IncidentOwnerAddedNotification]: `You have been added as an owner of incident {{incident_title}}. Manage the incident: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertCreatedOwnerNotification]: `Alert {{alert_title}} has been created for project {{project_name}}. View alert details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertNotePostedOwnerNotification]: `A new note was posted on alert {{alert_title}}. Review the alert: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertStateChangedOwnerNotification]: `Alert {{alert_title}} state changed to {{alert_state}}. Track the alert status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.AlertOwnerAddedNotification]: `You have been added as an owner of alert {{alert_title}}. Manage the alert: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.MonitorOwnerAddedNotification]: `You have been added as an owner of monitor {{monitor_name}}. Manage the monitor: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.MonitorCreatedOwnerNotification]: `Monitor {{monitor_name}} has been created. View monitor details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.MonitorStatusChangedOwnerNotification]: `Monitor {{monitor_name}} status changed to {{monitor_status}}. Check monitor status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.MonitorProbeStatusChangedNotification]: `Probes for monitor {{monitor_name}} are {{probe_status}}. Review probe details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.MonitorNoProbesMonitoringNotification]: `No probes are monitoring monitor {{monitor_name}}. Investigate the monitor: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceCreatedOwnerNotification]: `Scheduled maintenance {{event_title}} has been created. View event details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceNotePostedOwnerNotification]: `A new note was posted on scheduled maintenance {{event_title}}. Review the event: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceOwnerAddedNotification]: `You have been added as an owner of scheduled maintenance {{event_title}}. Manage the event: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceStateChangedOwnerNotification]: `Scheduled maintenance {{event_title}} state changed to {{event_state}}. Track event status: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.StatusPageAnnouncementCreatedOwnerNotification]: `Announcement {{announcement_title}} was published on status page {{status_page_name}}. View the announcement: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.StatusPageCreatedOwnerNotification]: `Status page {{status_page_name}} has been created. View status page details: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.StatusPageOwnerAddedNotification]: `You have been added as an owner of status page {{status_page_name}}. Manage the status page: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ProbeStatusChangedOwnerNotification]: `Probe {{probe_name}} status is {{probe_status}}. Review the probe: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.ProbeOwnerAddedNotification]: `You have been added as an owner of probe {{probe_name}}. Manage the probe: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.OnCallUserIsOnRosterNotification]: `You are now on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. View on-call schedule: {{action_link}}. For more information, visit your OneUptime dashboard.`,
  [WhatsAppTemplateIds.OnCallUserIsNextNotification]: `You are next on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. Prepare for your shift: {{action_link}}. For more information, visit your OneUptime dashboard.`,
