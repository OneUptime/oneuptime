...
const WhatsAppTemplateMessages = {
  ...
  [WhatsAppTemplateIds.IncidentCreatedOwnerNotification]: `This is a message from OneUptime. Incident {{incident_title}} has been created for project {{project_name}}. View incident details: {{action_link}}.`,
  [WhatsAppTemplateIds.IncidentNotePostedOwnerNotification]: `This is a message from OneUptime. A new note was posted on incident {{incident_title}}. Review the incident: {{action_link}}.`,
  [WhatsAppTemplateIds.IncidentStateChangedOwnerNotification]: `This is a message from OneUptime. Incident {{incident_title}} state changed to {{incident_state}}. Track the incident status: {{action_link}}.`,
  [WhatsAppTemplateIds.IncidentOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of incident {{incident_title}}. Manage the incident: {{action_link}}.`,
  [WhatsAppTemplateIds.AlertCreatedOwnerNotification]: `This is a message from OneUptime. Alert {{alert_title}} has been created for project {{project_name}}. View alert details: {{action_link}}.`,
  [WhatsAppTemplateIds.AlertNotePostedOwnerNotification]: `This is a message from OneUptime. A new note was posted on alert {{alert_title}}. Review the alert: {{action_link}}.`,
  [WhatsAppTemplateIds.AlertStateChangedOwnerNotification]: `This is a message from OneUptime. Alert {{alert_title}} state changed to {{alert_state}}. Track the alert status: {{action_link}}.`,
  [WhatsAppTemplateIds.AlertOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of alert {{alert_title}}. Manage the alert: {{action_link}}.`,
  [WhatsAppTemplateIds.MonitorOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of monitor {{monitor_name}}. Manage the monitor: {{action_link}}.`,
  [WhatsAppTemplateIds.MonitorCreatedOwnerNotification]: `This is a message from OneUptime. Monitor {{monitor_name}} has been created. View monitor details: {{action_link}}.`,
  [WhatsAppTemplateIds.MonitorStatusChangedOwnerNotification]: `This is a message from OneUptime. Monitor {{monitor_name}} status changed to {{monitor_status}}. Check monitor status: {{action_link}}.`,
  [WhatsAppTemplateIds.MonitorProbeStatusChangedNotification]: `This is a message from OneUptime. Probes for monitor {{monitor_name}} are {{probe_status}}. Review probe details: {{action_link}}.`,
  [WhatsAppTemplateIds.MonitorNoProbesMonitoringNotification]: `This is a message from OneUptime. No probes are monitoring monitor {{monitor_name}}. Investigate the monitor: {{action_link}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceCreatedOwnerNotification]: `This is a message from OneUptime. Scheduled maintenance {{event_title}} has been created. View event details: {{action_link}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceNotePostedOwnerNotification]: `This is a message from OneUptime. A new note was posted on scheduled maintenance {{event_title}}. Review the event: {{action_link}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of scheduled maintenance {{event_title}}. Manage the event: {{action_link}}.`,
  [WhatsAppTemplateIds.ScheduledMaintenanceStateChangedOwnerNotification]: `This is a message from OneUptime. Scheduled maintenance {{event_title}} state changed to {{event_state}}. Track event status: {{action_link}}.`,
  [WhatsAppTemplateIds.StatusPageAnnouncementCreatedOwnerNotification]: `This is a message from OneUptime. Announcement {{announcement_title}} was published on status page {{status_page_name}}. View the announcement: {{action_link}}.`,
  [WhatsAppTemplateIds.StatusPageCreatedOwnerNotification]: `This is a message from OneUptime. Status page {{status_page_name}} has been created. View status page details: {{action_link}}.`,
  [WhatsAppTemplateIds.StatusPageOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of status page {{status_page_name}}. Manage the status page: {{action_link}}.`,
  [WhatsAppTemplateIds.ProbeStatusChangedOwnerNotification]: `This is a message from OneUptime. Probe {{probe_name}} status is {{probe_status}}. Review the probe: {{action_link}}.`,
  [WhatsAppTemplateIds.ProbeOwnerAddedNotification]: `This is a message from OneUptime. You have been added as an owner of probe {{probe_name}}. Manage the probe: {{action_link}}.`,
  [WhatsAppTemplateIds.OnCallUserIsOnRosterNotification]: `This is a message from OneUptime. You are now on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. View on-call schedule: {{action_link}}.`,
  [WhatsAppTemplateIds.OnCallUserIsNextNotification]: `This is a message from OneUptime. You are next on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. Prepare for your shift: {{action_link}}.`,
  [WhatsAppTemplateIds.OnCallUserAddedToPolicyNotification]: `This is a message from OneUptime. You have been added to on-call policy {{on_call_policy_name}} for {{on_call_context}}. Review the on-call policy: {{action_link}}.`,
  [WhatsAppTemplateIds.OnCallUserRemovedFromPolicyNotification]: `This is a message from OneUptime. You have been removed from on-call policy {{on_call_policy_name}} for {{on_call_context}}. View on-call policies: {{action_link}}.`,
  [WhatsAppTemplateIds.OnCallUserNoLongerActiveNotification]: `This is a message from OneUptime. You are no longer on-call for policy {{on_call_policy_name}} on schedule {{schedule_name}}. Review your schedule: {{action_link}}.`,
} as const;
