...
export const isRequiredColumn = (target: BaseModel, propertyKey: string): boolean => {
    return Reflect.getMetadata(requiredColumnSymbol, target, propertyKey) as boolean;
}
