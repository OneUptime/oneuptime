              ...
              for (const args of component.metadata.returnValues) {
                if (
                  (args.type === ComponentInputType.JSON ||
                    args.type === ComponentInputType.JSONArray ||
                    args.type === ComponentInputType.BaseModel ||
                    args.type === ComponentInputType.BaseModelArray ||
                    args.type === ComponentInputType.Query ||
                    args.type === ComponentInputType.Select ||
                    args.type === ComponentInputType.StringDictionary) &&
                  component.returnValues &&
                  component.returnValues[args.id] &&
                  typeof component.returnValues[args.id] === "string"
                ) {
                  component.returnValues[args.id] = JSONFunctions.parse(
                    component.returnValues[args.id] as string,
                  );
                }
              }
