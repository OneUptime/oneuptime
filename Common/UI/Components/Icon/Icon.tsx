  ...
  if (icon === IconProp.Close) {
    ...
    return getSvgWrapper(
      <path
        fill="currentColor"
        stroke="none"
        d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.1-.47-.149-.667.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.76-1.653-2.057-.173-.297-.018-.458.13-.606.134-.133.298-.347.447-.52.149-.174.198-.298.298-.497.1-.198.05-.371-.025-.52-.075-.149-.667-1.61-.916-2.209-.242-.579-.487-.5-.667-.51-.173-.008-.371-.01-.57-.01a1.1 1.1 0 00-.8.373c-.273.298-1.04 1.017-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.08 4.487.71.306 1.264.489 1.696.626.712.227 1.36.195 1.872.118.571-.085 1.758-.718 2.006-1.41.248-.69.248-1.28.173-1.41-.074-.133-.272-.198-.57-.347zM11.032 20c-1.843 0-3.644-.497-5.215-1.438l-.375-.222-3.875 1.013 1.035-3.766-.244-.39A9.962 9.962 0 011.04 11.03C1.043 5.512 5.53 1.02 11.05 1.02c2.64 0 5.12 1.03 6.988 2.9a9.815 9.815 0 012.892 6.991c-.003 5.52-4.49 10.01-10.01 10.01h.012z"
      />,
      {
        viewBox: "0 0 22 22",
        strokeWidth: "0",
