...
const Icon: FunctionComponent<ComponentProps> = ({
  ...
  } else if (icon === IconProp.VMware) {
    /*
     * VMware — hypervisor mark: a host chassis with three virtual machines
     * stacked on the hypervisor layer. Drawn in the outlined house style
     * (currentColor stroke) so it sits at 16px next to the other resource
     * brand logos (Proxmox / Ceph / Docker) without a filled wordmark.
     */
    return getSvgWrapper(
      <>
        <rect x="3" y="4" width="18" height="16" rx="2" />
        <path strokeLinecap="round" d="M3 16h18" />
        <rect x="6" y="7" width="3" height="6" rx="0.75" />
        <rect x="10.5" y="7" width="3" height="6" rx="0.75" />
        <rect x="15" y="7" width="3" height="6" rx="0.75" />
      </>,
    );
