...
const Icon: FunctionComponent<ComponentProps> = ({
  ...
  if (icon === IconProp.Close) {
    ...
    /*
     * Podman glyph — a pod (rounded enclosure) grouping several containers,
     * the defining Podman concept. Drawn in the same line style as the Docker
     * and Kubernetes marks so it sits consistently with the rest of the icon
     * set; the dense official seal logo read as a heavy blob at icon sizes and
     * clashed with the surrounding outline icons.
     */
    return getSvgWrapper(
      <>
        {/* Pod — rounded enclosure */}
        <rect
          x="2.5"
          y="7"
          width="19"
          ...
          strokeLinejoin="round"
        />
        {/* Containers grouped inside the pod */}
        <rect
          x="5.5"
          y="10"
          width="3"
