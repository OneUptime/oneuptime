 ...
 * per-tenant GROUP BY unless the operator asks for it. The core page keeps the
 * Health layout around this content.
 */
const HealthTelemetryContent: FunctionComponent = (): ReactElement => {
...
export default HealthTelemetryContent;
