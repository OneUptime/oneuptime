...
> **Review before merging.** Verify the change keeps behavior identical (only handling/reporting should differ) before approving. Nothing is merged automatically.
