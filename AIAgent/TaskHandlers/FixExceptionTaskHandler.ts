...
interface FixExceptionMetadata {
  exceptionId: string;
...
export default class FixExceptionTaskHandler extends BaseTaskHandler {
  ...
  public async execute(context: TaskContext): Promise<TaskResult> {
    const metadata: FixExceptionMetadata = context.metadata as unknown as FixExceptionMetadata;
...
Automatically generated by OneUptime AI Agent.`;
  ...
  // Validate metadata
  public validateMetadata(metadata: JSONObject): boolean {
    const fixMetadata: FixExceptionMetadata = metadata as unknown as FixExceptionMetadata;
    return Boolean(fixMetadata.exceptionId);
  }
