/* Offline fixture server for the actual discovery components. No app/API server needed. */
const fs = require("fs");
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Discovery fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/network-devices/discovery`,
    );
  });
