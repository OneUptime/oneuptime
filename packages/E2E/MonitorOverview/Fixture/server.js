/*
 * Offline fixture server for the real monitor overview page
 * (Pages/Monitor/View/Layout + Index). No app/API server needed.
 */
const fs = require("fs");
...
const output = path.join(
  repository,
  "output/playwright/monitor-overview-ui/fixture",
);
const port = Number(process.env.MONITOR_OVERVIEW_FIXTURE_PORT || 4223);
const config = createConfig({
  serviceName: "monitor-overview-fixture",
  publicPath: "/dist/",
...
/*
 * The owners in the hero load their avatars from
 * /api/user/profile-picture/:userId. Answer with small generated SVGs so the
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Monitor overview fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/monitors/70000000-0000-4000-8000-000000000001`,
    );
  });
