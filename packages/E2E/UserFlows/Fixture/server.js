/* The production RUM layout and User Flows page; only their API data is synthetic. */
const fs = require("fs");
...
const output = path.join(repository, "output/playwright/user-flows-ui/fixture");
const port = Number(process.env.USER_FLOWS_FIXTURE_PORT || 4219);
const config = createConfig({
  serviceName: "user-flows-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () =>
    console.log(`User flows fixture ready on ${port}`),
  );
