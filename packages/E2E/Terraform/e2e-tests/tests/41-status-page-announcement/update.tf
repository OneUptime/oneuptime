...
# apply + drift gate. Changed vs main.tf: announcement title, description and
# end_announcement_at is now set.
terraform {
  required_providers {
    oneuptime = {
...
resource "oneuptime_status_page_announcement" "announcement" {
  title                                      = "terraform-e2e-announcement-updated"
  description                                = "Announcement updated by Terraform E2E tests"
  show_announcement_at                       = "2030-03-01T00:00:00.000Z"
  end_announcement_at                        = "2030-03-02T00:00:00.000Z"
