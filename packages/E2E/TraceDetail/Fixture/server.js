/* Offline fixture server for the real trace detail page. No app/API server needed. */
const fs = require("fs");
...
const port = Number(process.env.TRACE_DETAIL_FIXTURE_PORT || 4231);
const config = createConfig({
  serviceName: "trace-detail-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Trace detail fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/traces/view/4bf92f3577b34da6a3ce929d0e0e4736`,
    );
  });
