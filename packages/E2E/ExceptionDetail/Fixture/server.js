/* Offline fixture server for the real exception detail pages. No app/API server needed. */
const fs = require("fs");
...
const output = path.join(
  repository,
  "output/playwright/exception-detail-ui/fixture",
);
const port = Number(process.env.EXCEPTION_DETAIL_FIXTURE_PORT || 4221);
const config = createConfig({
  serviceName: "exception-detail-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Exception detail fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/exceptions/50000000-0000-4000-8000-000000000001`,
    );
  });
