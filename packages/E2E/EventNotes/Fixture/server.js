/*
 * Offline fixture server for the real public and private note pages of
 * incidents, alerts, scheduled maintenance and episodes. No app/API server needed.
 */
const fs = require("fs");
...
const output = path.join(
  repository,
  "output/playwright/event-notes-ui/fixture",
);
const port = Number(process.env.EVENT_NOTES_FIXTURE_PORT || 4223);
const config = createConfig({
  serviceName: "event-notes-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Event notes fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/incidents/20000000-0000-4000-8000-000000001042/public-notes`,
    );
  });
