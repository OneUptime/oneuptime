/* Offline fixture server for the actual SLO Burn Rate Rules page. No app/API server needed. */
const fs = require("fs");
...
const output = path.join(repository, "output/playwright/slo-burn-rate/fixture");
const port = Number(process.env.SLO_BURN_RATE_FIXTURE_PORT || 4213);
const config = createConfig({
  serviceName: "slo-burn-rate-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `SLO burn rate rules fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/slos/20000000-0000-4000-8000-000000000001/burn-rate-rules`,
    );
  });
