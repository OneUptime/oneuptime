/* Serve the production products menu and Dashboard catalog in isolation. */
const fs = require("fs");
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () =>
    console.log(`Navigation search fixture ready at http://127.0.0.1:${port}`),
  );
