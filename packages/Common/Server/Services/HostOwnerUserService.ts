...
export class Service extends DatabaseService<Model> {
  ...
  protected override async onDeleteSuccess(
    ...
    for (const item of itemsToDelete) {
      ...
      await HostFeedService.createHostFeedItem({
        hostId: hostId,
        projectId: projectId,
        hostFeedEventType: HostFeedEventType.OwnerUserRemoved,
        displayColor: Red500,
        feedInfoInMarkdown: `👨🏻‍💻 Removed **${user.name.toString()}** (${user.email?.toString()}) as an owner of ${await HostService.getHostMarkdownLink(
          projectId,
          hostId,
        )}.`,
  ...
  public override async onCreateSuccess(
    ...
    if (hostId && userId && projectId) {
      await HostFeedService.createHostFeedItem({
        hostId: hostId,
        projectId: projectId,
        hostFeedEventType: HostFeedEventType.OwnerUserAdded,
        ...
        )}** as an owner of ${await HostService.getHostMarkdownLink(
          projectId,
          hostId,
        )}.`,
