...
{
  public readonly ruleSelect: Select<VMwareVCenterLabelRule> = {
    _id: true,
    name: true,
    criteria: true,
  ...
  public async applyRulesToVMwareVCenter(
    ...
    try {
      ...
      await this.applyRules({ vmwareVCenter: vmwareVCenter, rules: rules });
    } catch (error) {
  ...
  public async applyRulesToExistingResource(
    ...
    try {
      ...
      logger.error(`Error running vCenter label rules: ${error}`, {
  ...
  private async applyRules(data: {
    vmwareVCenter: VMwareVCenter;
    rules: Array<VMwareVCenterLabelRule>;
  }): Promise<RuleApplicationResult> {
