...
@CrudApiEndpoint(new Route("/runbook-owner-team"))
@TableMetadata({
  tableName: "RunbookOwnerTeam",
  singularName: "Runbook Team Owner",
  pluralName: "Runbook Team Owners",
  icon: IconProp.Signal,
  tableDescription: "Add teams as owners to your runbooks.",
})
@Entity({
  name: "RunbookOwnerTeam",
})
@Index(["runbookId", "teamId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["runbookId", "teamId", "projectId"],
  "This team is already an owner of this runbook.",
)
export default class RunbookOwnerTeam extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
