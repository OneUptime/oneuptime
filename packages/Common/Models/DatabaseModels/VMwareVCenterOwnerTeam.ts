...
@TableAccessControl({
  create: [
    ...
    Permission.CreateVMwareVCenterOwnerTeam,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadVMwareVCenterOwnerTeam,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteVMwareVCenterOwnerTeam,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditVMwareVCenterOwnerTeam,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/vmware-vcenter-owner-team"))
@TableMetadata({
  tableName: "VMwareVCenterOwnerTeam",
  singularName: "vCenter Team Owner",
  pluralName: "vCenter Team Owners",
  icon: IconProp.Cube,
  tableDescription: "Add teams as owners to your vCenters.",
})
@Entity({
  name: "VMwareVCenterOwnerTeam",
})
@Index(["vmwareVCenterId", "teamId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["vmwareVCenterId", "teamId", "projectId"],
  "This team is already an owner of this vCenter.",
)
export default class VMwareVCenterOwnerTeam extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
