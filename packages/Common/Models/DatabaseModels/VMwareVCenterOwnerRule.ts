...
@TableAccessControl({
  create: [
    ...
    Permission.CreateVMwareVCenterOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.Viewer,
    Permission.ReadVMwareVCenterOwnerRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteVMwareVCenterOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditVMwareVCenterOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/vmware-vcenter-owner-rule"))
@Entity({
...
export default class VMwareVCenterOwnerRule extends RuleBaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this vCenter owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this vCenter owner rule",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    description:
      "Only trigger for vCenters that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "VMwareVCenterOwnerRuleVMwareVCenterLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "vmwareVCenterOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the vCenter when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @JoinTable({
    name: "VMwareVCenterOwnerRuleOwnerUser",
    inverseJoinColumn: {
      name: "userId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the vCenter when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
  ...
  @JoinTable({
    name: "VMwareVCenterOwnerRuleOwnerTeam",
    inverseJoinColumn: {
      name: "teamId",
      referencedColumnName: "_id",
    },
