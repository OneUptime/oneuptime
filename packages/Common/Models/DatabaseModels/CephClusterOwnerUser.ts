...
@TableAccessControl({
  create: [
    ...
    Permission.CreateCephClusterOwnerUser,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadCephClusterOwnerUser,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteCephClusterOwnerUser,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditCephClusterOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/ceph-cluster-owner-user"))
@TableMetadata({
  tableName: "CephClusterOwnerUser",
  singularName: "Ceph Cluster User Owner",
  pluralName: "Ceph Cluster User Owners",
  icon: IconProp.Cube,
  tableDescription: "Add users as owners to your Ceph clusters.",
})
@Entity({
...
@UniqueColumnsTogether(
  ["cephClusterId", "userId", "projectId"],
  "This user is already an owner of this Ceph cluster.",
)
