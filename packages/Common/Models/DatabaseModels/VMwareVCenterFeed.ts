...
/*
 * Every state change worth remembering about a vCenter. The overview page
 * answers "what does this vCenter look like right now"; the feed answers
 ...
 */
export enum VMwareVCenterFeedEventType {
  VMwareVCenterCreated = "VMwareVCenterCreated",
  VMwareVCenterUpdated = "VMwareVCenterUpdated",
  VMwareVCenterArchived = "VMwareVCenterArchived",
  VMwareVCenterRestored = "VMwareVCenterRestored",
...
@EnableDocumentation()
@CanAccessIfCanReadOn("vmwareVCenter")
...
@TableAccessControl({
  create: [
    ...
    Permission.CreateVMwareVCenterFeed,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadVMwareVCenterFeed,
  ],
  delete: [],
  update: [],
})
@CrudApiEndpoint(new Route("/vmware-vcenter-feed"))
@OwnedThrough("vmwareVCenterId", VMwareVCenter)
@Entity({
...
@Index(["vmwareVCenterId", "postedAt"]) // vCenter feed page: feed sorted by postedAt
export default class VMwareVCenterFeed extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    title: "vCenter",
    description: "Relation to vCenter in which this resource belongs",
  ...
  @TableColumn({
    ...
    required: true,
    title: "vCenter ID",
    description: "Relation to vCenter ID in which this resource belongs",
    example: "e5f6a7b8-d9c0-1234-5678-901234efab56",
  })
  @Column({
    type: ColumnType.ObjectID,
  ...
  @TableColumn({
    ...
    description: "Log of the vCenter change in Markdown",
    example: "👨🏻‍💻 Added **Jane Doe** as the owner of this vCenter.",
  })
  @Column({
  ...
  @TableColumn({
    ...
    example:
      "### Additional Context\n\nThis vCenter was discovered from incoming telemetry.",
  })
  @Column({
    type: ColumnType.Markdown,
    nullable: true,
  ...
  @TableColumn({
    ...
    required: true,
    title: "vCenter Feed Event",
    description: "vCenter Feed Event",
    example: "VMwareVCenterCreated",
  })
  @Column({
  ...
  public vmwareVCenterFeedEventType?: VMwareVCenterFeedEventType = undefined;
