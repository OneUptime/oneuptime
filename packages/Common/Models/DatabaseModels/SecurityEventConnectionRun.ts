...
// Only the worker and the connection operations API write these records.
@EnableDocumentation()
...
@CrudApiEndpoint(new Route("/security-event-connection-run"))
@Entity({ name: "SecurityEventConnectionRun" })
@Index(["projectId", "securityEventConnectionId", "createdAt"])
@TableMetadata({
  tableName: "SecurityEventConnectionRun",
  singularName: "Security Event Connection Run",
  pluralName: "Security Event Connection Runs",
...
export default class SecurityEventConnectionRun extends BaseModel {
  ...
  @TableColumn({
    ...
    manyToOneRelationColumn: "securityEventConnectionId",
    title: "Connection",
  ...
  @JoinColumn({ name: "securityEventConnectionId" })
  public securityEventConnection?: SecurityEventConnection = undefined;
  ...
  public securityEventConnectionId?: ObjectID = undefined;
  ...
  @TableColumn({
    ...
    title: "Requested By",
    description: "The user who requested this run, when it was on demand.",
    required: false,
  })
  @ManyToOne(
    () => {
  ...
  @TableColumn({
    ...
    description: "ID of the user who requested this run.",
    required: false,
    canReadOnRelationQuery: true,
  })
  @Column({
  ...
  public type?: SecurityEventConnectionRunType = undefined;
  ...
  public status?: SecurityEventConnectionRunStatus = undefined;
  ...
  @TableColumn({
    ...
    title: "Result",
    description:
      "Counts, requested time range, checks and a bounded preview of records.",
  })
  @Column({ type: ColumnType.JSON, nullable: true })
