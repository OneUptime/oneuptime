...
@TableAccessControl({
  create: [
    ...
    Permission.CreateRumApplicationOwnerUser,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadRumApplicationOwnerUser,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteRumApplicationOwnerUser,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditRumApplicationOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/rum-application-owner-user"))
@TableMetadata({
  tableName: "RumApplicationOwnerUser",
  singularName: "RUM Application User Owner",
  pluralName: "RUM Application User Owners",
  icon: IconProp.Globe,
  tableDescription: "Add users as owners to your RUM applications.",
})
@Entity({
