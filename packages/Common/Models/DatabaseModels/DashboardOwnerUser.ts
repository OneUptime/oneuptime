...
@TableAccessControl({
  ...
  update: [
    ...
    Permission.ProjectAdmin,
    Permission.ProjectMember,
    Permission.EditDashboardOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/dashboard-owner-user"))
@TableMetadata({
  tableName: "DashboardOwnerUser",
  singularName: "Dashboard User Owner",
  pluralName: "Dashboard User Owners",
  icon: IconProp.Window,
  tableDescription: "Add users as owners to your dashboards.",
})
@Entity({
  name: "DashboardOwnerUser",
})
@Index(["dashboardId", "userId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["dashboardId", "userId", "projectId"],
  "This user is already an owner of this dashboard.",
)
export default class DashboardOwnerUser extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
