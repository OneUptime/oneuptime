...
@TableAccessControl({
  create: [
    ...
    Permission.CreateDatabaseServerOwnerUser,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadDatabaseServerOwnerUser,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteDatabaseServerOwnerUser,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditDatabaseServerOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/database-server-owner-user"))
@TableMetadata({
  tableName: "DatabaseServerOwnerUser",
  singularName: "Database User Owner",
  pluralName: "Database User Owners",
  icon: IconProp.Cube,
  tableDescription: "Add users as owners to your databases.",
})
@Entity({
  name: "DatabaseServerOwnerUser",
})
@Index(["databaseServerId", "userId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["databaseServerId", "userId", "projectId"],
  "This user is already an owner of this database.",
)
export default class DatabaseServerOwnerUser extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    title: "Database",
    description: "Relation to Database Resource in which this object belongs",
  })
  @ManyToOne(
    () => {
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Database ID",
    description: "ID of your OneUptime Database in which this object belongs",
  })
  @Column({
    type: ColumnType.ObjectID,
    nullable: false,
