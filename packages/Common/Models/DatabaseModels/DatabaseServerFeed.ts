...
/*
 * Every state change worth remembering about a database. The overview page
 * answers "what does this database look like right now"; the feed answers
 ...
 */
export enum DatabaseServerFeedEventType {
  DatabaseServerCreated = "DatabaseServerCreated",
  DatabaseServerUpdated = "DatabaseServerUpdated",
  DatabaseServerArchived = "DatabaseServerArchived",
  DatabaseServerRestored = "DatabaseServerRestored",
...
@CrudApiEndpoint(new Route("/database-server-feed"))
...
@Index(["databaseServerId", "postedAt"]) // Database feed page: feed sorted by postedAt
export default class DatabaseServerFeed extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    title: "Database",
    description: "Relation to Database in which this resource belongs",
  ...
  @TableColumn({
    ...
    required: true,
    title: "Database ID",
    description: "Relation to Database ID in which this resource belongs",
    example: "e5f6a7b8-d9c0-1234-5678-901234efab56",
  })
  @Column({
    type: ColumnType.ObjectID,
  ...
  @TableColumn({
    ...
    description: "Log of the database change in Markdown",
    example: "👨🏻‍💻 Added **Jane Doe** as the owner of this database.",
  })
  @Column({
  ...
  @TableColumn({
    ...
    example:
      "### Additional Context\n\nThis database was discovered from incoming telemetry.",
  })
  @Column({
    type: ColumnType.Markdown,
    nullable: true,
  ...
  @TableColumn({
    ...
    required: true,
    title: "Database Feed Event",
    description: "Database Feed Event",
    example: "DatabaseServerCreated",
  })
  @Column({
  ...
  public databaseServerFeedEventType?: DatabaseServerFeedEventType = undefined;
