...
@TableAccessControl({
  create: [
    ...
    Permission.CreateDatabaseServerOwnerTeam,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadDatabaseServerOwnerTeam,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteDatabaseServerOwnerTeam,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditDatabaseServerOwnerTeam,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/database-server-owner-team"))
@TableMetadata({
  tableName: "DatabaseServerOwnerTeam",
  singularName: "Database Team Owner",
  pluralName: "Database Team Owners",
  icon: IconProp.Cube,
  tableDescription: "Add teams as owners to your databases.",
})
@Entity({
  name: "DatabaseServerOwnerTeam",
})
@Index(["databaseServerId", "teamId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["databaseServerId", "teamId", "projectId"],
  "This team is already an owner of this database.",
)
export default class DatabaseServerOwnerTeam extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
