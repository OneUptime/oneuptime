...
@TableAccessControl({
  ...
  update: [
    ...
    Permission.ProjectAdmin,
    Permission.ProjectMember,
    Permission.EditDashboardOwnerTeam,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/dashboard-owner-team"))
@TableMetadata({
  tableName: "DashboardOwnerTeam",
  singularName: "Dashboard Team Owner",
  pluralName: "Dashboard Team Owners",
  icon: IconProp.Window,
  tableDescription: "Add teams as owners to your dashboards.",
})
@Entity({
...
@UniqueColumnsTogether(
  ...
  "This team is already an owner of this dashboard.",
)
