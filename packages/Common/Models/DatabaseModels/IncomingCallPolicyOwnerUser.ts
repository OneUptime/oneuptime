...
@TableAccessControl({
  ...
  update: [
    ...
    Permission.OnCallAdmin,
    Permission.OnCallMember,
    Permission.EditIncomingCallPolicyOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/incoming-call-policy-owner-user"))
@TableMetadata({
  tableName: "IncomingCallPolicyOwnerUser",
  singularName: "Incoming Call Policy User Owner",
  pluralName: "Incoming Call Policy User Owners",
  icon: IconProp.IncomingCall,
  tableDescription: "Add users as owners to your incoming call policies.",
})
@Entity({
  name: "IncomingCallPolicyOwnerUser",
})
@Index(["incomingCallPolicyId", "userId", "projectId"], { unique: true })
@UniqueColumnsTogether(
  ["incomingCallPolicyId", "userId", "projectId"],
  "This user is already an owner of this incoming call policy.",
)
export default class IncomingCallPolicyOwnerUser extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    description:
      "Relation to Incoming Call Policy Resource in which this object belongs",
  })
  @ManyToOne(
    () => {
