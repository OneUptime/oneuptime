  ...
  var r = (function () {
    ...
    P = (function () {
      ...
      return function (b) {
        ...
        c.set(
          "digits",
          ("string" == typeof b ? b : String(b)).match(a).map(Number),
        );
    ...
    V = h(function (a, b, c) {
      ...
      a.forEach(function (a, f) {
        a.get("isTransformFunction")
          ? (d || (d = []), d.push(a.get("prop") + "(" + b[f] + ")"))
          : "opacity" == a.get("prop")
            ? (c.style.opacity = b[f])
            : c.setAttribute(a.get("prop"), b[f]);
      });
    ...
    X = function (a) {
      return v(
        (function () {
          if ("alternate" == a.get("direction")) return C(a);
