...
- **Токен приёма телеметрии OneUptime** — создайте его в _Настройки проекта → Телеметрия и APM → Ключи приема_.
...
- Полные вкладки **Журналы**, **Трассировки**, **Метрики** и **Экземпляры**.
