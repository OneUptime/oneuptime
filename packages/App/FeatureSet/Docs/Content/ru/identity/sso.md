...
> **Редакция:** SSO входит в OneUptime Enterprise Edition. В OneUptime Cloud он доступен начиная с тарифа **Scale**. Для самостоятельно размещённых установок нужны образ Enterprise Edition и лицензия. См. [Enterprise Edition](/docs/self-hosted/enterprise). Без действующей лицензии (после 14-дневного пробного периода или через 14 дней после истечения лицензии) вход через SSO прекращается, а «Require SSO» не применяется, пока не будет активирована лицензия.
