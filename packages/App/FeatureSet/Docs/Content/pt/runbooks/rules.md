...
Regras de runbook anexam runbooks automaticamente quando um **incidente**, **alerta** ou **evento de manutenção programada** é criado. São gerenciadas no menu Regras de cada entidade:
...
| **Habilitado**            | Toggle para suspender uma regra sem apagá-la.                                              |
| **Padrão de título**      | Regex case-insensitive testado contra o título da entidade. Vazio = qualquer título.       |
| **Padrão de descrição**   | Regex case-insensitive testado contra a descrição da entidade. Vazio = qualquer descrição. |
| **Runbooks para iniciar** | Um ou mais runbooks a disparar quando a regra casa.                                        |
