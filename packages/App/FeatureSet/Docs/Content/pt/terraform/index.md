...
The API key must be a **project API key** created in **Configurações do projeto > Chaves de API** in the OneUptime dashboard. See the [Quick Start](/docs/terraform/quick-start) for the full walkthrough.
