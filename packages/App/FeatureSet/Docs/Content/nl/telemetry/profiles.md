...
exporters:
  otlphttp:
    ...
    # Zonder deze regel verstuurt de exporter naar /otlp/v1development/profiles, dat OneUptime niet bedient
...
service:
  pipelines:
    # Vereist dat de collector start met --feature-gates=service.profilesSupport
    profiles:
      receivers: [otlp]
      exporters: [otlphttp]
```
