...
| 交换分区使用率      | 当前交换分区利用率百分比                 |
| CPU IO 等待率       | CPU 用于等待 I/O 的时间百分比            |
| 平均负载（1 分钟）  | 最近 1 分钟的系统平均负载                |
| 平均负载（5 分钟）  | 最近 5 分钟的系统平均负载                |
| 平均负载（15 分钟） | 最近 15 分钟的系统平均负载               |
...
对于数值指标（CPU、内存、磁盘、交换分区、IO 等待、平均负载）：
