...
1. Apri **Flussi di lavoro → Crea flusso di lavoro**, chiamalo `Incidents → Telegram` e apri il **Costruttore**.
...
- Usa **Condizioni** per filtrare per severità prima di inviare.
