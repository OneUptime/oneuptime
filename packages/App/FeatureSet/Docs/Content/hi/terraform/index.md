...
The API key must be a **project API key** created in **प्रोजेक्ट सेटिंग्स > API कुंजियाँ** in the OneUptime dashboard. See the [Quick Start](/docs/terraform/quick-start) for the full walkthrough.
