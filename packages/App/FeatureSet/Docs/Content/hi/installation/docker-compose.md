...
- **Backups**: अपने databases (Clickhouse, Postgres) को नियमित रूप से backup करें। cache stateless है और इसे safely ignore किया जा सकता है।
- **Cache और queues**: `valkey` service [Valkey](https://valkey.io) चलाती है, जो Redis 7.2 का BSD-licensed fork है, और इसे `config.env` में मौजूद `VALKEY_*` settings के माध्यम से configure किया जाता है। कोई भी Redis-protocol server काम करता है — यदि आप चाहें तो `VALKEY_HOST` को किसी managed Redis की ओर point करें। ये settings 13.0.0 तक `REDIS_*` नाम से थीं; पुराने नाम अब भी पढ़े जाते हैं, container अब भी `redis` hostname पर उत्तर देता है, और `npm run update` उन्हें दोबारा नहीं लिखेगा, इसलिए पुराने `config.env` में किसी संपादन की आवश्यकता नहीं है।
