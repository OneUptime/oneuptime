...
OBI सर्विस सीमाओं के पार ट्रेस कॉन्टेक्स्ट भी प्रसारित कर सकता है, ताकि पॉड B की तरफ का span पॉड A के आउटबाउंड रिक्वेस्ट के समान ट्रेस में लिंक हो जाए — किसी भी ऐप में SDK परिवर्तन किए बिना। **यह डिफ़ॉल्ट रूप से बंद है; इसे `--set ebpf.contextPropagation=true` के साथ चालू करें।**

| विकल्प                     | डिफ़ॉल्ट | विवरण                                                                                                                                                        |
| -------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ebpf.contextPropagation`  | off      | आउटबाउंड ट्रैफ़िक में W3C `traceparent` इंजेक्ट करें ताकि spans सर्विसों के पार लिंक हों। डिफ़ॉल्ट रूप से बंद — पहले नीचे दी गई चेतावनी पढ़ें। कोई अतिरिक्त kernel आवश्यकता नहीं; कोई भी kernel संस्करण इसे निष्क्रिय नहीं करता। |
| `ebpf.contextPropagationMode` | headers | `traceparent` कैसे इंजेक्ट होता है: `headers` (HTTP/1.1 रिक्वेस्ट हेडर्स, सबसे सीमित), `tcp` (Linux Traffic Control के ज़रिए TCP विकल्प) या `all` (दोनों)। केवल तभी पढ़ा जाता है जब `contextPropagation` सत्य हो। |
...
> **⚠️ यह डिफ़ॉल्ट रूप से बंद क्यों है।** हर प्रसार मोड पहले से प्रवाहित ट्रैफ़िक को बदलता है: सादे HTTP requests को कर्नेल में यथास्थान चौड़ा किया जाता है, जबकि TLS और रॉ TCP में Traffic Control hook से एक TCP विकल्प जोड़ा जाता है। यदि कनेक्शन का बाइट-लेखा ठीक-ठीक सही न किया जाए तो स्ट्रीम असंगत हो जाती है — रिपोर्ट किया गया लक्षण यह है कि nginx जैसे L7 प्रॉक्सी से गुज़रने वाले ट्रांसफ़र प्रतिक्रिया के ~64KB पार करते ही body के बीच में अटक जाते हैं, जबकि छोटे requests काम करते रहते हैं, जिससे यह एजेंट की नहीं बल्कि ऐप्लिकेशन की गड़बड़ी जैसा लगता है। Traces, RED मेट्रिक्स और सर्विस मैप इस पर निर्भर नहीं हैं; सेवाओं के बीच लिंकिंग के लिए OpenTelemetry SDK, जो हेडर को बिना कर्नेल पुनर्लेखन के userspace में प्रसारित करता है, अधिक सुरक्षित विकल्प है।
...
| `profiling.tracers`           | `""` _(सभी रनटाइम)_ | लोड करने के लिए भाषा ट्रेसर्स की अल्पविराम-अलग सूची।                                                                                                   |
