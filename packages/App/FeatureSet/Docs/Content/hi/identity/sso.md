...
> **संस्करण:** SSO, OneUptime Enterprise Edition का हिस्सा है। OneUptime Cloud पर यह **Scale** प्लान और उससे ऊपर उपलब्ध है। सेल्फ़-होस्टेड इंस्टॉलेशन के लिए Enterprise Edition इमेज और एक लाइसेंस चाहिए। [Enterprise Edition](/docs/self-hosted/enterprise) देखें।
