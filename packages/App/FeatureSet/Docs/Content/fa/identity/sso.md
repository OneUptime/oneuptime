...
> **نسخه:** SSO بخشی از نسخه سازمانی OneUptime (Enterprise Edition) است. در OneUptime Cloud از طرح **Scale** به بالا در دسترس است. نصب‌های خودمیزبان به ایمیج نسخه سازمانی و یک مجوز نیاز دارند. [Enterprise Edition](/docs/self-hosted/enterprise) را ببینید. بدون مجوز معتبر (پس از دوره آزمایشی ۱۴ روزه، یا ۳۰ روز پس از انقضای مجوز)، ورود با SSO متوقف می‌شود و «Require SSO» تا زمان فعال شدن یک مجوز اعمال نمی‌شود.
