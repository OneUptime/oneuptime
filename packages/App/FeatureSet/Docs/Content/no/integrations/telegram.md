...
1. Åpne **Arbeidsflyter → Opprett arbeidsflyt**, gi den navnet `Incidents → Telegram`, og åpne **Bygger**.
...
- Bruk **Betingelser** for å filtrere etter alvorlighetsgrad før sending.
