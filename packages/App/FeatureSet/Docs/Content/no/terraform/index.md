...
The API key must be a **project API key** created in **Prosjektinnstillinger > API-nøkler** in the OneUptime dashboard. See the [Quick Start](/docs/terraform/quick-start) for the full walkthrough.
