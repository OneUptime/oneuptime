...
> **Utgave:** SSO er en del av OneUptime Enterprise Edition. På OneUptime Cloud er det tilgjengelig på **Scale**-planen og høyere. Selvdriftede installasjoner trenger Enterprise Edition-imaget og en lisens. Se [Enterprise Edition](/docs/self-hosted/enterprise). Uten en gyldig lisens (etter den 14 dager lange prøveperioden, eller 14 dager etter at en lisens er utløpt) stopper SSO-pålogging, og «Require SSO» håndheves ikke før en lisens aktiveres.
...
1. **Naviger til prosjektinnstillinger**
   ...
   - Naviger til **Prosjektinnstillinger** > **Sikkerhet** > **SSO**
...
2. Naviger til **Prosjektinnstillinger** > **Sikkerhet** > **SSO**
