...
For at begynde skal du oprette en brugerdefineret probe i dit OneUptime Dashboard under Overvågninger > Indstillinger > Sonder. Når du har oprettet den brugerdefinerede probe på dit OneUptime-dashboard, bør du have `PROBE_ID` og `PROBE_KEY`.
...
- `PROBE_MONITOR_RETRY_LIMIT` – Genforsøg efter det første forsøg ved et mislykket monitortjek, brugt når et trin ikke selv angiver et antal (standard: 3, altså op til 4 forsøg)
