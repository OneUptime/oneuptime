...
- Un **Token de Ingesta de Telemetría de OneUptime**: crea uno desde _Ajustes del proyecto → Telemetría y APM → Claves de Ingesta_ y copia el valor `x-oneuptime-token`.
...
También puedes aplicar automáticamente etiquetas y propietarios mediante _Serverless → Ajustes → Reglas de etiquetas / Reglas del propietario_.
