...
/*
 * What "@oneuptime/ee-admin-dashboard" resolves to in the Community Edition:
 * no enterprise screens at all, so every shell renders its upsell card.
 *
 ...
 */
const CommunityPlugins: AdminDashboardEnterprisePlugins = {};
