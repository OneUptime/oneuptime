...
/*
 * What Settings > Global SSO shows without the Enterprise Edition: the
 * settings layout around the enterprise upsell card. Both Global SSO shells
 * (the provider list and one provider) render it.
 */
const GlobalSSOUpsell: FunctionComponent = (): ReactElement => {
...
export default GlobalSSOUpsell;
