...
const VMwareVCenterScheduledMaintenance: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  if (modelId) {
    query.vmwareVCenters = new Includes([modelId]);
  }
  ...
  return (
    <Fragment>
      <ScheduledMaintenancesTable
        ...
        noItemsMessage="No scheduled maintenance events for this vCenter."
      />
    </Fragment>
  );
};

export default VMwareVCenterScheduledMaintenance;
