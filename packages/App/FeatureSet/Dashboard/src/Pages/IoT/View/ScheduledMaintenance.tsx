...
const IoTFleetScheduledMaintenance: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  if (modelId) {
    query.iotFleets = new Includes([modelId]);
  }
  ...
  return (
    <Fragment>
      <ScheduledMaintenancesTable
        ...
        noItemsMessage="No scheduled maintenance events for this fleet."
      />
    </Fragment>
  );
};

export default IoTFleetScheduledMaintenance;
