...
const IoTFleetSideMenu: FunctionComponent<ComponentProps> = (
      ...
      <SideMenuSection title="Telemetry">
        <SideMenuItem
          link={{
            title: "Metrics",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_METRICS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Graph}
        ...
        <SideMenuItem
          link={{
            title: "Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Logs}
      ...
      <SideMenuSection title="Resources">
        <SideMenuItem
          link={{
            title: "Devices",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_DEVICES] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Cube}
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          link={{
            title: "Incidents",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_INCIDENTS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Alert}
          ...
          countQuery={{
            projectId: projectId!,
            iotFleets: new Includes([props.modelId]),
        ...
        <CountModelSideMenuItem<Alert>
          link={{
            title: "Alerts",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_ALERTS] as Route,
              { modelId: props.modelId },
            ),
          }}
      ...
      <SideMenuSection title="Advanced">
        <SideMenuItem
          link={{
            title: "Owners",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_OWNERS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Team}
        ...
        <SideMenuItem
          link={{
            title: "Settings",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_SETTINGS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            title: "Audit Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_AUDIT_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
        ...
        <SideMenuItem
          link={{
            title: "Delete Fleet",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.IOT_FLEET_VIEW_DELETE] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Trash}
...
export default IoTFleetSideMenu;
