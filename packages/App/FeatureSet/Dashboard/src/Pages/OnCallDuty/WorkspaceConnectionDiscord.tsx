...
const OnCallDutyDiscordPage: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
      ...
      {!isDiscordConnected && (
        <div>
          <EmptyState
            ...
            description="Connect your Discord server to receive on-call policy execution notifications. Please go to Project Settings > Workspace Connections > Discord to connect your server."
          />
        </div>
      )}
    </div>
...
export default OnCallDutyDiscordPage;
