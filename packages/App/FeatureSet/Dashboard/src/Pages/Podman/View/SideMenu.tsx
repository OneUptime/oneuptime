...
const PodmanHostSideMenu: FunctionComponent<ComponentProps> = (
    ...
    <SideMenu>
      ...
      <SideMenuSection title="Workloads">
        <SideMenuItem
          link={{
            title: "Containers",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_CONTAINERS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Cube}
      ...
      <SideMenuSection title="Observability">
        <SideMenuItem
          link={{
            title: "Metrics",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_METRICS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            title: "Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            title: "Traces",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_TRACES] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            ...
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_PROFILES] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Fire}
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          ...
          countQuery={{
            projectId: projectId!,
            podmanHosts: new Includes([props.modelId]),
        ...
        <CountModelSideMenuItem<Alert>
          link={{
            title: "Alerts",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_ALERTS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <CountModelSideMenuItem<ScheduledMaintenance>
          link={{
            ...
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_SCHEDULED_MAINTENANCE] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Clock}
      ...
      <SideMenuSection title="Advanced">
        <SideMenuItem
          link={{
            title: "Owners",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_OWNERS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Team}
        ...
        <SideMenuItem
          link={{
            title: "Feed",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_FEED] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
        ...
        <SideMenuItem
          link={{
            title: "Settings",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_SETTINGS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            title: "Audit Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_AUDIT_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
        ...
        <SideMenuItem
          link={{
            title: "Delete Host",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.PODMAN_HOST_VIEW_DELETE] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Trash}
...
export default PodmanHostSideMenu;
