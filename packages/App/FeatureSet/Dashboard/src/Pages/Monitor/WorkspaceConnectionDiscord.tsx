...
const MonitorsDiscordPage: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
      ...
      {!isDiscordConnected && (
        <div>
          <EmptyState
            ...
            description="Connect your Discord server to receive monitor status change notifications. Please go to Project Settings > Workspace Connections > Discord to connect your server."
          />
        </div>
      )}
    </div>
...
export default MonitorsDiscordPage;
