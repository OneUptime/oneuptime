...
Database Owner Rules add owner users and teams to a database automatically when it matches your criteria — without anyone having to remember to assign owners.
...
const DatabaseServerOwnerRulesPage: FunctionComponent<RuleSettingsPageProps> = (
  props: RuleSettingsPageProps,
): ReactElement => {
  return (
    <RuleTable<DatabaseServerOwnerRule>
      ...
      listRoute={RuleViewPageUtil.getListRoute(
        PageMap.DATABASE_SETTINGS_OWNER_RULES,
      )}
      getRuleViewRoute={(rule: DatabaseServerOwnerRule): Route => {
        return RuleViewPageUtil.getRuleViewRoute(
          PageMap.DATABASE_SETTINGS_OWNER_RULE_VIEW,
          rule,
        );
      }}
      id="database-server-owner-rules-table"
      name="Settings > Database Owner Rules"
      userPreferencesKey="database-server-owner-rules-table"
      saveFilterProps={{
        tableId: "database-server-owner-rules-table",
      }}
      isDeleteable={true}
      isEditable={true}
      isCreateable={true}
      ...
      cardProps={{
        title: "Database Owner Rules",
        description:
          "Auto-assign owner users and teams when matching databases are created.",
      }}
      helpContent={{
        title: "How Database Owner Rules Work",
        description: "Match databases and add owner users/teams automatically.",
        markdown: databaseServerOwnerDocumentation,
      }}
      sortBy="name"
      ...
      columns={[
        ...
        },
        {
          ...
          title: "Status",
          type: FieldType.Boolean,
          getElement: (item: DatabaseServerOwnerRule): ReactElement => {
      ...
      formFields={[
        {
          ...
          required: true,
          placeholder: "Assign team to matching databases",
        ...
        },
        {
          ...
          sectionDescription:
            "Filter databases by labels. Leave empty to skip the filter.",
...
export default DatabaseServerOwnerRulesPage;
