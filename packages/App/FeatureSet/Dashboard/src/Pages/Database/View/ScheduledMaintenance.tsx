...
const DatabaseServerScheduledMaintenance: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  return (
    <Fragment>
      <ScheduledMaintenancesTable
        ...
        noItemsMessage="No scheduled maintenance events for this database."
      />
    </Fragment>
  );
};

export default DatabaseServerScheduledMaintenance;
