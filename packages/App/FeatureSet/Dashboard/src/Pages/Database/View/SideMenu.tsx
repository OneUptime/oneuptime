...
const DatabaseServerSideMenu: FunctionComponent<ComponentProps> = (
    ...
    <SideMenu>
      ...
      <SideMenuSection title="Observability">
        ...
        <SideMenuItem
          link={{
            title: "Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            title: "Traces",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_TRACES] as Route,
              { modelId: props.modelId },
            ),
          }}
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          ...
          countQuery={{
            projectId: projectId!,
            databaseServers: new Includes([props.modelId]),
        ...
        <CountModelSideMenuItem<Alert>
          link={{
            title: "Alerts",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_ALERTS] as Route,
              { modelId: props.modelId },
            ),
          }}
      ...
      <SideMenuSection title="Advanced">
        ...
        <SideMenuItem
          link={{
            title: "Owners",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_OWNERS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Team}
        ...
        <SideMenuItem
          link={{
            title: "Feed",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_FEED] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
        ...
        <SideMenuItem
          link={{
            ...
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DATABASE_SERVER_VIEW_DELETE] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Trash}
...
export default DatabaseServerSideMenu;
