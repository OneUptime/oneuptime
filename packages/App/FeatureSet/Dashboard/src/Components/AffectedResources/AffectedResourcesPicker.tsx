 ...
 *
 * Anything that is not an array renders as nothing. The form briefly holds
 * our whole payload in the field the picker is registered on (FormField sets
 * it before the page's queued splitter runs); a synchronous flush renders
 * that state, and iterating it would throw.
 */
const toItems: (
    ...
    <div ref={containerRef} className="relative mt-1 w-full">
      ...
      {hiddenCount > 0 && (
        <div
          ...
          className="mb-2 flex items-start gap-1.5 text-xs text-gray-500"
        >
          <Icon
            icon={IconProp.Lock}
