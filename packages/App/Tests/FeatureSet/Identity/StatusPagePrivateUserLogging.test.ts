...
import statusPageScimRouter from "../../../FeatureSet/Identity/API/StatusPageSCIM";
...
jest.mock("Common/Server/Middleware/SCIMAuthorization", () => {
  return {
    __esModule: true,
...
jest.mock("../../../FeatureSet/Identity/Utils/SCIMLogger", () => {
  return {
