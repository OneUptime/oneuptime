enum PageMap {
    ...
    AI_COPILOT_CODE_REPOSITORY_VIEW = 'AI_COPILOT_VIEW',
    AI_COPILOT_CODE_REPOSITORY_VIEW_DELETE = 'AI_COPILOT_VIEW_DELETE',
    AI_COPILOT_CODE_REPOSITORY_VIEW_SETTINGS = 'AI_COPILOT_VIEW_SETTINGS',
