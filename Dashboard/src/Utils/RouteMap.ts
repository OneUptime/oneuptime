...
const RouteMap: Dictionary<Route> = {
    ...
    [PageMap.INCIDENTS]: new Route(`/dashboard/${RouteParams.ProjectID}/incidents/`),
    [PageMap.STATUS_PAGE]: new Route(`/dashboard/${RouteParams.ProjectID}/status-pages/`),
    ...
    [PageMap.ON_CALL]: new Route(`/dashboard/${RouteParams.ProjectID}/on-call/`),
    ...
    // Settings Routes
    [PageMap.SETTINGS]: new Route(`/dashboard/${RouteParams.ProjectID}/settings/`),
