...
export const  FETCH_ERROR_METRICS_REQUEST: string = 'FETCH_ERROR_METRICS_REQUEST';
export const  FETCH_ERROR_METRICS_SUCCESS: string = 'FETCH_ERROR_METRICS_SUCCESS';
export const  FETCH_ERROR_METRICS_FAILURE: string = 'FETCH_ERROR_METRICS_FAILURE';
...
export const  FETCH_INCOMING_METRICS_REQUEST: string = 'FETCH_INCOMING_METRICS_REQUEST';
export const  FETCH_INCOMING_METRICS_SUCCESS: string = 'FETCH_INCOMING_METRICS_SUCCESS';
export const  FETCH_INCOMING_METRICS_FAILURE: string = 'FETCH_INCOMING_METRICS_FAILURE';

export const  FETCH_OUTGOING_METRICS_REQUEST: string = 'FETCH_OUTGOING_METRICS_REQUEST';
export const  FETCH_OUTGOING_METRICS_SUCCESS: string = 'FETCH_OUTGOING_METRICS_SUCCESS';
export const  FETCH_OUTGOING_METRICS_FAILURE: string = 'FETCH_OUTGOING_METRICS_FAILURE';
