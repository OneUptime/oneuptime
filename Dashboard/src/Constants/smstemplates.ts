export const SMS_TEMPLATES_SUCCESS: string =
    'smstemplates/SMS_TEMPLATES_SUCCESS';
export const SMS_TEMPLATES_FAILED: string = 'smstemplates/SMS_TEMPLATES_FAILED';
export const SMS_TEMPLATES_REQUEST: string =
...
export const CHANGE_SHOWING_TEMPLATE: string =
    'smstemplates/CHANGE_SHOWING_TEMPLATE';

export const SET_REVEAL_VARIABLE: string = 'smstemplates/SET_REVEAL_VARIABLE';

export const SET_SMTP_CONFIG: string = 'smstemplates/SET_SMTP_CONFIG';

export const SMTP_CONFIG_SUCCESS: string = 'smstemplates/SMTP_CONFIG_SUCCESS';
