...
export const NOTIFICATION_CLOSED_SUCCESS: $TSFixMe =
    'feedback/NOTIFICATION_CLOSED_SUCCESS';
export const ALL_NOTIFICATION_READ_SUCCESS: $TSFixMe =
