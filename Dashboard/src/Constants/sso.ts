export const CREATE_SSO_REQUEST: string = 'CREATE_SSO_REQUEST';
export const CREATE_SSO_SUCCESS: string = 'CREATE_SSO_SUCCESS';
export const CREATE_SSO_FAILURE: string = 'CREATE_SSO_FAILURE';
...
export const DELETE_SSO_SUCCESS: string = 'DELETE_SSO_REQUEST';
export const DELETE_SSO_FAILURE: string = 'DELETE_SSO_FAILURE';
