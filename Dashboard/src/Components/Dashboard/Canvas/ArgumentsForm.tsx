...
const ArgumentsForm: FunctionComponent<ComponentProps> = (
  ...
  const [component, setComponent] = useState<DashboardBaseComponent>(props.component);
  ...
  const componentType: ObjectType = component._type;
  const componentArguments: Array<ComponentArgument<DashboardBaseComponent>> = DashboardComponentsUtil.getComponentSettingsArguments(componentType);
        ...
        {componentArguments &&
          componentArguments.length > 0 && (
            <BasicForm
              ...
              fields={
                componentArguments &&
                componentArguments.map((arg: ComponentArgument<DashboardBaseComponent>) => {
                  return {
                    title: `${arg.name}`,
                    description: `${
