...
const IncomingRequestMonitorView: FunctionComponent<ComponentProps> = (
    ...
    return <div className='flex space-x-3 justify-between'>
        <InfoCard title='Request Received At' value={props.incomingMonitorRequest?.incomingRequestReceivedAt ? OneUptimeDate.getDateAsLocalFormattedString(props.incomingMonitorRequest.incomingRequestReceivedAt) : '-'} />
    </div>
};
