...
const NotificationRuleConditions: FunctionComponent<ComponentProps> = (
    ...
    const [notificationRuleConditions, setNotificationRuleConditions] = React.useState<
    ...
    return (
        <div>
            ...
            {notificationRuleConditions.length === 0 && (
                <p>
                    This rule will trigger for all {props.eventType} events.
                </p>
            )}

            {notificationRuleConditions.map((i: NotificationRuleCondition, index: number) => {
                return (
            ...
            <div className="mt-3 -ml-3">
                <Button
                    ...
                    onClick={() => {
                        ...
                        const checkOnByEventType: Array<NotificationRuleConditionCheckOn> = NotificationRuleConditionUtil.getCheckOnByEventType(
                            props.eventType,
                        );


                        const conditionTypes: Array<ConditionType> = NotificationRuleConditionUtil.getConditionTypeByCheckOn(
