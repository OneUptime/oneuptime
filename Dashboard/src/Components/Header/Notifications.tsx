...
const DashboardHeader = (): ReactElement => {
    ...
    return (
        <HeaderIconDropdownButton icon={IconProp.Help}>
            <IconDropdwonMenu>
                <IconDropdwonRow>
                    <IconDropdwonItem title="Support Email" icon={IconProp.Email} url={URL.fromString("https://google.com")} />
                    <IconDropdwonItem title="Chat on Slack" icon={IconProp.Slack} url={URL.fromString("https://google.com")} />
                </IconDropdwonRow>
            </IconDropdwonMenu>
