...
const StatusPageMicrosoftTeamsSubscribers: FunctionComponent<PageComponentProps> = (
  ...
  useEffect(() => {
    ...
    const formFields: Array<ModelField<StatusPageSubscriber>> = [
      {
        field: {
          microsoftTeamsChannelName: true,
        },
        stepId: "subscriber-info",
        title: "Microsoft Teams Channel Name",
        description: "Name of the Microsoft Teams channel for identification.",
        fieldType: FormFieldSchemaType.Text,
        required: true,
        placeholder: "my-company-channel",
      },
      {
        field: {
        ...
        description: "Status page updates will be sent to this Microsoft Teams channel.",
      ...
      },
      {
        ...
        stepId: "subscriber-info",
        description:
          "Send a notification to the Microsoft Teams channel confirming the subscription.",
...

      {
        ...
        title: "Unsubscribe",
        stepId: "subscriber-info",
        description: "Unsubscribe this Microsoft Teams channel from the status page.",
        fieldType: FormFieldSchemaType.Toggle,
        required: false,
        ...
        <>
          ...
          <ModelTable<StatusPageSubscriber>
            ...
            query={{
              ...
              microsoftTeamsChannelName: new NotNull(),
            }}
            onBeforeCreate={(
