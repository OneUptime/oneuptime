      ...
      {!isMicrosoftTeamsConnected && (
        <div>
          <EmptyState
            ...
            description="Connect your Microsoft Teams workspace to receive monitor status change notifications. Please go to Project Settings > Workspace Connections > Microsoft Teams to connect your workspace."
          />
        </div>
      )}
    </div>
