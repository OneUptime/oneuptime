...
> = (): ReactElement => {
  ...
  return (
    <Fragment>
      <ModelTable<ServiceOwnerTeam>
        modelType={ServiceOwnerTeam}
        ...
        columns={[
          {
            ...
            getElement: (item: ServiceOwnerTeam): ReactElement => {
              if (!item["team"]) {
      ...
      <ModelTable<ServiceOwnerUser>
        modelType={ServiceOwnerUser}
        ...
        columns={[
          {
            ...
            getElement: (item: ServiceOwnerUser): ReactElement => {
              if (!item["user"]) {
