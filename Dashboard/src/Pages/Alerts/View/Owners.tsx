    ...
    <Fragment>
      <ModelTable<AlertOwnerTeam>
        ...
        cardProps={{
          title: "Owners (Teams)",
          description:
            "Here is list of teams that own this alert. They will be alerted when this alert is created or updated.",
        }}
        noItemsMessage={"No teams associated with this alert so far."}
        formFields={[
          {
            field: {
              team: true,
        ...
        columns={[
          {
            ...
            getElement: (item: AlertOwnerTeam): ReactElement => {
              if (!item["team"]) {
      ...
      <ModelTable<AlertOwnerUser>
        ...
        cardProps={{
          title: "Owners (Users)",
          description:
            "Here is list of users that own this alert. They will be alerted when this alert is created or updated.",
        }}
        noItemsMessage={"No users associated with this alert so far."}
        formFields={[
          {
            field: {
              user: true,
        ...
        columns={[
          {
            ...
            getElement: (item: AlertOwnerUser): ReactElement => {
              if (!item["user"]) {
