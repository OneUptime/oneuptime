...
const Settings: FunctionComponent<ComponentProps> = (
    ...
    useAsyncEffect(async () => {
        ...
        try {
            const project: Project | null = await ModelAPI.getItem<Project>(Project, DashboardNavigation.getProjectId()!, {
                reseller: {
                    name: true,
                    description: true,
                    _id: true,
            ...
            {!isLoading && !error ? <div>
                ...
                >
                    ...
                    <div className='space-y-2'>
                        <div className='text-sm font-medium text-gray-500'>The plan you purchased from {reseller.name} is {resellerPlan?.name}</div>
                        <div>
                            <span className='text-sm font-medium text-gray-500 mt-10'>With the following restrictions:</span>

                            <ul className='space-y-1'>
                                <li className='text-sm font-medium text-gray-500'> - Monitor Limit: <span className='text-gray-700'>{resellerPlan?.monitorLimit} monitors</span></li>
                                <li className='text-sm font-medium text-gray-500'> - Team Member Limit: <span className='text-gray-700'>{resellerPlan?.teamMemberLimit}</span></li>
                            </ul>
                        </div>
