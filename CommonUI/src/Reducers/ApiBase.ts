...
const reducer = (
    ...
    switch (action.type) {
        case ApiBaseConstants.REQUEST:
            return Object.assign({}, state, { requesting: (action.payload as ApiRequest).requesting });
        case ApiBaseConstants.ERROR:
            return Object.assign({}, state, { error: (action.payload as ApiError).error });
        case ApiBaseConstants.RESET:
            return Object.assign({}, state, initialState);
        case ApiBaseConstants.SUCCESS:
            return Object.assign({}, state, { success: (action.payload as ApiSuccess).data });
        default:
            return state;
    };
};
