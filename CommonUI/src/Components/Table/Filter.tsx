    ...
    return (<div>
        <div className="relative">
            ...
            <div className="relative flex justify-center">
                <span className="bg-white px-2 text-sm text-gray-500">Filter By</span>
            </div>
        </div>
        <div className="pt-3 pb-5">
            <div className="grid grid-cols-6 sm:grid-cols-12 md:grid-cols-12 gap-6">
                {props.showFilter &&
                    ...
                    !props.filterError && props.columns && props.columns.filter((column) => (column.isFilterable && column.key)).map((column: Column, i: number) => {
                        return (<div className='col-span-3 sm:col-span-3 '>
                            <label className='block text-sm font-medium text-gray-700'>{column.title}</label>
                            {(column.type ===
                                FieldType.Entity ||
                                column.type ===
