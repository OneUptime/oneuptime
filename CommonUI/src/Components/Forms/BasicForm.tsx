...
const BasicForm: Function = <T extends Object>(
    ...
    const validate: ((
        ...
        Function = (values: FormValues<T>): FormikErrors<FormValues<T>> => {
            ...
            const totalValidationErrors: FormikErrors<
                FormValues<T>
            > = { ...errors, ...customValidateResult } as FormikErrors<
                FormValues<T>
            >;
            ...
            if (props.onFormValidationErrorChanged) {
                props.onFormValidationErrorChanged(Object.keys(totalValidationErrors).length !== 0)
            }
