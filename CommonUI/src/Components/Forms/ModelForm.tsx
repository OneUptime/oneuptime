                    ...
                    if (field.dropdownModal && field.dropdownModal.type) {
                        ...
                        if (listResult.data && listResult.data.length > 0) {
                            ...
                            if (hasAccessControlColumn) {
                                ...
                                let labels: Array<AccessControlModel> = [];
                                ...
                                for (const item of listResult.data) {
                                    ...
                                    for (const label of labels) {
                                        if (
                                            ...
                                            const existingLabel: AccessControlModel | undefined = labels.find((i: AccessControlModel) => {
                                ...
                                labels = labels.sort(
                                    (a: AccessControlModel, b: AccessControlModel) => {
                                        return a.getColumnValue('name')!.toString().localeCompare(b.getColumnValue('name')?.toString() || '');
                                    }
                                );
                                ...
                                for (const label of labels) {
                                    categories.push({
                                        ...
                                        title: (<Pill
                                            color={label.getColumnValue('color') as Color || Black}
