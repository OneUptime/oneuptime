...
export interface ModelField<TBaseModel extends BaseModel> extends Field<TBaseModel> {
    overrideField?:
        | {
    ...
    props: ComponentProps<TBaseModel>
        ...
        const setFormFields: () => Promise<void> = async (): Promise<void> => {
            ...
            for (const field of props.fields) {
                const fieldObj: {
                    [field: string]: true;
                } | SelectFormFields<TBaseModel> | undefined = field.field || field.overrideField;
                ...
                if (keys.length > 0) {
                    ...
                    if (
                        ...
                        fieldsToSet.filter((i: ModelField<TBaseModel>) => {
                            const fieldObj: {
                                [field: string]: true;
                            } | SelectFormFields<TBaseModel> | undefined = i.field || i.overrideField;
