...
const DateFilter: DateFilterFunction = <T extends GenericObject>(
  ...
  return (<StartAndEndDate initialValue={filterData[filter.key] as InBetween} onValueChanged={(inBetween: InBetween | null) => {
  ...
  }} type={filter.type === FieldType.DateTime ? StartAndEndDateType.DateTime : StartAndEndDateType.Date} />);
};
