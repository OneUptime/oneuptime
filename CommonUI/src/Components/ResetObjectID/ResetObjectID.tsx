...
const ResetObjectID: <TBaseModel extends BaseModel>(
    ...
    props: ComponentProps<TBaseModel>
        ...
        const tableColumn: TableColumnMetadata | undefined = props.fieldName ? model.getTableColumnMetadata(props.fieldName as string) : undefined;
        const tableColumnName: string = tableColumn?.title || props.fieldName as string;
        ...
        return (
            <>
                ...
                {showResultModal ? (
                    <ConfirmModal
                        description={`Your new ${tableColumnName} is ${newId?.toString() || ''}`}
