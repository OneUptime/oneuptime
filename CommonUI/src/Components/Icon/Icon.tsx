...
const Icon: FunctionComponent<ComponentProps> = ({
    ...
    const getSvgWrapper = (children: ReactElement | Array<ReactElement>): ReactElement => {
        return (<svg onClick={() => {
            onClick && onClick();
    ...
    if (icon === IconProp.Close) {
        ...
        return getSvgWrapper(<path fillRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clipRule="evenodd" />);
        ...
        return getSvgWrapper(<path fill-rule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clip-rule="evenodd" />)
    } else if (icon == IconProp.ChevronRight) {
        return getSvgWrapper(<path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />)
    ...
    } else if (icon === IconProp.Anouncement) {
        return getSvgWrapper(
