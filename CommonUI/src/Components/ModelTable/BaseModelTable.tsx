...
const BaseModelTable: <TBaseModel extends BaseModel | AnalyticsBaseModel>(
    ...
    props: ComponentProps<TBaseModel>
        ...
        const getFilterDropdownItems: PromiseVoidFunction =
            async (): Promise<void> => {
                ...
                try {
                    ...
                    const classicFilters: Array<ClassicFilterType<TBaseModel>> = filters.map((filter: Filter<TBaseModel>) => {
                    ...
                    }).filter((filter: ClassicFilterType<TBaseModel> | null) => filter !== null) as Array<ClassicFilterType<TBaseModel>>;
        ...
        const getSelect: GetSelectFunction = (): Select<TBaseModel> => {
            ...
            for (const moreField of selectMoreFields) {
                if (model.hasColumn(moreField as string) && model.isEntityColumn(moreField as string)) {
        ...
        type GetFilterKeyFunction = (filter: Filter<TBaseModel>) => keyof TBaseModel | null;
