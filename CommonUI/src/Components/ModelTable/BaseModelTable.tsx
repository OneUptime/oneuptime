...
import { BulkActionButtonSchema, BulkActionFailed } from '../BulkUpdate/BulkUpdateForm';
                ...
                <Table
                    ...
                    bulkActions={{
                        buttons: props.bulkActions?.buttons.map((action) => {
                            const permissions: Array<Permission> =
                                PermissionUtil.getAllPermissions();
                            if (action === ModalTableBulkDefaultActions.Delete && model.hasDeletePermissions(permissions)) {
