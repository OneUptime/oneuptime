...
export const BACKUP_CODE_VERIFICATION_SUCCESS: $TSFixMe =
    'auth/BACKUP_CODE_VERIFICATION_SUCCESS';
export const BACKUP_CODE_VERIFICATION_FAILED: $TSFixMe =
    'auth/BACKUP_CODE_VERIFICATION_FAILED';
export const BACKUP_CODE_VERIFICATION_REQUEST: $TSFixMe =
    'auth/BACKUP_CODE_VERIFICATION_REQUEST';
export const RESET_BACKUP_CODE_VERIFICATION: $TSFixMe =
