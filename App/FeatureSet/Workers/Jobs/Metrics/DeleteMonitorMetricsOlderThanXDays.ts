...
RunCron(
  ...
  async () => {
    ...
    logger.debug("Checking Metric:DeleteMonitorMetricsOlderThanXDays", { service: "workers" });

    logger.debug(`Deleting Monitor Metrics older than ${olderThanDays} days`, { service: "workers" });
