...
RunCron(
  ...
  async () => {
    ...
    logger.debug("Checking Metric:DeleteAlertMetricsOlderThanXDays", { service: "workers" });

    logger.debug(`Deleting Alert Metrics older than ${olderThanDays} days`, { service: "workers" });
