              ...
              {TABS.map((tab: { key: LogTab; label: string }): ReactElement => {
                ...
                return (
                  <button
                    key={tab.key}
                    type="button"
                    className={`-mb-px border-b-2 px-3 py-2 text-sm font-medium rounded-t focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-1 ${
                      isActive
