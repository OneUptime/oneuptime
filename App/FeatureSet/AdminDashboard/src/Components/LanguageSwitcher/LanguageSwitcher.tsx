  ...
  return (
    ...
    >
      <Icon
        ...
        className="h-4 w-4"
      />
      <label htmlFor="admin-dashboard-language-switcher" className="sr-only">
        {t("language.switchLanguage")}
      </label>
      <select
        id="admin-dashboard-language-switcher"
        aria-label={t("language.switchLanguage")}
        value={currentLanguage}
        onChange={onChange}
        className="cursor-pointer border-0 bg-transparent p-0 text-sm font-medium text-gray-500 transition-colors duration-200 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
      >
