...
export interface ResourceCounts {
  ...
  datastores?: number | undefined;
  clusters?: number | undefined;
  resourcePools?: number | undefined;
}
...
const VMwareVCenterSideMenu: FunctionComponent<ComponentProps> = (
    ...
    <SideMenu>
      ...
      <SideMenuSection title="Telemetry">
        <SideMenuItem
          link={{
            title: "Metrics",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.VMWARE_VCENTER_VIEW_METRICS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Graph}
        ...
        <SideMenuItem
          link={{
            title: "Logs",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.VMWARE_VCENTER_VIEW_LOGS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Logs}
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          ...
          countQuery={{
            projectId: projectId!,
            vmwareVCenters: new Includes([props.modelId]),
      ...
      <SideMenuSection title="Advanced">
        <SideMenuItem
          link={{
            title: "Owners",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.VMWARE_VCENTER_VIEW_OWNERS] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Team}
        ...
        <SideMenuItem
          link={{
            title: "Feed",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.VMWARE_VCENTER_VIEW_FEED] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
        ...
        <SideMenuItem
          link={{
            ...
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.VMWARE_VCENTER_VIEW_DELETE] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Trash}
...
export default VMwareVCenterSideMenu;
