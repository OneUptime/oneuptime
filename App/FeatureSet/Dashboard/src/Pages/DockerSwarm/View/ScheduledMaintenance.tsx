...
const DockerSwarmClusterScheduledMaintenance: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  if (modelId) {
    query.dockerSwarmClusters = new Includes([modelId]);
  }
...
export default DockerSwarmClusterScheduledMaintenance;
