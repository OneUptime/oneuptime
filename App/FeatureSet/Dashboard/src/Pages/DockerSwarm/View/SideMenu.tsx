...
const DockerSwarmClusterSideMenu: FunctionComponent<ComponentProps> = (
    ...
    <SideMenu>
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          ...
          countQuery={{
            projectId: projectId!,
            dockerSwarmClusters: new Includes([props.modelId]),
...
export default DockerSwarmClusterSideMenu;
