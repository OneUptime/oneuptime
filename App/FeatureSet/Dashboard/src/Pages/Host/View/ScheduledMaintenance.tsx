...
const HostScheduledMaintenance: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  if (modelId) {
    query.hosts = new Includes([modelId]);
  }
  ...
  return (
    <Fragment>
      <ScheduledMaintenancesTable
        ...
        noItemsMessage="No scheduled maintenance events for this host."
      />
    </Fragment>
  );
};

export default HostScheduledMaintenance;
