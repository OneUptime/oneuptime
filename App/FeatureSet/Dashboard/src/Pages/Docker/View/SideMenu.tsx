    ...
    <SideMenu>
      ...
      <SideMenuSection title="Observability">
        ...
        <SideMenuItem
          link={{
            title: "Traces",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DOCKER_HOST_VIEW_TRACES] as Route,
              { modelId: props.modelId },
            ),
          }}
        ...
        <SideMenuItem
          link={{
            ...
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DOCKER_HOST_VIEW_PROFILES] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.Fire}
      ...
      <SideMenuSection title="Activity">
        <CountModelSideMenuItem<Incident>
          ...
          countQuery={{
            projectId: projectId!,
            dockerHosts: new Includes([props.modelId]),
      ...
      <SideMenuSection title="Advanced">
        ...
        <SideMenuItem
          link={{
            title: "Feed",
            to: RouteUtil.populateRouteParams(
              RouteMap[PageMap.DOCKER_HOST_VIEW_FEED] as Route,
              { modelId: props.modelId },
            ),
          }}
          icon={IconProp.List}
