...
const dockerHostOwnerDocumentation: string = `
### How Docker Host Owner Rules Work

Docker Host Owner Rules add owner users and teams to a Docker host automatically when it matches your criteria — without anyone having to remember to assign owners.

### Match Criteria

A rule matches a Docker host only when **all** specified criteria pass. Empty criteria are skipped.

- **Docker Host Labels** — any-of (M2M)
...
> = (): ReactElement => {
  return (
    <ModelTable<DockerHostOwnerRule>
      ...
      cardProps={{
        title: "Docker Host Owner Rules",
        description:
          "Auto-assign owner users and teams when matching Docker hosts are created.",
      }}
      helpContent={{
        title: "How Docker Host Owner Rules Work",
        description:
          "Match Docker hosts and add owner users/teams automatically.",
        markdown: dockerHostOwnerDocumentation,
      }}
      sortBy="name"
      ...
      columns={[
        ...
        },
        {
          ...
          title: "Status",
          type: FieldType.Boolean,
          getElement: (item: DockerHostOwnerRule): ReactElement => {
      ...
      formFields={[
        {
          ...
          required: true,
          placeholder: "Assign team to matching Docker hosts",
        ...
        },
        {
          ...
          sectionDescription:
            "Filter Docker hosts by labels. Leave empty to skip the filter.",
...
export default DockerHostOwnerRulesPage;
