...
const KubernetesClusterMetrics: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  ...
  return (
    <Fragment>
       ...
       * Drop the attribute fallback (here and in the attributeFilters query
       * merge) once deploy-date + max retention has passed.
       */}
      <MetricsViewer
        attributeFilters={{
...
export default KubernetesClusterMetrics;
