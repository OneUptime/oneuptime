...
> = (): ReactElement => {
  return (
    <LabelRuleTable<CloudResourceLabelRule>
      ...
      cardProps={{
        title: "Cloud Resource Label Rules",
        description:
          "Auto-attach labels when matching cloud resources are created.",
      }}
      sortBy="name"
      ...
      columns={[
        ...
        },
        {
          ...
          title: "Status",
          type: FieldType.Boolean,
          getElement: (item: CloudResourceLabelRule): ReactElement => {
      ...
      formFields={[
        ...
        },
        {
          ...
          sectionDescription:
            "Only trigger for resources that already have at least one of these labels. Leave empty to skip the filter.",
...
export default CloudResourceLabelRulesPage;
