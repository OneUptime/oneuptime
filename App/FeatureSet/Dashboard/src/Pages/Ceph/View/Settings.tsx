    ...
    <Fragment>
        ...
        formFields={[
          {
            ...
            description:
              "Default retention for telemetry collected from this Ceph cluster. Leave blank to use the project's default.",
        ...
        modelDetailProps={{
          ...
          fields: [
            ...
            },
            {
              ...
              title: "Retain Telemetry Data For (Days)",
              description:
                "Default retention for telemetry collected from this Ceph cluster. Falls back to the project's default when not set.",
      ...
      <CardModelDetail<CephCluster>
        ...
        cardProps={{
          ...
          description:
            "Override retention for specific telemetry types for this Ceph cluster. Any field left blank falls back to the Ceph cluster default, then the project's settings.",
        }}
        isEditable={true}
        ...
        modelDetailProps={{
          modelType: CephCluster,
          id: "model-detail-ceph-cluster-telemetry-retention-overrides",
          fields: [
            {
              field: { telemetryRetentionConfig: true },
              fieldType: FieldType.Element,
              title: "Retention Overrides",
              getElement: (item: CephCluster) => {
                return (
