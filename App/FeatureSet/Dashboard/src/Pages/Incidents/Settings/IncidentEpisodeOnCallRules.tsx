...
const IncidentEpisodeOnCallRulesPage: FunctionComponent<
  PageComponentProps
> = (): ReactElement => {
  return (
    <Fragment>
      <ModelTable<IncidentEpisodeOnCallRule>
        ...
        formFields={[
          ...
          },
          {
            ...
            required: true,
            description:
              "Policies to execute when an episode matches this rule.",
...
export default IncidentEpisodeOnCallRulesPage;
