...
const EpisodeInternalNote: FunctionComponent<PageComponentProps> = (
  ...
  return (
    <Fragment>
      <ModelTable<IncidentEpisodeInternalNote>
        ...
        onBeforeCreate={(
          item: IncidentEpisodeInternalNote,
        ): Promise<IncidentEpisodeInternalNote> => {
        ...
        columns={[
          {
            ...
            getElement: (item: IncidentEpisodeInternalNote): ReactElement => {
              return (
                <UserElement
