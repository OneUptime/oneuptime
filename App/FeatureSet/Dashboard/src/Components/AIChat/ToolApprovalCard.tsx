...
const statusChipTone: { [key in AIChatToolActionStatus]: string } = {
  ...
  [AIChatToolActionStatus.Skipped]:
        ...
        <div className="space-y-1.5">
          {resolved.map((action: AIChatToolAction) => {
            return (
              <div
                key={action.id}
                className="flex items-center gap-2 rounded-lg border border-gray-100 bg-gray-50 px-3 py-1.5 dark:border-gray-800 dark:bg-gray-800/40"
              >
                <span
          ...
          <div className="space-y-1.5">
            {pending.map((action: AIChatToolAction) => {
              ...
              return (
                <div
                  key={action.id}
                  className="rounded-lg border border-amber-200/70 bg-white px-3 py-2 dark:border-amber-900/40 dark:bg-gray-900"
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {props.interactive && (
                      <div className="flex flex-shrink-0 overflow-hidden rounded-md border border-gray-200 dark:border-gray-700">
                        <button
                          type="button"
