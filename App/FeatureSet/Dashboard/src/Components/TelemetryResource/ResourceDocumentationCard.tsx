...
import { DocVars } from "./documentationMarkdown";

export interface ComponentProps {
  title: string;
  description: string;
  buildMarkdown: (vars: DocVars) => string;
}

const ResourceDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your telemetry.
          </p>
          <button
            type="button"
            onClick={() => {
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your telemetry."
          onClose={() => {
            ...
            fields: [
              {
                ...
                required: true,
                placeholder: "e.g. Telemetry Ingestion Key",
                validation: {
                  minLength: 2,
                },
              },
...
export default ResourceDocumentationCard;
