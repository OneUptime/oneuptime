...
/*
 * The height the player fills on a desktop.
 *
 ...
 *
 * The pure pieces (compute, measure, observe) take plain objects so the
 * node test environment runs them without a DOM.
 */
