...
import { getVMwareInstallationMarkdown } from "../../Pages/VMware/Utils/DocumentationMarkdown";
...
const VMwareDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your VMware agent.
          </p>
          <button
            type="button"
            onClick={() => {
  ...
  const installationMarkdown: string = getVMwareInstallationMarkdown({
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your VMware agent."
          onClose={() => {
          ...
          formProps={{
            ...
            fields: [
              ...
              ...getTelemetryPayAsYouGoFormFields(),
              {
                ...
                required: true,
                placeholder: "e.g. VMware Agent Key",
                validation: {
                  minLength: 2,
                },
              },
