...
const NAV_COMMANDS: Array<NavCommandSpec> = [
  ...
  },
  {
    ...
    keywords: "alert open unresolved active",
    icon: IconProp.Bell,
    group: "Navigate",
    pageMapKey: PageMap.UNRESOLVED_ALERTS,
  },
  {
    id: "nav-alerts-triage",
    title: "Alert triage",
    subtitle: "Fast keyboard triage of active alerts",
    keywords: "alert triage queue keyboard peek acknowledge resolve",
    icon: IconProp.Bolt,
    group: "Navigate",
    pageMapKey: PageMap.ALERT_TRIAGE,
  },
  {
    id: "nav-maintenance",
