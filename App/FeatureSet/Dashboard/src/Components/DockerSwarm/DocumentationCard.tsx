...
const DockerSwarmDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your Docker Swarm agent.
          </p>
          <button
            type="button"
            onClick={() => {
  ...
  const installationMarkdown: string = getDockerSwarmInstallationMarkdown({
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your Docker Swarm agent."
          onClose={() => {
            ...
            fields: [
              {
                ...
                required: true,
                placeholder: "e.g. Docker Swarm Agent Key",
                validation: {
                  minLength: 2,
                },
              },
