...
import DashboardPodmanHostListComponent from "Common/Types/Dashboard/DashboardComponents/DashboardPodmanHostListComponent";
...
> = (props: ComponentProps): ReactElement => {
  ...
  const args: DashboardPodmanHostListComponent["arguments"] =
  ...
  const rows: Array<ReactElement> = hosts.map((host: PodmanHost) => {
    const id: string = (host._id as string) || "";
    const name: string = (host.name as string) || "Unnamed";
    const status: string =
      (host.otelCollectorStatus as string) || "disconnected";
  ...
  return (
    <DashboardResourceListBase
      ...
      emptyMessage="No Podman hosts found"
...
export default React.memo(
  DashboardPodmanHostListComponentElement,
  arePropsEqual,
);
