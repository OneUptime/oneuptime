...
import DashboardKubernetesJobListComponent from "Common/Types/Dashboard/DashboardComponents/DashboardKubernetesJobListComponent";
...
export interface ComponentProps extends DashboardBaseComponentProps {
  component: DashboardKubernetesJobListComponent;
}

const COLUMNS: Array<ResourceListColumn> = [
  { label: "Job", widthPct: "40%" },
...
const DashboardKubernetesJobListComponentElement: FunctionComponent<
  ComponentProps
> = (props: ComponentProps): ReactElement => {
  const args: DashboardKubernetesJobListComponent["arguments"] =
...
export default React.memo(
  DashboardKubernetesJobListComponentElement,
  arePropsEqual,
);
