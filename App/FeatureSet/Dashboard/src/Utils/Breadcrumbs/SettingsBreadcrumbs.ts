...
export function getSettingsBreadcrumbs(path: string): Array<Link> | undefined {
  const breadcrumpLinksMap: Dictionary<Link[]> = {
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_TEAM_VIEW_MEMBERS, [
      "Project",
      "Settings",
      "Teams",
      "View Team",
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_TEAM_VIEW_PERMISSIONS, [
      "Project",
      "Settings",
      "Teams",
      "View Team",
    ...
    ...BuildBreadcrumbLinksByTitles(
      ...
      ["Project", "Settings", "Teams", "View Team", "Block Permissions"],
    ),
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_TEAM_VIEW_COMPLIANCE, [
      "Project",
      "Settings",
      "Teams",
      "View Team",
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_TEAM_VIEW_DELETE, [
      "Project",
      "Settings",
      "Teams",
      "View Team",
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_USER_VIEW_TEAMS, [
      "Project",
      "Settings",
      "Users",
      "View User",
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_USER_VIEW_CUSTOM_FIELDS, [
      "Project",
      "Settings",
      "Users",
      "View User",
    ...
    ...BuildBreadcrumbLinksByTitles(PageMap.SETTINGS_USER_VIEW_DELETE, [
      "Project",
      "Settings",
      "Users",
      "View User",
