...
export default class OpenTelemetryRequestMiddleware {
  ...
  public static async getProductType(
    ...
    try {
      ...
      logger.debug("Product Type: " + productType, getLogAttributesFromRequest(req as any));
      logger.debug("Is Protobuf: " + isProtobuf, getLogAttributesFromRequest(req as any));
