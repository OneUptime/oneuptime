...
Connectez d'abord Slack à votre projet sous **Project Settings → Espace de travail → Slack**. Voir [Connexion d'espace de travail Slack](/docs/workspace-connections/slack).
