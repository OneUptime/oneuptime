...
- Un service PagerDuty avec une intégration **Events API v2**. Dans PagerDuty : **Service → Integrations → Add integration → Events API v2**. Copiez la **clé d'intégration** (aussi appelée *routing key*).
