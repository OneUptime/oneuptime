...
3. Ajoutez un bloc **API** connecté au déclencheur :
   ...
   - **Method** : `POST`
   - **URL** : `https://gitlab.com/api/v4/projects/12345678/issues` _(remplacez `12345678` par votre ID de projet ; pour une instance auto-gérée, utilisez votre propre hôte)_
   - **Headers** :
