...
Utilisez ceci lorsqu'un système externe doit *créer ou mettre à jour quelque chose dans OneUptime* — généralement ouvrir un incident ou une alerte lorsqu'il détecte un problème.
...
Utilisez ceci lorsque *quelque chose dans OneUptime doit apparaître dans un autre outil* — ouvrir un ticket Jira, alerter quelqu'un dans PagerDuty, publier dans Slack.
