...
- Un **jeton d'ingestion de télémétrie OneUptime** — créez-en un depuis _Paramètres du projet → Télémétrie & APM → Clés d'ingestion_ et copiez la valeur
...
| **Journaux de conteneurs**        | Journaux stdout / stderr de tous les conteneurs                                    |
