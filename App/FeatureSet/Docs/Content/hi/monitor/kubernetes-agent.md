...
| -------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ebpf.contextPropagation`  | off      | आउटबाउंड ट्रैफ़िक में W3C `traceparent` इंजेक्ट करें ताकि spans सर्विसों के पार लिंक हों। डिफ़ॉल्ट रूप से बंद — पहले नीचे दी गई चेतावनी पढ़ें। kernel 5.17+ आवश्यक। |
