...
शुरू करने के लिए आपको अपने मॉनिटर > सेटिंग्स > प्रोब में एक custom probe बनाना होगा। एक बार जब आप OneUptime Dashboard पर custom probe बना लें। आपके पास `PROBE_ID` और `PROBE_KEY` होने चाहिए।
