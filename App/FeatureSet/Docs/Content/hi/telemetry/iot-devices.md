...
- एक **OneUptime Telemetry Ingestion Token** — इसे _प्रोजेक्ट सेटिंग्स → टेलीमेट्री और APM → इंजेशन कुंजियाँ_ से बनाएँ और `x-oneuptime-token` मान को कॉपी करें
...
4. किसी भी `iot_*` श्रृंखला को चार्ट करने के लिए फ्लीट के अंतर्गत **मेट्रिक्स** खोलें।
...
इन्जेस्शन टोकन अमान्य, रद्द या गायब है। _प्रोजेक्ट सेटिंग्स → टेलीमेट्री और APM → इंजेशन कुंजियाँ_ से एक नया बनाएँ और `x-oneuptime-token` हेडर अपडेट करें।
