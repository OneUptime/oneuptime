...
- **Telemetry Ingestion Token** – _प्रोजेक्ट सेटिंग्स → टेलीमेट्री और APM → इंजेशन कुंजियाँ_ से एक बनाएं और `x-oneuptime-token` value copy करें।
...
ये attributes **उत्पाद → लॉग्स** explorer के अंदर searchable बन जाते हैं।
