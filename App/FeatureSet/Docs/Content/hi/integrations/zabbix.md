...
3. कैनवास पर एक **Conditions** ब्लॉक खींचें और trigger का output उससे जोड़ें। कॉन्फ़िगर करें:
   ...
   - **Operator**: `==`
   - **Right value**: `1`  *(Zabbix समस्या के लिए `1` और recovery के लिए `0` भेजता है)*
...
5. सहेजें। **Enabled** *बंद* छोड़ें अभी के लिए — test के बाद आप इसे चालू करेंगे।
...
3. **Name**: `OneUptime`।
4. ये **Parameters** जोड़ें (हर एक के लिए *Add* क्लिक करें)। ये Zabbix [macros](https://www.zabbix.com/documentation/current/en/manual/appendix/macros/supported_by_location) को एक साफ़ payload में map करते हैं:
...
Zabbix notifications *एक user को* भेजता है। एक समर्पित user बनाएँ ताकि इंटीग्रेशन ढूंढना और बंद करना आसान हो।
...
3. **Conditions** (वैकल्पिक): इसे संकुचित करें — उदाहरण के लिए, *Trigger severity >= Warning*। सब कुछ भेजने के लिए खाली छोड़ें।
...
ऊपर का मुख्य वर्कफ़्लो incidents *खोलता* है। Zabbix के recover होने पर उन्हें *बंद* भी करने के लिए:
...
4. उसे एक **Update Incident** ब्लॉक से जोड़ें और incident को आपके *resolved* state में ले जाएँ।
