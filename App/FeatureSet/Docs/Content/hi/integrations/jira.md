...
2. Jira में, **Project settings → Automation → Create rule** पर जाएँ:
   - **Trigger**: *Issue transitioned* to **Done** (या *Issue resolved*)।
   - **Action**: *Send web request* → method `POST`, URL = आपका workflow webhook URL, body में issue key और OneUptime incident id शामिल करें, जैसे:
