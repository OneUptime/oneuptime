...
**सेटिंग्स → Runbook एजेंट** पर जाएँ और एक नया एजेंट बनाएँ। भरें:
...
एजेंट बनाने के बाद, उसकी पंक्ति पर **सेटअप निर्देश दिखाएं** क्लिक करें। आपको इस एजेंट के ID और key के साथ पहले से भरा हुआ `docker run` कमांड दिखेगा। **अभी key save कर लें** — आप इसे बाद में reset कर सकते हैं, लेकिन modal बंद करने के बाद वही value दोबारा नहीं देख पाएँगे।
...
**सेटिंग्स → Runbook एजेंट** पर वापस जाएँ। लगभग 60 सेकंड के भीतर एजेंट की पंक्ति को ताज़ा **Last seen** टाइमस्टैम्प के साथ `Connected` में बदल जाना चाहिए। अगर वह `Disconnected` ही रहे:
...
| --------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Claim timeout**     | 2 मिनट   | Worker कितनी देर चुने हुए एजेंट के job claim करने का इंतज़ार करता है। अगर एजेंट समय में नहीं उठाए, step `TimedOut` के साथ fail हो जाती है और runbook (**विफलता पर जारी रखें** के अनुसार) आगे बढ़ता है या रुकता है। |
| **Execution timeout** | 30 सेकंड | एजेंट script को समाप्त करने से पहले कितनी देर चलने देता है। (Bash को `SIGKILL` मिलता है; JavaScript का isolate तोड़ दिया जाता है।)                                                                                 |

दोनों प्रति step कॉन्फ़िगर करने योग्य हैं। **रनबुक &rsaquo; आपका runbook &rsaquo; चरण** पर जाएँ, किसी Bash या JavaScript step को खोलें, और script के नीचे **Execution timeout** और **Claim timeout** (सेकंड में) सेट करें। डिफ़ॉल्ट का उपयोग करने के लिए फ़ील्ड खाली छोड़ दें। प्रत्येक फ़ील्ड 1 सेकंड से 1 घंटे तक का मान स्वीकार करता है; इस दायरे से बाहर के मान step चलते समय इन्हीं सीमाओं तक सीमित कर दिए जाते हैं।
