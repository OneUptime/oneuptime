...
- प्रति-चरण execution timeout डिफ़ॉल्ट: JavaScript, Bash और HTTP के लिए **30 सेकंड**। इसे Runbook के **Steps** पेज पर प्रति चरण सेट करें — डिफ़ॉल्ट बनाए रखने के लिए फ़ील्ड खाली छोड़ दें।
- Bash और JavaScript चरणों के लिए प्रति-चरण **claim timeout**: **2 मिनट** — Worker कितनी देर चुने हुए एजेंट के job लेने का इंतज़ार करता है, इससे पहले कि वह fail हो। यह भी प्रति चरण सेट किया जाता है।
- दोनों timeouts **1 सेकंड से 1 घंटे** तक स्वीकार करते हैं। इस दायरे से बाहर का मान चरण चलते समय इन्हीं सीमाओं तक सीमित कर दिया जाता है, इसलिए ग़लत टाइप किया गया कॉन्फ़िग न timeout को निष्क्रिय कर सकता है और न किसी Worker slot को अनंतकाल तक खुला रोके रख सकता है।
