...
- **बनाएँ** — एक नया रिकॉर्ड जोड़ें।
- **अपडेट करें** — एक रिकॉर्ड बदलें।
- **हटाएं** — एक रिकॉर्ड हटाएँ।
- **गणना** — फ़िल्टर से मेल खाने वाले रिकॉर्ड्स गिनें।

इसी तरह एक वर्कफ़्लो OneUptime डेटा को पढ़ और बदल सकता है। उदाहरण के लिए: आपके CI टूल से एक webhook विफलता विवरण के साथ एक incident खोलने के लिए **घटना बनाएं** का उपयोग कर सकता है।
