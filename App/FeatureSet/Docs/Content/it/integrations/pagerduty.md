...
- Un servizio PagerDuty con un'integrazione **Events API v2**. In PagerDuty: **Service → Integrations → Add integration → Events API v2**. Copia l'**Integration Key** (detta anche *routing key*).
