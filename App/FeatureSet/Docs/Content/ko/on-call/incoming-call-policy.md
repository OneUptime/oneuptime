...
4. 다음 항목을 입력합니다:
   ...
   - **Twilio 기본 전화번호**: 발신 전화에 사용할 Twilio 계정의 전화 번호
5. **저장**을 클릭합니다

## 3단계: 수신 전화 정책 생성

1. **온콜 듀티** > **수신 통화 정책**으로 이동합니다
...
2. **설정**으로 이동합니다
3. 다음을 구성합니다:
   - **인사 메시지**: 통화가 응답될 때 재생됨
   - **응답 없음 메시지**: 모든 에스컬레이션 규칙이 실패할 때 재생됨
   - **사용 가능한 사람 없음 메시지**: 온콜 중인 사람이 없을 때 재생됨
