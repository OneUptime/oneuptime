...
1. 먼저 Atlassian Statuspage JSON API를 시도합니다 (`/api/v2/status.json`, `/api/v2/components.json`, `/api/v2/incidents/unresolved.json`)
2. 다음으로 incident.io 상태 페이지 API를 시도합니다 (`/proxy/<host>`)
