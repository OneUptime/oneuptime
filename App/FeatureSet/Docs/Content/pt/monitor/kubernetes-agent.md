...
| -------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ebpf.contextPropagation`  | inativo | Injeta um `traceparent` W3C no tráfego de saída para que os spans sejam ligados entre serviços. Desativado por omissão — leia primeiro o aviso abaixo. Requer kernel 5.17+. |
