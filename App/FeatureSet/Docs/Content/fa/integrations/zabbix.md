...
> **نکته:** گذاشتن `event_id` در توضیحات (یا برچسبی روی حادثه) به شما امکان می‌دهد اگر خواستید هنگام بهبود خودکار برطرف کنید، بعداً همین حادثه را پیدا کنید. [برطرف کردن خودکار](#resolving-automatically-optional) را ببینید.
...
اگر چیزی نرسید، [رفع اشکال](#troubleshooting) را ببینید.
