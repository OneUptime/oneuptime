...
1. Først forsøger den Atlassian Statuspage JSON API (`/api/v2/status.json`, `/api/v2/components.json` og `/api/v2/incidents/unresolved.json`)
2. Dernæst forsøger den incident.io-statussidens API (`/proxy/<host>`)
