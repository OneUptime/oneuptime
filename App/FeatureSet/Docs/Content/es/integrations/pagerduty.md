...
- Un servicio de PagerDuty con una integración **Events API v2**. En PagerDuty: **Service → Integrations → Add integration → Events API v2**. Copia la **Integration Key** (también llamada _routing key_).
