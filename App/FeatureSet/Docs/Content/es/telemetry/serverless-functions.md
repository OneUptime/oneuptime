...
- Un **Token de Ingesta de Telemetría de OneUptime**: crea uno desde _Configuración del Proyecto → Telemetría y APM → Claves de Ingesta_ y copia el valor `x-oneuptime-token`.
