...
| Seite                                          | Was Sie sehen                                                                            |
| ---------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **Arbeitsabläufe → Ausführungen & Protokolle** | Jede Ausführung aus jedem Workflow im Projekt. Filterbar nach Workflow, Status und Zeit. |
| **Arbeitsablauf → Protokolle-Tab**             | Nur die Ausführungen dieses einen Workflows.                                             |
...
| **Wird ausgeführt**    | Der Workflow ist in Bearbeitung. Lang laufende Bausteine halten eine Ausführung in diesem Zustand.                                                                                    |
