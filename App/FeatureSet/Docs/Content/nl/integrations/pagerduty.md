...
- Een PagerDuty-service met een **Events API v2**-integratie. In PagerDuty: **Service → Integrations → Add integration → Events API v2**. Kopieer de **Integration Key** (ook wel de *routing key* genoemd).
