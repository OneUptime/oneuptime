...
1. Eerst probeert het de Atlassian Statuspage JSON API (`/api/v2/status.json`, `/api/v2/components.json` en `/api/v2/incidents/unresolved.json`)
2. Vervolgens probeert het de incident.io-statuspagina-API (`/proxy/<host>`)
