...
- **Конечная точка намеренно не аутентифицирована** — секретный ключ в URL-пути _и есть_ аутентификация, так же как на публичной конечной точке `oneuptime.com`. Относитесь к секретному ключу как к учётным данным.
