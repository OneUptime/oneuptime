...
- **OneUptime Telemetry Ingestion Token** — создайте его в разделе *Project Settings → Telemetry Ingestion Keys* и скопируйте значение
...
| `ONEUPTIME_SERVICE_TOKEN` | Да | Токен загрузки телеметрии из *Project Settings → Telemetry Ingestion Keys* |
