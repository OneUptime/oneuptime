...
После регистрации в OneUptime и создания проекта нажмите «Products» в панели навигации, а затем нажмите «Project Settings».
...
Каждое именованное свойство (`OrderId`, `CustomerId`, `Amount`, `LatencyMs`) отправляется как атрибут лога, поэтому вы можете фильтровать и искать по ним в обозревателе **Products → Журналы**.
