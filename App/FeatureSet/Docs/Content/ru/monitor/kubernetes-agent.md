...
| -------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ebpf.contextPropagation`  | выкл.        | Вставка W3C `traceparent` в исходящий трафик, чтобы span связывались между сервисами. По умолчанию отключено — сначала прочитайте предупреждение ниже. Требуется ядро 5.17+. |
