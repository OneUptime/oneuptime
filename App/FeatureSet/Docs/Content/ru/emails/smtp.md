...
| **Имя пользователя**     | Адрес электронной почты для отправки                                                     |
| **Тип аутентификации**   | Выберите "OAuth"                                                                         |
| **Тип провайдера OAuth** | Выберите "Client Credentials" для Microsoft 365 или "JWT Bearer" для Google Workspace    |
...
| **Область**              | Необходимые области действия OAuth для доступа к SMTP                                    |
...
- **Тестирование конфигурации**: Используйте кнопку "Отправить тестовое письмо" в OneUptime для проверки настройки
