...
- A PagerDuty service with an **Events API v2** integration. In PagerDuty: **Service → Integrations → Add integration → Events API v2**. Copy the **Integration Key** (also called the *routing key*).
