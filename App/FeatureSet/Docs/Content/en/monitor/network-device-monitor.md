...
- The lookup asks at most 2,000 hosts per scan and adds up to about 30 seconds to the end of the scan. A host that does not answer keeps its IP address as its name.
