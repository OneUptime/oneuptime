...
Koble Slack til prosjektet ditt først under **Prosjektinnstillinger → Arbeidsområde → Slack**. Se [Slack arbeidsområdetilkobling](/docs/workspace-connections/slack).
