...
- A **OneUptime Telemetry Ingestion Token** — create one from _Prosjektinnstillinger → Telemetri og APM → Inntaksnøkler_ and copy the value
...
| **Containerlogger**   | stdout / stderr logs from all containers                       |
