...
Arbeidsflyt-triggere for hendelser er ikke håndskrevne — OneUptime genererer dem fra datamodellene, så hver modell i hendelsesfamilien får komponentene **On Create X**, **On Update X** og **On Delete X**, navngitt etter modellens entallsnavn. De tre viktigste er **On Create Incident**, **On Update Incident** og **On Delete Incident**, og de bor i kategorien **Hendelse** i komponentpaletten for arbeidsflyter på `/dashboard/{projectId}/workflows`.
