...
Använd detta när ett externt system behöver _skapa eller uppdatera något i OneUptime_ — vanligtvis öppna en incident eller ett larm när det upptäcker ett problem.
