...
1. Först provar det Atlassian Statuspage JSON API (`/api/v2/status.json`, `/api/v2/components.json` och `/api/v2/incidents/unresolved.json`)
2. Därefter provar det incident.io-statussidans API (`/proxy/<host>`)
