...
| -------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ebpf.contextPropagation`  | av       | Injicera en W3C `traceparent` i utgående trafik så att spans länkas mellan tjänster. Av som standard — läs varningen nedan först. Kräver kärna 5.17+. |
