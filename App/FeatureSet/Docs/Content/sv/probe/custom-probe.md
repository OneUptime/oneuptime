...
För att börja behöver du skapa en anpassad sond i din OneUptime-instrumentpanel under Övervakare > Inställningar > Sonder. När du har skapat den anpassade sonden på din OneUptime-instrumentpanel bör du ha `PROBE_ID` och `PROBE_KEY`.
