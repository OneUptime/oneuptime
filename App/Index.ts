...
const init: PromiseVoidFunction = async (): Promise<void> => {
  try {
    // Check the infrastructure status before initializing the app
    ...
    // Initialize the app with the infrastructure status checks
    await App.init({
    ...
    // Connect to the databases and Redis
    ...
    // Initialize the home route last because it has the catch-all route
