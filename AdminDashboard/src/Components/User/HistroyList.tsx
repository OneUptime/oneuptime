...
export class HistoryList extends Component<ComponentProps> {
    ...
    override render() {
        ...
        if (!this.props.history.skip) {
            this.props.history.skip = 0;
        }

        if (!this.props.history.limit) {
            this.props.history.limit = 0;
        }
