...
export const dashboardLoadRequest = function (): void {
    return {
        type: types.DASHBOARD_LOAD_REQUEST,
    };
};
export const dashboardLoadSuccess = function (): void {
    return {
        type: types.DASHBOARD_LOAD_SUCCESS,
    };
};
export const resetDashboardLoad = function (): void {
    return {
        type: types.DASHBOARD_LOAD_RESET,
    };
};

export const dashboardLoadFailed = function (payload: $TSFixMe): void {
    return {
