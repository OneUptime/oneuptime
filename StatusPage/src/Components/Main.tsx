...
class Main extends Component<ComponentProps> {
    ...
    override componentDidMount() {
        ...
        if (
            window.location.pathname.includes('/StatusPage/') &&
    ...
    override render() {
        ...
        if (this.props.statusData && this.props.statusData.monitorsData) {
            ...
            if (serviceStatus === 'all') {
                ...
                faviconurl = '/StatusPage/greenfavicon.ico';
                ...
                faviconurl = '/StatusPage/redfavicon.ico';
                ...
                faviconurl = '/StatusPage/yellowfavicon.ico';
...
const HelemtCard: Function = ({
    ...
    return (
        <Helmet>
            ...
            <script
                src="/StatusPage/js/landing.base.js"
