  ...
  const fields: Array<ModelField<StatusPageSubscriber>> = [
    {
      ...
      description: "Enter your Microsoft Teams workspace name for validation.",
    ...
    },
    {
      ...
      description: "Status page updates will be sent to this Teams webhook.",
          ...
          fields={[
            {
              ...
              title:
                "Please enter your Microsoft Teams workspace name you have subscribed with",
              description:
        ...
        <div className="justify-center">
          <div>
            ...
            {!isSuccess ? (
              <div className="">
                <Card
                  title="Subscribe by Microsoft Teams"
                  description={
                    "All of our updates will be sent to this Teams webhook."
                  }
                >
                  <Tabs
                    tabs={[
