...
const Overview: FunctionComponent<PageComponentProps> = (
    ...
    const [announcements, setAnnouncements] = useState<Array<StatusPageAnnouncement>>([]);
    ...
    useAsyncEffect(async () => {
        try {
            ...
            const response = await BaseAPI.post<JSONObject>(URL.fromString(DASHBOARD_API_URL.toString()).addRoute(`/status-page/announcements/${id.toString()}`), {}, {});
            const data = response.data;


            const announcements = BaseModel.fromJSONArray(data['announcements'] as JSONArray || [], StatusPageAnnouncement);
    ...
    useEffect(() => {
        ...
        for (const announcement of announcements) {
            const dayString = OneUptimeDate.getDateString(announcement.showAnnouncementAt!);
