...
export default class ResourceUtil {
    public static getResources(): Array<ModelDocumentation> {
        ...
        const resources: Array<ModelDocumentation> = Models.filter((model: typeof BaseModel) => {
            ...
            return {
                ...
                path: Text.pascalCaseToDashes(modelInstance.tableName as string),
                model: modelInstance,
    ...
    public static getFeaturedResources(): Array<ModelDocumentation> {
        ...
        return ResourceUtil.getResources().filter((resource) => featuredResources.includes(resource.name));
