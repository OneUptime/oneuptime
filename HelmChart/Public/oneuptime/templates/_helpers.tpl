...
- name: MICROSOFT_TEAMS_APP_ID
  value: {{ $.Values.microsoftTeamsApp.appId | quote }}
- name: HOST
  value: {{ $.Values.host }}
...
- name: MICROSOFT_TEAMS_APP_PASSWORD
  value: {{ $.Values.microsoftTeamsApp.appPassword }}

- name: MICROSOFT_TEAMS_TENANT_ID
