...
describe('Fyipe Component Reload', () => {
   ...
   test('Should create a component and confirm there are no errors', async (done) => {
   ...
   test('Should navigate to Log page inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
   ...
   test('Should navigate to Error tracking page inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
   ...
   test('Should navigate to Performance tracker page inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
   ...
   test('Should navigate to Container security page inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
      ...
      await page.reload({ waitUntil: 'networkidle0' });
      await page.waitForSelector(`#cb${componentName}`, { visible: true });
      await page.waitForSelector('#cbContainerSecurity', { visible: true });
      done();
   }, operationTimeOut);

   test('Should navigate to Application security inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
      await page.waitForSelector('#security', { visible: true });
      await page.click('#security');
   ...
   test('Should navigate to Component-Settings(Basic) inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
      ...
      await page.reload({ waitUntil: 'networkidle0' });
      await page.waitForSelector(`#cb${componentName}`, { visible: true });
      await page.waitForSelector('#cbComponentSettings', { visible: true });
      done();
   }, operationTimeOut);

   test('Should navigate to Component-Settings(Advanced) inside component and confirm there are no errors', async (done) => {
      await init.navigateToComponentDetails(componentName, page);
      await page.waitForSelector('#componentSettings', { visible: true });
      await page.click('#componentSettings');
