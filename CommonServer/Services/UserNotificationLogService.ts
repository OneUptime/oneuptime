...
export class Service extends DatabaseService<Model> {
    ...
    protected override async onCreateSuccess(_onCreate: OnCreate<Model>, createdItem: Model): Promise<Model> {
        ...
        let notificationRuleType: NotificationRuleType = NotificationRuleType.ON_CALL_INCIDENT_CREATED;

        if (createdItem.userNotificationEventType === UserNotificationEventType.IncidentCreated) {
        ...
        const immediateNotificationRule: Array<UserNotificationRule> = await UserNotificationRuleService.findBy({
            query: {
        ...
        for (const immediateNotificationRuleItem of immediateNotificationRule) {
            ...
            await UserNotificationRuleService.executeNotificationRuleItem(immediateNotificationRuleItem.id!, {
