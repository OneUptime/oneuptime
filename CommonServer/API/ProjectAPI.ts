            ...
            async (
                ...
                try {
                    ...
                    if(!((req as OneUptimeRequest).userAuthorization?.userId)){
                        throw new NotAuthorizedException("User should be logged in to access this API");
                    }
                    ...
                    for(const teamMember of teamMembers){  
                        ...
                        if(projects.findIndex(project => project._id?.toString() === teamMember.project!._id?.toString()) === -1){
