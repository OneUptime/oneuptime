...
export default class InitialMigration implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DROP TABLE "IncidentTemplateOnCallDutyPolicy"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "StatusPageHistoryChartBarColorRule"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "ScheduledMaintenanceStateTimeline"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "ScheduledMaintenanceNoteTemplate"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "ScheduledMaintenanceInternalNote"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "OnCallDutyPolicyScheduleLayerUser"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "OnCallDutyPolicyEscalationRuleUser"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TABLE "OnCallDutyPolicyEscalationRuleTeam"`
        );
        await queryRunner.query(
