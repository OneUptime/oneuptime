...
class UserBlockModal extends Component {
    componentDidMount() {
...
const mapStateToProps = (state: $TSFixMe) => {
    return {
        ...
        error: state.user && state.user.blockUser && state.user.blockUser.error,
    };
};
...
export default connect(mapStateToProps)(UserBlockModal);
