...
export class AuditLogsList extends Component {
  render() {
    ...
    if (
      ...
      this.props.auditLogs.limit = parseInt(this.props.auditLogs.limit, 10);
    }
    ...
    let canNext =
      ...
      this.props.auditLogs.count >
        ...
        : false;
    let canPrev =
      this.props.auditLogs && this.props.auditLogs.skip <= 0 ? false : true;
            ...
            <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
              <span>
                <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                  {this.props.auditLogs && this.props.auditLogs.count
                    ? this.props.auditLogs.count +
                      (this.props.auditLogs && this.props.auditLogs.count > 1
                        ? ' Logs'
                        : ' Log')
                    : null}
                </span>
            ...
            <div className="Box-root Flex-flex Flex-alignItems--stretch Flex-direction--row Flex-justifyContent--flexStart">
              <div className="Box-root Margin-right--8">
                <button
                  ...
                  className={
                    'Button bs-ButtonLegacy' + (canPrev ? '' : 'Is--disabled')
                  }
                  disabled={!canPrev}
              ...
              <div className="Box-root">
                <button
                  ...
                  className={
                    'Button bs-ButtonLegacy' + (canNext ? '' : 'Is--disabled')
                  }
                  disabled={!canNext}
