...
class ProjectUser extends Component {
    ...
    renderTable = () => {
        const { handleSubmit, updatingRequest } = this.props;
        return (
            this.props.users &&
            this.props.users.teamMembers.map(user => (
                <tr
                                        ...
                                        >
                                            <div className="Flex-flex Flex-alignContent--spaceBetween">
                                                <Dropdown disabled={false}>
                                                    {!(
                                                        updatingRequest.requesting &&
                                                        updatingRequest.updating.includes(
                                                            user.userId
                                                        )
                                                    ) && (
                                                        <Dropdown.Toggle
...
ProjectUser.propTypes = {
    ...
    updatingRequest: PropTypes.oneOfType([PropTypes.bool, PropTypes.object]),
};

function mapStateToProps(state) {
    return {
        updatingRequest: state.project.updateUser,
    };
}
