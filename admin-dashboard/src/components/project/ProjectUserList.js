...
export class ProjectUserList extends Component {
    render() {
        if (
            this.props.projects &&
                            ...
                            {this.props.requesting ? (
                              ...
                              this.props.projects.projects.length > 0 ? (
                                this.props.projects.projects.map(
                                    (project, index) => {
                                        const projectOwner =
                                            project.users.find(userProject =>
                                                userProject.projects.find(
                                                    project => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectUserList);
