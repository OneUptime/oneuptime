                        ...
                        :
                            this.props.projects && this.props.projects.projects && this.props.projects.projects.length > 0 ? (
                                this.props.projects.projects.map((project) => {
                                    ...
                                    const usersDetail = project.users.length - 1 > 0 ? project.users.length - 1 > 1 ? `${projectOwner.name} and ${project.users.length - 1} others` : `${ projectOwner.name } and 1 other` : 'Not Added Yet';
                                        
                                    return <tr key={project._id} className="Table-row db-ListViewItem bs-ActionsParent db-ListViewItem--hasLink" onClick={() => { history.push('/projects/' + project._id) }} >
                                        ...
                                        <td className="Table-cell Table-cell--align--right Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap db-ListViewItem-cell" style={{ height: '1px' }}>
                                            <div className="db-ListViewItem-link" >
                                                <div className="db-ListViewItem-cellContent Box-root Padding-all--8">
                                                    <span className="db-ListViewItem-text Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                                                        <div className="Box-root"><span>{ usersDetail }</span></div>
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
