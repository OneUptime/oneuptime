    ...
    test(
        ...
        async () => {
            await cluster.execute(null, async ({ page }) => {
                ...
                logCount = logCount.split(' ');
                console.log("The log count is: ", logCount);
                logCount = logCount[4];
                console.log("Extracted Log: ",logCount);
                logCount = logCount.splice(1);
                console.log("Spliced Log: ",logCount);
                // goto other pages
                await page.waitForSelector('#probes');
                await page.click('#probes');
