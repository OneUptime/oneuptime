...
@media (-webkit-min-device-pixel-ratio: 1.25), (min-resolution: 120dpi), all and (max-width: 768px) {
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="st-Header-logo" align="left" style="height:80px;width:70px; border: 0; margin: 0; padding: 0;">
  ...
  <tbody>
    <tr>
      ...
      <strong￼ style="color: #0080a8 !important;">{{monitorName}} is down</strong>. A new incident has been created {{incidentTime}} and is available on the statuspage
