module.exports = {
  incidentDefaultSettings:{
    ...
    description:"{{monitorName}} is {{incidentType}}. This incident is currently being investigated by our team and more information will be added soon.",
  },
  variables: [
    {
      name:'incidentType',
    ...
    {
      name:'projectName',
      definition:'Name of the project on which the incident has occured.'
    },
    {
      name:'time',
