...
import BrandingFormDefault from '../../../components/statusPage/Branding';
...
const props = {
    ...
    createFaviconCache: action('createFaviconCache'),
    createLogoCache: action('createLogoCache'),
    updateStatusPageBranding: action('updateStatusPageBranding'),
    resetFaviconCache: action('resetFaviconCache'),
    resetLogoCache: action('resetLogoCache'),
...
storiesOf('Status Page', module).add('Branding', () => (
    <BrandingForm {...props} />
));
...
const props_requesting = {
    ...
    statusPage: {
        ...props.statusPage,
        branding: {
            ...props.statusPage.branding,
            requesting: true,
        },
    },
};

storiesOf('Status Page', module).add('Branding Requesting', () => (
...
storiesOf('Status Page', module).add('Branding Error', () => (
    <BrandingForm {...props_error} />
));

storiesOf('Status Page', module).add('Branding Default', () => (
    <BrandingFormDefault {...props_error} />
));
