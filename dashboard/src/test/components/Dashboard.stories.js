...
storiesOf('DashBoard', module)
    ...
    .add('New Project', () => <DashboardApp {...props} />);
...
storiesOf('DashBoard', module)
    ...
    .add('Delete Project', () => <DashboardApp {...props} />);
...
storiesOf('DashBoard', module)
    .addDecorator(story => (
        <Provider store={store_delete_profileMenu}>{story()}</Provider>
    ))
...
storiesOf('DashBoard', module)
    .addDecorator(story => (
        <Provider store={store_delete_notification}>{story()}</Provider>
    ))
    .add('Notification', () => (
...
storiesOf('DashBoard', module)
    .addDecorator(story => (
        <Provider store={store_delete_newProject}>{story()}</Provider>
    ))
    .add('No Projects', () => <DashboardApp {...props_no_project} />);
...
storiesOf('DashBoard', module)
    ...
    .add('Error', () => <DashboardApp {...props_no_error} />);
...
storiesOf('DashBoard', module)
    ...
    .add('Requesting', () => <DashboardApp {...props_no_requesting} />);
