...
import IsAdmin from '../../../components/basic/IsAdmin'
...
storiesOf('Basic', module)
    ...
    .add('IsAdmin False', () =>
        <span>
        {IsAdmin(currentProject)?'Returned true, User Is Admin': 'Returned false, User Is not Admin'}
        </span>
    )
    .add('IsAdmin True', () =>
            <span>
            {IsAdmin(currentProject_2)?'Returned true, User Is Admin': 'Returned false, User Is not Admin'}
            </span>
        )