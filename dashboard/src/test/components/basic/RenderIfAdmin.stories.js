...
storiesOf('Basic', module)
    ...
    .add('RenderIfAdmin Not Admin', () => (
        <RenderIfAdmin currentProject={currentProject_1}>
            User is admin, Children will render, this should not show
        </RenderIfAdmin>
    ))
    .add('RenderIfAdmin Admin', () => (
        <RenderIfAdmin currentProject={currentProject_2}>
            User is admin, Children will render
        </RenderIfAdmin>
    ));
