...
storiesOf('Basic', module)
    ...
    .add('IsMember False', () =>
        <span>
        {IsMember(currentProject_1)?'Returned true, User Is Member': 'Returned false, User Is not Member'}
        </span>
    )
    .add('IsMember True', () =>
        <span>
        {IsMember(currentProject_2)?'Returned true, User Is Member': 'Returned false, User Is not Member'}
        </span>
    )