            ...
            monitors: [
                {
                    ...
                    time: [
                        {
                            date:
                                'Tue Jun 26 2018 02:24:10 GMT+0530 (India Standard Time)',
                            monitorId: '5b1f41a02a62c8611d23c96e',
                            upTime: 0,
                            downTime: 0,
                            status: '',
...
const mapDispatchToProps = dispatch => {
    return bindActionCreators(
        { incidentsRequest, incidentsError, incidentsSuccess, resetIncidents },
        dispatch
    );
};
...
const MockIncidentPaginationDecorated = connect(
    null,
    mapDispatchToProps
)(MockIncidentPagination);
...
storiesOf('Incidents', module)
    ...
    .add('IncidentList', () => (
        <MockIncidentPaginationDecorated
            getIncidents={mock_getIncidents}
            {...props}
        />
    ));
