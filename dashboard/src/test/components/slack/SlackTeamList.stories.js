...
import SlackTeamList from '../../../components/slack/SlackTeamList';
...
const props = {
        ...
        teams: [
            {
                ...
                data: {
                    ...
                    teamName: 'Gueva',
                    accessToken:
                        'xoxp-245917606595-245991995746-430319582274-1c624bec5306c36ef546768181e66954',
                    botAccessToken:
                        'xoxb-245917606595-430319585874-r66lbqsdLXE1OHMnpCmKzYZT',
                },
                __v: 0,
            },
        ],
    ...
    projectId: '5b9283e1c5d4132324cd92e2',
    getSlackTeams: action('getSlackTeams'),
};

storiesOf('Slack', module)
    .addDecorator(story => <Provider store={store}>{story()}</Provider>)
    .addDecorator(story => <div style={{ margin: '5%' }}>{story()}</div>)
    .add('Slack integration list', () => <SlackTeamList {...props} />);
