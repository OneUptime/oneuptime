...
import { DeleteProjectBox } from '../../../components/settings/DeleteProject'
...
const props = {
    ...
    initialValues:{},
    showDeleteModal: () => {
        const showDeleteModal = action('showDeleteModal');
...
storiesOf('Settings', module)
    ...
    .add('DeleteProject', () =>
        <DeleteProjectBox isRequesting={boolean('isRequesting', false)}  {...props} />
    )