...
const props = {
    time: {
        date: '2018-07-02T18:30:04.452Z',
        upTime: 228,
        downTime: 6,
        _id: '5b3a6f2c6a2043182826411a',
...
storiesOf('BlockChart', module)
    .addDecorator(story => (
        <div style={{ margin: '20%' }}>
            <div className="block-chart">{story()}</div>
        </div>
    ))
    .add('BlockChart Time', () => <BlockChart {...props} />)
    .add('BlockChart Empty', () => <BlockChart {...props_empty} />);
