...
describe('Schedules Reducers', () => {
    ...
    it('should handle SCHEDULE_FETCH_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.SCHEDULE_FETCH_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle SCHEDULE_FETCH_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.SCHEDULE_FETCH_RESET })
        ).toEqual(expected);
    });

    it('should handle SCHEDULE_FETCH_SUCCESS', () => {
        initialState.schedules.data = [
            { _id: '_id', name: 'Enter Schedule Name' },
        ];
        const payload = {
            data: [{ _id: '_id' }],
            count: 1,
    ...
    it('should handle CREATE_SCHEDULE_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_SCHEDULE_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle CREATE_SCHEDULE_SUCCESS', () => {
        initialState.schedules.data = [
            { _id: '_id', name: 'Not Enter Schedule Name' },
        ];
    ...
    it('should handle CREATE_SCHEDULE_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_SCHEDULE_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle RENAME_SCHEDULE_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.RENAME_SCHEDULE_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle RENAME_SCHEDULE_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.RENAME_SCHEDULE_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle DELETE_SCHEDULE_SUCCESS not deleted', () => {
        const payload = {
            ok: 0,
            n: 3,
            scheduleId: 'test DELETE_SCHEDULE_SUCCESS',
        };
        const expected = {
            ...initialState,
            deleteSchedule: {
    ...
    it('should handle DELETE_SCHEDULE_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.DELETE_SCHEDULE_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle DELETE_SCHEDULE_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.DELETE_SCHEDULE_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle ADD_MONITOR_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.ADD_MONITOR_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle ADD_MONITOR_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.ADD_MONITOR_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle ADD_USER_REQUEST', () => {
        ...
        expect(reducer(initialState, { type: types.ADD_USER_REQUEST })).toEqual(
            expected
        );
    });
    ...
    it('should handle ADD_USER_RESET', () => {
        ...
        expect(reducer(initialState, { type: types.ADD_USER_RESET })).toEqual(
            expected
        );
    });
