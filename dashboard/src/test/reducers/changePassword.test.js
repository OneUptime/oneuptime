...
describe('Change password Reducers', () => {
    ...
    it('should handle CHANGEPASSWORD_REQUEST ', () => {
        ...
        expect(
            reducer(initialState, { type: types.CHANGEPASSWORD_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle CHANGEPASSWORD_SUCCESS', () => {
        ...
        expect(
            reducer(initialState, { type: types.CHANGEPASSWORD_SUCCESS })
        ).toEqual(expected);
    });
    ...
    it('should handle RESET_CHANGEPASSWORD ', () => {
        expect(
            reducer(initialState, { type: types.RESET_CHANGEPASSWORD })
