...
describe('Profile Reducers', () => {
    ...
    it('should handle UPDATE_PROFILE_SETTING_RESET', () => {
        expect(
            reducer(initialState, { type: types.UPDATE_PROFILE_SETTING_RESET })
    ...
    it('should handle UPDATE_CHANGE_PASSWORD_SETTING_RESET', () => {
        expect(
            reducer(initialState, {
                type: types.UPDATE_CHANGE_PASSWORD_SETTING_RESET,
            })
        ).toEqual(initialState);
    });
    ...
    it('should handle SHOW_PROFILE_MENU', () => {
        ...
        expect(
            reducer(initialState, { type: types.SHOW_PROFILE_MENU })
        ).toEqual(expected);
    });
    ...
    it('should handle HIDE_PROFILE_MENU', () => {
        ...
        expect(
            reducer(initialState, { type: types.HIDE_PROFILE_MENU })
        ).toEqual(expected);
    });
    ...
    it('should handle USER_SETTINGS_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.USER_SETTINGS_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle USER_SETTINGS_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.USER_SETTINGS_RESET })
        ).toEqual(expected);
    });

    it('should handle LOG_FILE', () => {
        const payload = 'assume its a file';
        const expected = {
            ...initialState,
            file: payload,
        };
        expect(
            reducer(initialState, { type: 'LOG_FILE', payload: payload })
        ).toEqual(expected);
    });
