...
describe('Project Reducers', () => {
    ...
    it('should handle PROJECTS_RESET', () => {
        ...
        expect(reducer(initialState, { type: types.PROJECTS_RESET })).toEqual(
            expected
        );
    });
    ...
    it('should handle SWITCH_PROJECT_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.SWITCH_PROJECT_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle CREATE_PROJECT_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_PROJECT_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle CREATE_PROJECT_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_PROJECT_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle RESET_PROJECT_TOKEN_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.RESET_PROJECT_TOKEN_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle RESET_PROJECT_TOKEN_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.RESET_PROJECT_TOKEN_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle RENAME_PROJECT_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.RENAME_PROJECT_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle RENAME_PROJECT_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.RENAME_PROJECT_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle DELETE_PROJECT_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.DELETE_PROJECT_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle DELETE_PROJECT_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.DELETE_PROJECT_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle SHOW_PROJECT_SWITCHER', () => {
        ...
        expect(
            reducer(initialState, { type: types.SHOW_PROJECT_SWITCHER })
        ).toEqual(expected);
    });
    ...
    it('should handle HIDE_PROJECT_SWITCHER', () => {
        ...
        expect(
            reducer(initialState, { type: types.HIDE_PROJECT_SWITCHER })
        ).toEqual(expected);
    });
    ...
    it('should handle SHOW_PROJECT_FORM', () => {
        ...
        expect(
            reducer(initialState, { type: types.SHOW_PROJECT_FORM })
        ).toEqual(expected);
    });
    ...
    it('should handle HIDE_PROJECT_FORM', () => {
        ...
        expect(
            reducer(initialState, { type: types.HIDE_PROJECT_FORM })
        ).toEqual(expected);
    });
    ...
    it('should handle SHOW_DELETE_MODAL', () => {
        ...
        expect(
            reducer(initialState, { type: types.SHOW_DELETE_MODAL })
        ).toEqual(expected);
    });
    ...
    it('should handle HIDE_DELETE_MODAL', () => {
        ...
        expect(
            reducer(initialState, { type: types.HIDE_DELETE_MODAL })
        ).toEqual(expected);
    });
    ...
    it('should handle CHANGE_PLAN_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.CHANGE_PLAN_RESET })
        ).toEqual(expected);
    });
    it('should handle CHANGE_PLAN_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.CHANGE_PLAN_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle EXIT_PROJECT_SUCCESS', () => {
        ...
        expect(
            reducer(initialState, { type: types.EXIT_PROJECT_SUCCESS })
        ).toEqual(expected);
    });
    ...
    it('should handle EXIT_PROJECT_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.EXIT_PROJECT_REQUEST })
        ).toEqual(expected);
    });
