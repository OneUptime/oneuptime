...
describe('Monitors Reducers', () => {
    ...
    it('should handle CREATE_MONITOR_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_MONITOR_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle CREATE_MONITOR_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.CREATE_MONITOR_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle FETCH_MONITORS_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.FETCH_MONITORS_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle FETCH_MONITORS_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.FETCH_MONITORS_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle EDIT_MONITOR_SUCCESS no monitors in state', () => {
        ...
        expect(
            reducer(initialState, { type: types.EDIT_MONITOR_SUCCESS })
        ).toEqual(expected);
    });
    ...
    it('should handle EDIT_MONITOR_SUCCESS with monitors in state, same _id in payload, return monitor in state', () => {
        ...
        initialState.monitorsList.monitors = [
            { _id: 'test EDIT_MONITOR_SUCCESS', from: 'state' },
        ];
        const expected = {
            ...initialState,
            monitorsList: {
    ...
    it('should handle EDIT_MONITOR_FAILURE', () => {
        ...
        expect(
            reducer(initialState, {
                ...
                payload: 'error EDIT_MONITOR_FAILURE',
            })
        ).toEqual(expected);
    });
    ...
    it('should handle EDIT_MONITOR_RESET', () => {
        ...
        expect(
            reducer(initialState, { type: types.EDIT_MONITOR_RESET })
        ).toEqual(expected);
    });
    ...
    it('should handle EDIT_MONITOR_REQUEST', () => {
        ...
        expect(
            reducer(initialState, { type: types.EDIT_MONITOR_REQUEST })
        ).toEqual(expected);
    });
    ...
    it('should handle EDIT_MONITOR_SWITCH, with [] in state.monitorsList.monitors ', () => {
        ...
        expect(
            reducer(initialState, { type: types.EDIT_MONITOR_SWITCH })
        ).toEqual(expected);
    });
    ...
    it('should handle FETCH_MONITORS_INCIDENT_SUCCESS, no monitors in state', () => {
        ...
        expect(
            reducer(initialState, {
                ...
                payload: { monitorId: 'test FETCH_MONITORS_INCIDENT_SUCCESS' },
            })
        ).toEqual(expected);
    });
    ...
    it('should handle FETCH_MONITORS_INCIDENT_SUCCESS, monitors in state, same id as in payload ', () => {
        const payload = [
            {
                _id: 'test FETCH_MONITORS_INCIDENT_SUCCESS',
                skip: 3,
                limit: 6,
                incidents: { data: [{ _id: 'test incidentId' }] },
            },
        ];
        initialState.monitorsList.monitors = [
            {
    ...
    it('should handle FETCH_MONITORS_INCIDENT_SUCCESS, monitors in state, different id as in payload ', () => {
        const payload = {
            monitorId: '_test FETCH_MONITORS_INCIDENT_SUCCESS',
            skip: 3,
            limit: 6,
            incidents: [{ _id: 'test incidentId' }],
        };
        initialState.monitorsList.monitors = [
            { _id: 'test FETCH_MONITORS_INCIDENT_SUCCESS' },
        ];
    ...
    it('should handle FETCH_MONITORS_INCIDENT_FAILURE', () => {
        ...
        expect(
            reducer(initialState, {
                ...
                payload: 'error FETCH_MONITORS_INCIDENT_FAILURE',
            })
        ).toEqual(expected);
    });
    ...
    it('should handle FETCH_MONITORS_INCIDENT_REQUEST', () => {
        const payload = {
            data: { test: 'test FETCH_MONITORS_INCIDENT_REQUEST' },
        };
        const expected = {
            ...initialState,
    ...
    it('should handle DELETE_MONITOR_SUCCESS, different _id in payload', () => {
        initialState.monitorsList.monitors = [
            { _id: '_test DELETE_MONITOR_SUCCESS' },
        ];
    ...
    it('should handle DELETE_MONITOR_SUCCESS, same _id in payload', () => {
        initialState.monitorsList.monitors = [
            { _id: 'test DELETE_MONITOR_SUCCESS' },
        ];
        const payload = 'test DELETE_MONITOR_SUCCESS';
        const expected = {
            ...initialState,
    ...
    it('should handle DELETE_PROJECT_MONITORS', () => {
        ...
        initialState.monitorsList.monitors = [
            { projectId: 'test DELETE_PROJECT_MONITORS' },
        ];
        const expected = {
            ...initialState,
            monitorsList: {
    ...
    it('should handle INCIDENT_RESOLVED_BY_SOCKET,return incident in payload', () => {
        const payload = {
            data: { _id: 'test INCIDENT_RESOLVED_BY_SOCKET', from: 'payload' },
        };

        initialState.monitorsList.monitors = [
            {
                _id: 'test INCIDENT_RESOLVED_BY_SOCKET',
                incidents: [
                    { _id: 'test INCIDENT_RESOLVED_BY_SOCKET', from: 'state' },
                ],
            },
        ];
    ...
    it('should handle INCIDENT_RESOLVED_BY_SOCKET,return incident in state', () => {
        const payload = {
            data: { _id: '_test INCIDENT_RESOLVED_BY_SOCKET', from: 'payload' },
        };
        initialState.monitorsList.monitors = [
            {
                _id: 'test INCIDENT_RESOLVED_BY_SOCKET',
    ...
    it('should handle INCIDENT_ACKNOWLEDGED_BY_SOCKET,return incident in state', () => {
        const payload = {
            data: {
                _id: '_test INCIDENT_ACKNOWLEDGED_BY_SOCKET',
                from: 'payload',
            },
        };
        initialState.monitorsList.monitors = [
            {
                _id: 'test INCIDENT_ACKNOWLEDGED_BY_SOCKET',
                incidents: [
                    {
                        _id: 'test INCIDENT_ACKNOWLEDGED_BY_SOCKET',
                        from: 'state',
    ...
    it('should handle DELETE_MONITOR_BY_SOCKET,return one monitor', () => {
        ...
        initialState.monitorsList.monitors = [
            { _id: 'test DELETE_MONITOR_BY_SOCKET' },
        ];
    ...
    it('should handle ADD_NEW_INCIDENT_TO_MONITORS,filter monitors to []', () => {
        const payload = {
            ...
            _id: 'test1 ADD_NEW_INCIDENT_TO_MONITORS',
        };

        initialState.monitorsList.monitors = [
            {
                _id: 'test ADD_NEW_INCIDENT_TO_MONITORS',
                incidents: [
                    {
                        _id: 'test1 ADD_NEW_INCIDENT_TO_MONITORS',
                        monitorId: { _id: 'test ADD_NEW_INCIDENT_TO_MONITORS' },
                    ...
                    {
                        _id: 'test2 ADD_NEW_INCIDENT_TO_MONITORS',
                        monitorId: { _id: 'test ADD_NEW_INCIDENT_TO_MONITORS' },
                    },
                ],
            },
