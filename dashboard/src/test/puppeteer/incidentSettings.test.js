    ...
    test(
        ...
        async () => {
            return await cluster.execute(null, async ({ page }) => {
                ...
                await page.waitForSelector('#CreateIncidentPriority',{visible: 'hidden'});
                await page.waitForSelector(`priorityDelete_${priorityName}_2`,{visible: true, timeout:100000});
                await page.reload({
                    waitUntil: 'networkidle0',
                });
                ...
                await page.waitForSelector(`priorityDelete_${priorityName}_2`,{visible: true, timeout:100000});
                await page.click(`priorityDelete_${priorityName}_2`);
                await page.waitForSelector('#RemoveIncidentPriority');
                await page.click('#RemoveIncidentPriority'); 
                await page.waitForSelector('#RemoveIncidentPriority',{visible:'hidden'});
                await page.reload({waitUntil: 'networkidle0'});
                const v = await init.selectByText('#incidentPriority', 'High', page);
                expect(v).toMatch('High');
