 ...
 */
 ...
 describe('Fyipe Page Reload', ()=>{
     ...
     test('Should reload the dashboard page and confirm there are no errors', async (done)=>{
        await page.reload({waitUntil:'networkidle0'});
        await page.waitForSelector('#cbHome', {visible:true});
        done();
     }, operationTimeOut);

     test('Should reload the components page and confirm there are no errors', async (done)=>{
     ...
     test('Should reload the incidents page and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the status-pages and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the onCall Duty and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the Scheduled Maintenance and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
        await page.waitForSelector('#scheduledMaintenance', {visible: true});
     ...
     test('Should reload the Reports page and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the Team members and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the Project settings and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
     ...
     test('Should reload the Consulting and Services and confirm there are no errors', async (done)=>{
        await page.goto(utils.DASHBOARD_URL);
        await page.waitForSelector('#consultingServices', {visible: true});
        await page.click('#consultingServices');
        await page.waitForSelector('#consultingServicesPage', {visible:true});
        // To confirm no errors and stays on the same page on reload
        await page.reload({waitUntil:'networkidle0'});
        await page.waitForSelector('#consultingServicesPage', {visible:true});
        done();
