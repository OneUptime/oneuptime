require('./CreateProject.test');
require('./IncidentSubProject.test');
...
require('./SwitchProject.test');
require('./TeamSubProject.test');
require('./UserFeedback.test');
require('./ManageCards.test');