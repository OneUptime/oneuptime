...
describe('actions', () => {
    it('should create an action of type OPEN_NOTIFICATION_MENU', () => {
        ...
        expect(actions.openNotificationMenu().type).toEqual(expectedAction.type)
    })
})
...
describe('actions', () => {
    it('should create an action of type CLOSE_NOTIFICATION_MENU', () => {
        ...
        expect(actions.closeNotificationMenu(error).type).toEqual(expectedAction.type)
...
describe('actions', () => {
    it('should create an action of type FETCH_NOTIFICATIONS_REQUEST', () => {
        ...
        expect(actions.fetchNotificationsRequest().type).toEqual(expectedAction.type)
    })
})
...
describe('actions', () => {
    it('should create an action of type FETCH_NOTIFICATIONS_RESET', () => {
        ...
        expect(actions.fetchNotificationsReset().type).toEqual(expectedAction.type)
    })
})
