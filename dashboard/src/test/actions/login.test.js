...
describe('actions', () => {
    it('should create an action of type LOGIN_REQUEST, promise in payload', () => {
        ...
        let promise = Promise.resolve('login request response')
        let action = actions.loginRequest(promise)
...
describe('actions', () => {
    it('should create an action of type LOGIN_FAILED, error in payload', () => {
        ...
        let action = actions.loginError('error that occurred')
...
describe('actions', () => {
    it('should create an action of type LOGIN_SUCCESS, user in payload', () => {
        ...
        let action = actions.loginSuccess(user)
        expect(action.type).toEqual(expectedAction.type)
        expect(action.payload).toEqual(expectedAction.payload)
    })
})
...
describe('actions', () => {
    it('should despatch LOGIN_REQUEST and INTERNAL_NOTE_SUCCESS  actions', () => {
        let user = {
            _id:'test',username:'test',email:'test',
            tokens:{
        ...
        let action = actions.loginUser({username:'test',password:''})(dispatch)
    })
})