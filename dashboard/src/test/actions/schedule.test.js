...
describe('actions', () => {
    it('should create an action of type SCHEDULE_FETCH_REQUEST', () => {
        ...
        const action = actions.scheduleRequest(promise);
...
describe('actions', () => {
    it('should despatch SCHEDULE_FETCH_FAILED with 404', () => {
            ...
            switch (dispatched.type) {
                case actions.SCHEDULE_FETCH_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.SCHEDULE_FETCH_REQUEST
                    );
                    break;
                case actions.SCHEDULE_FETCH_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.SCHEDULE_FETCH_SUCCESS
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.SCHEDULE_FETCH_FAILED
                    );
        ...
        actions.fetchSchedules({})(dispatch);
    });
});
describe('actions', () => {
    it('should despatch SCHEDULE_FETCH_REQUEST and SCHEDULE_FETCH_SUCCESS  actions', () => {
        ...
        actions.fetchSchedules('projectId')(dispatch);
    });
});
...
describe('actions', () => {
    it('should create an action of type CREATE_SCHEDULE_REQUEST', () => {
        ...
        const action = actions.createScheduleRequest();
        expect(action.type).toEqual(expectedAction.type);
    });
});
    ...
    it('should despatch CREATE_SCHEDULE_FAILED with 404', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                ...
                default:
                    expect(dispatched.type).toEqual(
                        actions.CREATE_SCHEDULE_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.createSchedule({})(dispatch);
    });
});
describe('actions', () => {
    it('should despatch CREATE_SCHEDULE_REQUEST and CREATE_SCHEDULE_SUCCESS  actions', () => {
        axiosMock.onPost(`${API_URL}/schedule/projectId/create`).reply(
            200,
            {
                data: 'success',
            },
        ...
        actions.createSchedule('projectId', {})(dispatch);
    });
});
...
describe('actions', () => {
    it('should create an action of type RENAME_SCHEDULE_RESET', () => {
        ...
        const action = actions.renameScheduleReset();
        expect(action.type).toEqual(expectedAction.type);
    });
});
...
describe('actions', () => {
    it('should create an action of type RENAME_SCHEDULE_REQUEST', () => {
        ...
        const action = actions.renameScheduleRequest();
        expect(action.type).toEqual(expectedAction.type);
...
describe('actions', () => {
    it('should despatch RENAME_SCHEDULE_FAILED with 404', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.RENAME_SCHEDULE_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_SCHEDULE_REQUEST
                    );
                    break;
                case actions.RENAME_SCHEDULE_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_SCHEDULE_SUCCESS
                    );
                    break;
                case actions.RENAME_SCHEDULE_RESET:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_SCHEDULE_RESET
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_SCHEDULE_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.renameSchedule({})(dispatch);
    });
});
describe('actions', () => {
    it('should despatch RENAME_SCHEDULE_REQUEST and RENAME_SCHEDULE_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/schedule/projectId/scheduleId/renameSchedule`)
            .reply(
                200,
                {
                    data: 'success',
...
describe('actions', () => {
    it('should create an action of type DELETE_SCHEDULE_RESET', () => {
        ...
        const action = actions.deleteScheduleReset();
        expect(action.type).toEqual(expectedAction.type);
    });
});
...
describe('actions', () => {
    it('should create an action of type DELETE_SCHEDULE_REQUEST', () => {
        ...
        const action = actions.deleteScheduleRequest();
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(true);
    });
});
...
describe('actions', () => {
    it('should despatch DELETE_SCHEDULE_FAILED with 404', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                ...
                case actions.DELETE_SCHEDULE_RESET:
                    expect(dispatched.type).toEqual(
                        actions.DELETE_SCHEDULE_RESET
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.DELETE_SCHEDULE_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.deleteSchedule('projectId', 'scheduleId')(dispatch);
    });
});
describe('actions', () => {
    it('should despatch DELETE_SCHEDULE_REQUEST and DELETE_SCHEDULE_SUCCESS  actions', () => {
        axiosMock
            .onDelete(`${API_URL}/schedule/projectId/scheduleId/deleteSchedule`)
            .reply(
                200,
                {
                    data: 'success',
...
describe('actions', () => {
    it('should create an action of type ADD_MONITOR_RESET', () => {
        ...
        const action = actions.addMonitorReset();
        expect(action.type).toEqual(expectedAction.type);
    });
});
...
describe('actions', () => {
    it('should create an action of type ADD_MONITOR_REQUEST', () => {
        ...
        const action = actions.addMonitorRequest();
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(true);
    });
});
...
describe('actions', () => {
    it('should despatch ADD_MONITOR_FAILED with 404', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.ADD_MONITOR_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.ADD_MONITOR_REQUEST
                    );
                    break;
                case actions.ADD_MONITOR_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.ADD_MONITOR_SUCCESS
                    );
                    break;
        ...
        actions.addMonitors('projectId', 'scheduleId', {})(dispatch);
    });
});
...
describe('actions', () => {
    it('should despatch ADD_MONITOR_REQUEST and ADD_MONITOR_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/schedule/projectId/scheduleId/addMonitors`)
            .reply(
                200,
                {
                    data: 'success',
...
describe('actions', () => {
    it('should create an action of type ADD_USER_RESET', () => {
        ...
        const action = actions.addUserReset();
        expect(action.type).toEqual(expectedAction.type);
    });
});
...
describe('actions', () => {
    it('should create an action of type ADD_USER_REQUEST', () => {
        ...
        const action = actions.addUserRequest();
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(true);
    });
});
...
describe('actions', () => {
    it('should despatch ADD_MONITOR_FAILED with 404', () => {
        ...
        actions.addUsers('projectId', 'scheduleId', {})(dispatch);
    });
});
...
describe('actions', () => {
    it('should despatch ADD_USER_REQUEST and ADD_USER_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/schedule/projectId/scheduleId/addUsers`)
            .reply(
                200,
                {
                    data: 'success',
