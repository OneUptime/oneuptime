...
describe('actions', () => {
    it('should create an action of type CREATE_FEEDBACK_REQUEST', () => {
        ...
        expect(actions.createFeedbackRequest().type).toEqual(
            expectedAction.type
        );
    });
});
...
describe('actions', () => {
    it('should create an action of type CREATE_FEEDBACK_SUCCESS and project in payload', () => {
        ...
        expect(actions.createFeedbackSuccess('project')).toEqual(
            expectedAction
        );
    });
});
...
describe('actions', () => {
    it('should despatch CREATE_FEEDBACK_REQUEST and CREATE_FEEDBACK_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/feedback/create`)
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                ...
                default:
                    expect(dispatched.type).toEqual(
                        actions.CREATE_FEEDBACK_FAILED
                    );
                    expect(dispatched.payload).toEqual('fail test');
            }
        };
        actions.createFeedback({})(dispatch);
    });
});
