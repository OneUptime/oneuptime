...
describe('actions', () => {
    it('should create an action of type PROJECTS_REQUEST, promise in payload', () => {
        ...
        const action = actions.projectsRequest(Promise.resolve(true));
...
describe('actions', () => {
    it('should create an action of type PROJECTS_FAILED, error in payload', () => {
        ...
        const action = actions.projectsError('error');
        expect(action.type).toEqual(expectedAction.type);
...
describe('actions', () => {
    it('should create an action of type PROJECTS_SUCCESS, projects in payload', () => {
        ...
        const action = actions.projectsSuccess([]);
        expect(action.type).toEqual(expectedAction.type);
...
describe('actions', () => {
    it('should create an action of type PROJECTS_RESET', () => {
        ...
        const action = actions.resetProjects();
        expect(action.type).toEqual(expectedAction.type);
    });
});
...
describe('actions', () => {
    it('should despatch a bunch of error actions', () => {
        ...
        actions.getProjects()(dispatch);
    });
});

describe('actions', () => {
    it('should despatch a bunch of error actions', () => {
        axiosMock.onGet(`${API_URL}/project/projects`).reply(
            200,
            [
                {
                    _id: '123456789',
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                ...
                case 'schedule/SCHEDULE_FETCH_REQUEST':
                    expect(dispatched.type).toEqual(
                        'schedule/SCHEDULE_FETCH_REQUEST'
                    );
                    break;
                ...
                case 'schedule/SCHEDULE_FETCH_FAILED':
                    expect(dispatched.type).toEqual(
                        'schedule/SCHEDULE_FETCH_FAILED'
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
                ...
                case actions.PROJECTS_REQUEST:
                    expect(dispatched.type).toEqual(actions.PROJECTS_REQUEST);
                    return dispatched.payload.then(o =>
                        expect(o).toEqual({
                            data: 'data',
                        })
                    );
...
describe('actions', () => {
    it('should despatch a bunch of success actions', () => {
        ...
        axiosMock
            .onGet(
                `${API_URL}/alert/projectId/getAlerts?skip=undefined&limit=undefined`
            )
            .reply(
                200,
                [
        ...
        axiosMock.onGet(`${API_URL}/statusPage/projectId/statusPages`).reply(
            200,
            {
                data: 'status page',
            },
        ...
        axiosMock.onGet(`${API_URL}/monitor/projectId/monitors`).reply(
            200,
            [
                {
                    _id: 'id one',
        ...
        axiosMock.onGet(`${API_URL}/schedule/projectId/projectSchedules`).reply(
            200,
            [
                {
                    _id: 'id one',
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                ...
                case 'schedule/SCHEDULE_FETCH_SUCCESS':
                    expect(dispatched.type).toEqual(
                        'schedule/SCHEDULE_FETCH_SUCCESS'
                    );
                    expect(dispatched.payload).toEqual([
                        {
                            _id: 'id one',
...
describe('actions', () => {
    it('should create an action of type CREATE_PROJECT_REQUEST', () => {
        ...
        expect(actions.createProjectRequest().type).toEqual(
            expectedAction.type
        );
    });
});
...
describe('actions', () => {
    it('should create an action of type CREATE_PROJECT_FAILED', () => {
        ...
        const action = actions.createProjectError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
...
describe('actions', () => {
    it('should create an action of type CREATE_PROJECT_SUCCESS, and project in payload', () => {
        const action = actions.createProjectSuccess('project');
...
describe('actions', () => {
    it('should despatch CREATE_PROJECT_FAILED with Request failed with status code 404 error', () => {
        axiosMock.onPost(`${API_URL}/project/createxx`).reply(
            200,
            {
                data: 'response',
            },
...
describe('actions', () => {
    it('should create an action of type RESET_PROJECT_TOKEN_RESET', () => {
        ...
        expect(actions.resetProjectTokenReset().type).toEqual(
            expectedAction.type
        );
    });
});
...
describe('actions', async () => {
    it('should create an action of type RESET_PROJECT_TOKEN_REQUEST', () => {
        const action = actions.resetProjectTokenRequest();
...
describe('actions', () => {
    it('should create an action of type RESET_PROJECT_TOKEN_FAILED', () => {
        ...
        const action = actions.resetProjectTokenError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type RESET_PROJECT_TOKEN_SUCCESS', () => {
        const action = actions.resetProjectTokenSuccess({
            data: 'data',
        });
...
describe('actions', () => {
    it('should despatch RESET_PROJECT_TOKEN_REQUEST and RESET_PROJECT_TOKEN_SUCCESS  actions', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.RESET_PROJECT_TOKEN_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.RESET_PROJECT_TOKEN_SUCCESS
                    );
                    expect(dispatched.payload).toEqual([]);
                    break;
                case actions.RESET_PROJECT_TOKEN_RESET:
                    expect(dispatched.type).toEqual(
                        actions.RESET_PROJECT_TOKEN_RESET
                    );
                    break;
                case actions.RESET_PROJECT_TOKEN_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.RESET_PROJECT_TOKEN_REQUEST
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.RESET_PROJECT_TOKEN_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.resetProjectToken('projectId')(dispatch);
    });
});

describe('actions', () => {
    it('should despatch RESET_PROJECT_TOKEN_REQUEST and RESET_PROJECT_TOKEN_SUCCESS  actions', () => {
        axiosMock.onGet(`${API_URL}/project/projectId/resetToken`).reply(
            200,
            {
                data: 'token',
            },
...
describe('actions', async () => {
    it('should create an action of type RENAME_PROJECT_REQUEST', () => {
        const action = actions.renameProjectRequest();
...
describe('actions', () => {
    it('should create an action of type RENAME_PROJECT_SUCCESS', () => {
        const action = actions.renameProjectSuccess({
            data: 'data',
        });
...
describe('actions', () => {
    it('should create an action of type RENAME_PROJECT_FAILED', () => {
        ...
        const action = actions.renameProjectError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch RENAME_PROJECT_FAILED error action', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.RENAME_PROJECT_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_PROJECT_SUCCESS
                    );
                    expect(dispatched.payload).toEqual([]);
                    break;
                case actions.RESET_PROJECT_TOKEN_RESET:
                ...
                case actions.RENAME_PROJECT_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_PROJECT_REQUEST
                    );
                    break;
                case actions.RENAME_PROJECT_RESET:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_PROJECT_RESET
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.RENAME_PROJECT_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.renameProject('projectId', 'project name')(dispatch);
    });
});

describe('actions', () => {
    it('should despatch RENAME_PROJECT_FAILED error action', () => {
        axiosMock.onPost(`${API_URL}/project/projectId/renameProject`).reply(
            200,
            {
...
describe('actions', () => {
    it('should create an action of type DELETE_PROJECT_REQUEST', () => {
        ...
        expect(actions.deleteProjectRequest().type).toEqual(
            expectedAction.type
        );
    });
});
...
describe('actions', () => {
    it('should create an action of type DELETE_PROJECT_FAILED', () => {
        ...
        const action = actions.deleteProjectError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch DELETE_PROJECT_FAILED error action', () => {
        ...
        actions.deleteProject('projectId')(dispatch);
    });
});

describe('actions', () => {
    it('should despatch DELETE_PROJECT_FAILED error action', () => {
        axiosMock.onDelete(`${API_URL}/project/projectId/deleteProject`).reply(
            200,
            {
                data: 'renamed project',
            },
...
describe('actions', () => {
    it('should create an action of type CHANGE_PLAN_SUCCESS', () => {
        const action = actions.changePlanSuccess({
            data: 'data',
        });
...
describe('actions', () => {
    it('should create an action of type CHANGE_PLAN_FAILED', () => {
        ...
        const action = actions.changePlanError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch CHANGE_PLAN_FAILED error action', () => {
        ...
        actions.changePlan('projectId')(dispatch);
    });
});

describe('actions', () => {
    it('should despatch DELETE_PROJECT_FAILED error action', () => {
        axiosMock.onPost(`${API_URL}/project/projectId/changePlan`).reply(
            200,
            {
                data: 'new plan',
            },
...
describe('actions', () => {
    it('should create an action of type EXIT_PROJECT_SUCCESS', () => {
        const action = actions.exitProjectSuccess('userId');
...
describe('actions', () => {
    it('should create an action of type EXIT_PROJECT_FAILED', () => {
        ...
        const action = actions.exitProjectError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch CHANGE_PLAN_FAILED error action', () => {
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.EXIT_PROJECT_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.EXIT_PROJECT_REQUEST
                    );
                    break;
                case actions.EXIT_PROJECT_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.EXIT_PROJECT_SUCCESS
                    );
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.EXIT_PROJECT_FAILED
                    );
                    expect(dispatched.payload).toEqual(
                        Error('Request failed with status code 404')
                    );
        ...
        actions.exitProject('projectId', 'userId')(dispatch);
    });
});
...
describe('actions', () => {
    it('should despatch DELETE_PROJECT_FAILED error action', () => {
        axiosMock
            .onDelete(`${API_URL}/project/projectId/user/userId/exitProject`)
            .reply(
                200,
                {
                    data: 'new plan',
