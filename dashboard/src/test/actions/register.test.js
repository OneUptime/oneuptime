...
describe('actions', () => {
    it('should create an action of type SIGNUP_FAILED', () => {
        ...
        let action = actions.signupError('error that occurred')
...
describe('actions', () => {
    it('should create an action of type SAVE_USER_STATE with values in payload', () => {
        ...
        let action = actions.saveUserState('values')
        expect(action.type).toEqual(expectedAction.type)
        expect(action.payload).toEqual(expectedAction.payload)
    })
})
...
describe('actions', () => {
    it('should create an action of type SAVE_CARD_STATE with values in payload', () => {
        ...
        let action = actions.saveCompanyState('values')
        expect(action.type).toEqual(expectedAction.type)
        expect(action.payload).toEqual(expectedAction.payload)
    })
})
...
describe('actions', () => {
    it('should create an action of type SAVE_COMPANY_STATE with values in payload', () => {
        ...
        let action = actions.saveCardState('values')
        expect(action.type).toEqual(expectedAction.type)
        expect(action.payload).toEqual(expectedAction.payload)
    })
})
describe('actions', () => {
    it('should create an action of type SIGNUP_REQUEST, promise in payload', () => {
        ...
        let action = actions.signUpRequest(promise)
...
describe('actions', () => {
    it('should create an action of type RESET_SIGNUP', () => {
        let action = actions.signUpReset()
...
describe('actions', () => {
    it('should create an action of type RESET_SIGNUP', () => {
        let action = actions.resetSignup()
...
describe('actions', () => {
    it('should despatch LOGIN_SUCCESS', () => {
        ...
        let action = actions.signupSuccess(user)(dispatch)
    })
})
...
describe('actions', () => {
    it('should despatch SIGNUP_FAILED with 404', () => {
        ...
        let action = actions.signupUser({})(dispatch)
    })
})
...
describe('actions', () => {
    it('should create an action of type SIGNUP_STEP_INC', () => {
        let action = actions.incrementStep()
...
describe('actions', () => {
    it('should create an action of type SKIP_CARD_STEP', () => {
        let action = actions.skipCardStep()
...
describe('actions', () => {
    it('should create an action of type SIGNUP_STEP_DEC', () => {
        let action = actions.decrementStep()
...
describe('actions', () => {
    it('should create an action of type IS_USER_INVITED_REQUEST, promise in payload', () => {
        let promise = Promise.resolve('request response')
        let action = actions.isUserInvitedRequest(promise)
...
describe('actions', () => {
    it('should create an action of type IS_USER_INVITED_SUCCESS', () => {
        ...
        expect(actions.isUserInvitedSuccess().type).toEqual(expectedAction.type)
    })
})
describe('actions', () => {
...
describe('actions', () => {
    it('should despatch SIGNUP_FAILED with 404', () => {
        ...
        let dispatch = (dispatched) => {
            switch (dispatched.type) {
                case actions.IS_USER_INVITED_REQUEST:
                    expect(dispatched.type).toEqual(actions.IS_USER_INVITED_REQUEST)
                    break;
                case actions.IS_USER_INVITED_RESET:
                    expect(dispatched.type).toEqual(actions.IS_USER_INVITED_RESET)
                    expect(dispatched.payload).toEqual(Error('Request failed with status code 404'))
                    break;
                default:
                    expect(dispatched.type).toEqual(actions.IS_USER_INVITED_REQUEST)
        ...
        let action = actions.isUserInvited({})(dispatch)
    })
})
        ...
        let dispatch = (dispatched) => {
            switch (dispatched.type) {
                ...
                case actions.IS_USER_INVITED_SUCCESS:
                    expect(dispatched.type).toEqual(actions.IS_USER_INVITED_SUCCESS)
                    expect(dispatched.payload).toEqual(user)
                    break;
                default:
                    expect(dispatched.type).toEqual(actions.IS_USER_INVITED_REQUEST)
