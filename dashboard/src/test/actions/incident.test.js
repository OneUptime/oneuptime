...
describe('actions', () => {
    it('should create an action of type INCIDENTS_REQUEST, promise in payload', () => {
        ...
        const action = actions.incidentsRequest(promise);
...
describe('actions', () => {
    it('should create an action of type INCIDENTS_FAILED', () => {
        ...
        const action = actions.incidentsError('error that occurred');
...
describe('actions', () => {
    it('should create an action of type INCIDENTS_SUCCESS with incidents in payload', () => {
        ...
        const action = actions.incidentsSuccess('incidents');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch INCIDENTS_REQUEST and INCIDENTS_SUCCESS  actions', () => {
        axiosMock
            .onGet(`${API_URL}/incident/projectId/incidents?skip=5&limit=10`)
            .reply(200, [], {});
        ...
        actions.getIncidents('projectId', 5, 10)(dispatch);
    });
});
...
describe('actions', () => {
    it('should create an action of type CREATE_INCIDENT_REQUEST, promise in payload', () => {
        const promise = Promise.resolve('create incident request response');
        const action = actions.createIncidentRequest(promise);
...
describe('actions', () => {
    it('should create an action of type CREATE_INCIDENT_FAILED, error in payload', () => {
        ...
        const action = actions.createIncidentError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type CREATE_INCIDENT_SUCCESS with incidents in payload', () => {
        ...
        const action = actions.createIncidentSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch CREATE_INCIDENT_REQUEST and CREATE_INCIDENT_SUCCESS  actions', () => {
        axiosMock.onPost(`${API_URL}/incident/projectId/create`).reply(
            200,
            {
                _id: 'id here',
            ...
            switch (dispatched.type) {
                case actions.CREATE_INCIDENT_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.CREATE_INCIDENT_REQUEST
                    );
                    break;
                case actions.CREATE_INCIDENT_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.CREATE_INCIDENT_SUCCESS
                    );
                    expect(dispatched.payload).toEqual({
                        _id: 'id here',
                        date: 'February 14th, 3:25:50.125 PM',
                ...
                default:
                    expect(dispatched.type).toEqual(
                        actions.CREATE_INCIDENT_FAILED
                    );
                    expect(dispatched.payload).toEqual('fail test');
            }
        };
        actions.createNewIncident('projectId', 'monitorId')(dispatch);
    });
});
...
describe('actions', () => {
    it('should create an action of type INCIDENT_REQUEST, promise in payload', () => {
        const promise = Promise.resolve('incident request response');
        const action = actions.incidentRequest(promise);
...
describe('actions', () => {
    it('should create an action of type INCIDENT_FAILED, error in payload', () => {
        ...
        const action = actions.incidentError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type INCIDENT_SUCCESS with incident in payload', () => {
        ...
        const action = actions.incidentSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type ACKNOWLEDGE_INCIDENT_REQUEST, promise in payload', () => {
        const promise = Promise.resolve(
            'Acknowledge Incident Request request response'
        );
        const action = actions.acknowledgeIncidentRequest(promise);
...
describe('actions', () => {
    it('should create an action of type RESOLVE_INCIDENT_REQUEST, promise in payload', () => {
        const promise = Promise.resolve(
            'Resolve Incident Request request response'
        );
        const action = actions.resolveIncidentRequest(promise);
...
describe('actions', () => {
    it('should create an action of type ACKNOWLEDGE_INCIDENT_SUCCESS with incident in payload', () => {
        ...
        const action = actions.acknowledgeIncidentSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type RESOLVE_INCIDENT_SUCCESS with incident in payload', () => {
        ...
        const action = actions.resolveIncidentSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should despatch INCIDENT_REQUEST and INCIDENT_SUCCESS  actions', () => {
        axiosMock
            .onGet(`${API_URL}/incident/projectId/incident/incidentId`)
            .reply(
                200,
                {
                    _id: 'id here',
        ...
        actions.getIncident('projectId', 'incidentId')(dispatch);
    });
});
...
describe('actions acknowledgeIncident multiple true', () => {
    it('should despatch ACKNOWLEDGE_INCIDENT_REQUEST and ACKNOWLEDGE_INCIDENT_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/incident/projectId/acknowledge/incidentId`)
            .reply(
                200,
                {
                    _id: 'id here',
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.ACKNOWLEDGE_INCIDENT_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.ACKNOWLEDGE_INCIDENT_REQUEST
                    );
                    break;
                case actions.ACKNOWLEDGE_INCIDENT_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.ACKNOWLEDGE_INCIDENT_SUCCESS
                    );
...
describe('actions resolveIncident multiple false', () => {
    it('should despatch RESOLVE_INCIDENT_REQUEST and RESOLVE_INCIDENT_REQUEST  actions', () => {
        axiosMock
            .onPost(`${API_URL}/incident/projectId/resolve/incidentId`)
            .reply(
                200,
                {
                    _id: 'id here',
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.RESOLVE_INCIDENT_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.RESOLVE_INCIDENT_REQUEST
                    );
                    break;
                case actions.RESOLVE_INCIDENT_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.RESOLVE_INCIDENT_SUCCESS
                    );
                    expect(dispatched.payload.data).toEqual({
                        _id: 'id here',
                        date: 'February 14th, 3:25:50.125 PM',
...
describe('actions', () => {
    it('should create an action of type UNRESOLVED_INCIDENTS_REQUEST, promise in payload', () => {
        const promise = Promise.resolve('Unresolved incident request response');
        const action = actions.UnresolvedIncidentsRequest(promise);
...
describe('actions', () => {
    it('should create an action of type UNRESOLVED_INCIDENTS_FAILED, error in payload', () => {
        ...
        const action = actions.UnresolvedIncidentsError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type UNRESOLVED_INCIDENTS_SUCCESS with incidents in payload', () => {
        ...
        const action = actions.UnresolvedIncidentsSuccess('incidents');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type UNRESOLVED_INCIDENTS_RESET', () => {
        ...
        expect(actions.resetUnresolvedIncidents().type).toEqual(
            expectedAction.type
        );
    });
});
...
describe('actions fetchUnresolvedIncidents', () => {
    it('should despatch UNRESOLVED_INCIDENTS_REQUEST and RESOLVE_INCIDENT_REQUEST  actions', () => {
        axiosMock
            .onGet(`${API_URL}/incident/projectId/unresolvedincidents`)
            .reply(200, [], {});
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.UNRESOLVED_INCIDENTS_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.UNRESOLVED_INCIDENTS_REQUEST
                    );
                    break;
                case actions.UNRESOLVED_INCIDENTS_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.UNRESOLVED_INCIDENTS_SUCCESS
                    );
                    expect(dispatched.payload).toEqual([]);
                    break;
                default:
                    expect(dispatched.type).toEqual(
                        actions.UNRESOLVED_INCIDENTS_FAILED
                    );
                    expect(dispatched.payload).toEqual('fail test');
            }
        };
        actions.fetchUnresolvedIncidents('projectId')(dispatch);
    });
});
...
describe('actions', () => {
    it('should create an action of type INVESTIGATION_NOTE_REQUEST, promise in payload', () => {
        const promise = Promise.resolve('Investigation note request response');
        const call = actions.investigationNoteRequest(promise);
...
describe('actions', () => {
    it('should create an action of type INVESTIGATION_NOTE_FAILED, error in payload', () => {
        ...
        const action = actions.investigationNoteError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type INVESTIGATION_NOTE_SUCCESS with incidents in payload', () => {
        ...
        const action = actions.investigationNoteSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions setInvestigationNote', () => {
    it('should despatch INVESTIGATION_NOTE_REQUEST and INVESTIGATION_NOTE_SUCCESS  actions', () => {
        axiosMock
            .onPost(
                `${API_URL}/incident/projectId/investigationNotes/incidentId`
            )
            .reply(
                200,
                {
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.INVESTIGATION_NOTE_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.INVESTIGATION_NOTE_REQUEST
                    );
                    break;
                case actions.INVESTIGATION_NOTE_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.INVESTIGATION_NOTE_SUCCESS
                    );
                    expect(dispatched.payload).toEqual({
                        status: 'success',
                    });
                ...
                default:
                    expect(dispatched.type).toEqual(
                        actions.INVESTIGATION_NOTE_FAILED
                    );
                    expect(dispatched.payload).toEqual('fail test');
            }
        };
        actions.setInvestigationNote(
            'projectId',
            'incidentId',
            'test note'
        )(dispatch);
...
describe('actions', () => {
    it('should create an action of type INTERNAL_NOTE_REQUEST, promise in payload', () => {
        const promise = Promise.resolve('Internal note request response');
        const call = actions.internalNoteRequest(promise);
...
describe('actions', () => {
    it('should create an action of type INTERNAL_NOTE_FAILED, error in payload', () => {
        ...
        const action = actions.internalNoteError('error that occurred');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions', () => {
    it('should create an action of type INTERNAL_NOTE_SUCCESS with incidents in payload', () => {
        ...
        const action = actions.internalNoteSuccess('incident');
        expect(action.type).toEqual(expectedAction.type);
        expect(action.payload).toEqual(expectedAction.payload);
    });
});
...
describe('actions setinternalNote', () => {
    it('should despatch INTERNAL_NOTE_REQUEST and INTERNAL_NOTE_SUCCESS  actions', () => {
        axiosMock
            .onPost(`${API_URL}/incident/projectId/internalNotes/incidentId`)
            .reply(
                200,
                {
                    status: 'success',
        ...
        const dispatch = dispatched => {
            switch (dispatched.type) {
                case actions.INTERNAL_NOTE_REQUEST:
                    expect(dispatched.type).toEqual(
                        actions.INTERNAL_NOTE_REQUEST
                    );
                    break;
                case actions.INTERNAL_NOTE_SUCCESS:
                    expect(dispatched.type).toEqual(
                        actions.INTERNAL_NOTE_SUCCESS
                    );
                    expect(dispatched.payload).toEqual({
                        status: 'success',
                    });
                ...
                default:
                    expect(dispatched.type).toEqual(
                        actions.INTERNAL_NOTE_FAILED
                    );
                    expect(dispatched.payload).toEqual('fail test');
            }
        };
        actions.setinternalNote(
            'projectId',
            'incidentId',
            'test note'
        )(dispatch);
