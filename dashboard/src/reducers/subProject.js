...
export default function subProject(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case types.SUBPROJECTS_SUCCESS:
            return Object.assign({}, state, {
                subProjects: {
                    ...
                    error: null,
                    success: true,
                    subProjects: action.payload.data
                },
            });
        ...
        case types.RESET_SUBPROJECT_TOKEN_SUCCESS:
            ...
            index = subProjects.findIndex(subProject => subProject._id === action.payload._id);
        ...
        case types.DELETE_SUBPROJECT_SUCCESS:
            subProjects = Object.assign([], state.subProjects.subProjects);
            subProjects = subProjects.filter(subProject => subProject._id !== action.payload);
            return Object.assign({}, state, {
                deleteSubProject: {
                    requesting: false,
