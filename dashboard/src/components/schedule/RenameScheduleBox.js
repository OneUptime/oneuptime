                    ...
                    <div className="Box-root">
                        ...
                        <form onSubmit={this.props.handleSubmit(this.submitForm)}>
                                        ...
                                        <fieldset className="bs-Fieldset">
                                            <div className="bs-Fieldset-rows">
                                                <div className="bs-Fieldset-row">
                                                    <label className="bs-Fieldset-label">Schedule Name</label>
                                                    <div className="bs-Fieldset-fields">
                                                        ...
                                                        <RenderIfSubProjectMember>
                                                            <label className="bs-Fieldset-label">{this.props.initialValues && this.props.initialValues.schedule_name ? this.props.initialValues.schedule_name : 'Unnamed Schedule'}</label>
                                                        </RenderIfSubProjectMember>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="bs-ContentSection-footer bs-ContentSection-content Box-root Box-background--white Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween Padding-horizontal--20 Padding-vertical--12">
                                ...
                                <div>
                                    <RenderIfSubProjectAdmin>
                                        <button className="bs-Button bs-Button--blue" type="submit">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RenameScheduleForm));