        ...
        <>
            ...
            {((isNextActiveTeam &&  teamMembersOnPartialDutyCount > 0) || isActiveTeam) && <div className="bs-Fieldset-row">
                ...
                <div className="bs-Fieldset-fields labelfield">
                    ...
                    {isActiveTeam && <><div>
                        <p><b>Reminders: </b>{escalation.call && <span>{escalation.callReminders}  Call reminders</span>} {escalation.call && escalation.sms && <span>,</span>} {escalation.sms && <span>{escalation.smsReminders}  SMS reminders</span>} {(escalation.sms || escalation.call) && escalation.email && <span>,</span>} {escalation.email && <span>{escalation.emailReminders}  Email reminders</span>} <span> will be sent to each member of this team if they do not respond. <br /></span></p>
                    </div>
