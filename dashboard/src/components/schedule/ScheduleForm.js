...
export class ScheduleForm extends React.Component{
    ...
    submitForm = (values) => {
		this.props.createSchedule(this.props.data.projectId, values).then(()=>{
                            ...
                            <div className="ModalLayer-contents" tabIndex={-1} style={{ marginTop: 40 }}>
                                ...
                                <div className="bs-Modal-header">
                                    ...
                                    <div className="bs-Modal-messages">
                                        <ShouldRender if={this.props.schedule.newSchedule.error}>
                                            <p className="bs-Modal-message">{this.props.schedule.newSchedule.error}</p>
                                        </ShouldRender>
                                    </div>
                                </div>
                                <div className="bs-Modal-body">
                                    <Field
                                        ...
                                        disabled={this.props.schedule.newSchedule.requesting}
                                    />
                                </div>
                                    <div className="bs-Modal-footer">
                                        <div className="bs-Modal-footer-actions">
                                            <button
                                                className={`bs-Button bs-DeprecatedButton ${this.props.schedule.newSchedule.requesting && 'bs-is-disabled'}`}
                                                type="button"
                                            ...
                                            <button
                                                ...
                                                className={`bs-Button bs-DeprecatedButton bs-Button--blue ${this.props.schedule.newSchedule.requesting && 'bs-is-disabled'}`}
                                                type="save"
                                                disabled={this.props.schedule.newSchedule.requesting}
                                            >
                                                <ShouldRender if={this.props.schedule.newSchedule.requesting}>
                                                    <Spinner />
                                                </ShouldRender>
