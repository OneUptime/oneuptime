...
class PaymentCard extends Component {
    ...
    componentDidMount() {
        ...
        this.props.fetchCards(projectId);
    }


    render() {
        const { createCardModalId, confirmCardDeleteModalId } = this.state;
        const { cards, requesting, projectId, settingDefaultCard, requestingDefaultCardId } = this.props;
        return (
                                                ...
                                                <div className="Box-root">
                                                    <button onClick={() => {
                                                        ...
                                                        <div className="bs-ButtonLegacy-fill Box-root Box-background--white Flex-inlineFlex Flex-alignItems--center Flex-direction--row Padding-horizontal--8 Padding-vertical--4">
                                                            ...
                                                            <span id="addCardButton" className="bs-Button bs-FileUploadButton bs-Button--icon bs-Button--new">
                                                                <span>Add card</span>
                                                            </span>
                                                        </div>
                                                    </button>
                                    ...
                                    {requesting ? <ListLoader /> :
                                        <table className="Table">
                                            <thead className="Table-body">
                                                <tr className="Table-row db-ListViewItem db-ListViewItem-header">
                                                    ...
                                                    <td className="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap db-ListViewItem-cell" style={{ height: '1px' }}>
                                                        <div className="db-ListViewItem-cellContent Box-root Padding-all--8"><span className="db-ListViewItem-text Text-align--left Text-color--dark Text-display--block Text-fontSize--13 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--upper Text-wrap--wrap"><span>Expiry</span></span></div>
                                                    </td>
                                                    ...
                                                    <td className="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap db-ListViewItem-cell" style={{ height: '1px' }}>
                                                        <div className="db-ListViewItem-cellContent Box-root Padding-all--8"><span className="db-ListViewItem-text Text-color--dark Text-display--inline Text-fontSize--13 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--upper Text-wrap--wrap"><span></span></span></div>
                                                    </td>
                                                    <td className="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap db-ListViewItem-cell" style={{ height: '1px' }}>
                                                        <div className="db-ListViewItem-cellContent Box-root Padding-all--8"><span className="db-ListViewItem-text Text-color--dark Text-display--inline Text-fontSize--13 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--upper Text-wrap--wrap"><span>Default</span></span></div>
                                                    </td>
                                            ...
                                            <tbody className="Table-body">
                                                {!requesting && cards.length > 0 && cards.map((card, i) => {
                                                    if (card.brand === 'American Express') {
                                                        card.brand = 'cc-amex';
                                                    }
                                                    else if (card.brand === 'Diners Club') {
                                                        card.brand = 'cc-diners-club'
                                                    }
                                                    else if (card.brand === 'Visa') {
                                                        card.brand = 'cc-visa'
                                                    }
                                                    else if (card.brand === 'MasterCard') {
                                                        card.brand = 'cc-mastercard'
                                                    }
                                                    else if (card.brand === 'JCB') {
                                                        card.brand = 'cc-jcb'
                                                    }
                                                    else if (card.brand === 'Discover') {
                                                        card.brand = 'cc-discover'
                                                    }
                                                    return (
                                                        <tr className="Table-row db-ListViewItem bs-ActionsParent db-ListViewItem" key={card.id} >
                                                                    ...
                                                                    <span className="db-ListViewItem-text Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                                                                        <div className="Box-root Margin-right--16">
                                                                            <div className="Box-root bs-u-floatLeft Padding-vertical--8">
                                                                                <span>
                                                                                    <i className={`fa fa-${card.brand} fa-lg`}></i>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </span>
                                                            ...
                                                            <td id="placeholder-left" className="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--wrap--noWrap db-ListViewItem-cell">
                                                                <div className="db-ListViewItem-cellContent Box-root Padding-all--8">
                                                            ...
                                                            <td id="placeholder-right" className="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--wrap--noWrap db-ListViewItem-cell">
                                                                <div className="db-ListViewItem-cellContent Box-root Padding-all--8">
                                                                    <span className="db-ListViewItem-text Text-color--dark Text-display--inline Text-fontSize--13 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--upper Text-wrap--wrap"></span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td className="Table-cell Table-cell--align--right Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap db-ListViewItem-cell" style={{ height: '1px' }}>
                                                                <div className="db-ListViewItem-cellContent Box-root Padding-all--8" style={{ display: 'flex' }}>
                                                                    <div id={`deleteCard${i}`} onClick={() =>
                                                                        this.props.openModal({
                                                                            id: confirmCardDeleteModalId,
                                                                            content: DataPathHoC(DeleteCard, {}),
                                                                            deleteCardId: card.id
                                                                        })} className="Box-root">
                                                                        <div className="Margin-all--4 bs-u-v-middle">
                                                                            <button className="Button bs-ButtonLegacy" type="button">
                                                                                <div className="Button-fill bs-ButtonLegacy-fill Box-root Flex-inlineFlex Flex-alignItems--center Flex-direction--row Padding-horizontal--8 Padding-vertical--4"><span className="Button-label Text-color--default Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--noWrap"><i className="fa fa-trash"></i></span></div>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    {!card.default_source &&
                                                                        <div id={`setDefaultCard${i}`}
                                                                            className="Box-root"
                                                                            onClick={() => this.props.setDefaultCard(projectId, card.id)}>
                                                                            <div className="Margin-all--4 bs-u-v-middle">
                                                                                <button
                                    ...
                                    <div className="Box-root Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween" style={{ backgroundColor: 'white' }}>
                                        <div className="Box-root Flex-flex Flex-alignItems--center Padding-all--20">
                                            <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                                                <span>
                                                    <span id="cardsCount" className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">{this.props.count ? this.props.count + (this.props.count > 1 ? ' Cards' : ' Card') : '0 Card'}</span>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
...
const mapDispatchToProps = dispatch => bindActionCreators(
    { openModal, closeModal, fetchCards, setDefaultCard }, dispatch
)
