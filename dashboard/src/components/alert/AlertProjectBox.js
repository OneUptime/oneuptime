    ...
    <div>
        ...
        <table className="Table">
            ...
            <tbody className="Table-body" style={{pointerEvents: 'none'}}>
                ...
                <AlertTableRows alerts={subProjectAlert.alerts} isRequesting={isRequesting} />

            </tbody>
        </table>

        <ShouldRender if={!isRequesting && subProjectAlert.alerts.length === 0}>
        ...
        <div className="Box-root Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween">
                    ...
                    <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                        <span>
                            <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
                                {subProjectAlert.count} Alert{subProjectAlert.count === 1 ? '' : 's'}
                            </span>
                        </span>
                    </span>
                </div>
            ...
            <div className="Box-root Padding-horizontal--20 Padding-vertical--16">
                <div className="Box-root Flex-flex Flex-alignItems--stretch Flex-direction--row Flex-justifyContent--flexStart">
                    <div className="Box-root Margin-right--8">
                        <button className={'Button bs-ButtonLegacy' + (canPrev ? '' : 'Is--disabled')} disabled={!canPrev} data-db-analytics-name="list_view.pagination.previous" type="button" onClick={()=>{prevClicked(subProjectAlert._id, subProjectAlert.skip, subProjectAlert.limit)}}>
                    ...
                    <div className="Box-root">
                        <button
                            ...
                            disabled={!canNext} data-db-analytics-name="list_view.pagination.next"
                            type="button"
                            onClick={()=>{nextClicked(subProjectAlert._id, subProjectAlert.skip, subProjectAlert.limit)}}
                        >
...
AlertProjectBox.displayName = 'IncidentProjectBox';
