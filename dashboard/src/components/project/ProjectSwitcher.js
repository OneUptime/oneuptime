        ...
        if (projects && projects.length > 0) {
            projectOptions = projects.map(project => (
                <div key={project._id} title={project.name}>
                    <ReactHoverObserver>
                        {({ isHovering }) => (
                            <div aria-selected="false" role="option" onClick={() => this.selectProject(project)}>
                                <div>
                                    <div className={isHovering ? 'Box-root Box-background--blue Flex-flex Flex-alignItems--center Padding-horizontal--8 Padding-vertical--4' : 'Box-root Box-background--white Flex-flex Flex-alignItems--center Padding-horizontal--8 Padding-vertical--4'} style={{ cursor: 'pointer', userSelect: 'none' }}>
                                        ...
                                        <div style={{ 'overflow': 'hidden', 'textOverflow': 'ellipsis', 'whiteSpace': 'nowrap' }}>
                                            <span id={`span_${project.name}`} className={isHovering ? 'Text-color--white Text-display--inline Text-fontSize--16 Text-fontWeight--medium Text-lineHeight--24 Text-typeface--base Text-wrap--wrap' : 'Text-color--default Text-display--inline Text-fontSize--16 Text-fontWeight--medium Text-lineHeight--24 Text-typeface--base Text-wrap--wrap'}>{project.name}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <span>
                    <div id="selector" className="db-AccountSwitcher Card-root Card-shadow--medium">
                        <div className="ScrollableMenu db-AccountSwitcher-menu" id="accountSwitcher" role="listbox">
                            ...
                            <ReactHoverObserver>
                                {({ isHovering }) => (
                                    <div aria-selected="false" role="option" onClick={this.handleClick}>
                                        <div>
                                            <div className={isHovering ? 'Box-root Box-background--blue Flex-flex Flex-alignItems--center Padding-horizontal--8 Padding-vertical--8' : 'Box-root Box-background--white Flex-flex Flex-alignItems--center Padding-horizontal--8 Padding-vertical--8'} style={{ cursor: 'pointer', userSelect: 'none' }}>
                                                <div className="Box-root Margin-right--8">
                                                    <div className="db-AccountSwitcherX-activeImage">
                                                        <div className="db-AccountSwitcherX-accountImage Box-root Box-background--white">
                                                ...
                                                <div style={{ 'overflow': 'hidden', 'textOverflow': 'ellipsis', 'whiteSpace': 'nowrap' }}>
                                                    <span id="create-project"
                                                        className={isHovering ? 'Text-color--white Text-display--inline Text-fontSize--16 Text-fontWeight--medium Text-lineHeight--24 Text-typeface--base Text-wrap--wrap' : 'Text-color--default Text-display--inline Text-fontSize--16 Text-fontWeight--medium Text-lineHeight--24 Text-typeface--base Text-wrap--wrap'}
                                                    >
                                                        Create New Project
                                                    </span>
                                                </div>
