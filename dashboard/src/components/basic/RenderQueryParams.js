...
const RenderQueryParams = ({ fields }) => {
                ...
                <div className="bs-Fieldset-row">
                    <div className="Box-root Margin-bottom--12">
                        ...
                        >
                            ...
                            >
                                Currently you do not have any query params
                                saved. Please click the Add Params button above
                                to add one.
                            </label>
...
RenderQueryParams.displayName = 'RenderQueryParams';

RenderQueryParams.propTypes = {
    fields: PropTypes.oneOfType([PropTypes.array, PropTypes.object]).isRequired,
};

export default RenderQueryParams;
