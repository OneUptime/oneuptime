export const emailTemplateTitles = {
    ...
    'Subscriber Incident Acknowldeged':
        'Subscriber Incident Acknowldeged Email Template',
...
export const emailTemplateDescriptions = {
    ...
    'Subscriber Incident Acknowldeged':
        'This email is sent to a subscriber when an incident is acknowledged.',
    'Subscriber Incident Resolved':
        'This email is sent to a subscriber when an incident is resolved.',
};
