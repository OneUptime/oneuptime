...
export class ProfileSetting extends Component {
  ...
  componentDidUpdate(prevProps) {
    const prevProfilePic =
      prevProps.profileSettings && prevProps.profileSettings.data && prevProps.profileSettings.data.profilePic
        ? prevProps.profileSettings.data.profilePic
        : null
    const currentProfilePic =
      this.props.profileSettings && this.props.profileSettings.data && this.props.profileSettings.data.profilePic
        ? this.props.profileSettings.data.profilePic
        : null
  ...
  submitForm = values => {
    ...
    if (initialAlertPhoneNumber !== alertPhoneNumber && !verified && !sendVerificationSMSError && !verifySMSCodeError) {
      setInitPhoneVerification(true)
        ...
        <div className='Box-root'>
          <div className='bs-ContentSection-content Box-root Box-divider--surface-bottom-1 Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween Padding-horizontal--20 Padding-vertical--16'>
            <div className='Box-root'>
              ...
              <p>
                <span>Change your email, password, profile picture and more.</span>
              </p>
            </div>
          </div>
          <form onSubmit={handleSubmit(this.submitForm)}>
                  ...
                  <fieldset className='bs-Fieldset'>
                    <div className='bs-Fieldset-rows'>
                      ...
                      <ShouldRender if={!verifiedEmail}>
                        <div className='bs-Fieldset-row' style={{ marginBottom: -5, marginTop: -5 }}>
                          ...
                          <div className='bs-Fieldset-fields'>
                            ...
                            {emailVerificationError && emailValue === profileSettingState.initAlertEmail && (
                              <span>
                                <br />
                                {emailVerificationError}
                              </span>
                      ...
                      <ShouldRender if={showPhoneVerifyTools}>
                        {profileSettingState.initPhoneVerificationNumber || (profileSettings.data && profileSettings.data.tempAlertPhoneNumber) ? (
                          <div className='bs-Fieldset-row' style={{ paddingBottom: '3px', paddingTop: '0px' }}>
                            <label className='bs-Fieldset-label'></label>
                            <div className='bs-Fieldset-fields'>
                              <span>
                                Your number
                          ...
                          <div className='bs-Fieldset-row' style={{ marginBottom: -5, marginTop: -5 }}>
                            ...
                            <div className='bs-Fieldset-fields'>
                              <button
                                ...
                                {sendVerificationSMSRequesting && (
                                  <div style={{ marginTop: '-20px', padding: '0px 52px' }}>
                                    {' '}
                                    <ListLoader />{' '}
                                  </div>
                                )}
                        ...
                        <ShouldRender if={!showSendVerification && !showError && !sendVerificationSMSRequesting}>
                          {!verifySMSCodeError && !sendVerificationSMSError && !sendVerificationSMSRequesting && (
                            <div className='bs-Fieldset-row'>
                              <label className='bs-Fieldset-label' style={{ flex: '30% 0 0' }}>
                                <span></span>
                              </label>
                                ...
                                <div className='Box-root Flex-flex Flex-alignItems--stretch Flex-direction--column Flex-justifyContent--flexStart'>
                                  <label className='Checkbox'>
                                    <div className='Box-root' style={{ paddingLeft: '5px' }}>
                                      <label>We have sent a code to {profileSettingState.initPhoneVerificationNumber} for verification.</label>
                                    </div>
                                  </label>
                                </div>
                              </div>
                          ...
                          <div className='bs-Fieldset-row'>
                            ...
                            <div>
                              ...
                              <button
                                ...
                                {!sendVerificationSMSRequesting && resendTimer && resendTimer > 0 ? (
                                  <span>
                            ...
                            <div className='Box-root Flex-flex Flex-alignItems--stretch Flex-direction--column Flex-justifyContent--flexStart'>
                              <label className='Checkbox'>
                                <div className='Box-root' style={{ paddingLeft: '5px', color: 'green' }}>
                                  <label>Verification successful, this number has been updated.</label>
                                </div>
                              </label>
                            </div>
                          </div>
                      ...
                      <div className='bs-Fieldset-row'>
                        ...
                        <div className='bs-Fieldset-fields'>
                          ...
                          <ShouldRender if={profilePic || this.props.fileUrl}>{profileImage}</ShouldRender>
                        </div>
                      </div>
                      <div className='bs-Fieldset-row'>
            ...
            <div className='bs-ContentSection-footer bs-ContentSection-content Box-root Box-background--white Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween Padding-horizontal--20 Padding-vertical--12'>
              ...
              <div>
                <button className='bs-Button bs-Button--blue' disabled={profileSettings && profileSettings.requesting} type='submit'>
