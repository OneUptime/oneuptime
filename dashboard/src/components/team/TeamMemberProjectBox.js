...
const TeamMemberProjectBox = (props) => (
    <div className="Box-root">
        <div className="ContentHeader Box-root Box-background--white Box-divider--surface-bottom-1 Flex-flex Flex-direction--column Padding-horizontal--20 Padding-vertical--16">
            <div className="Box-root Flex-flex Flex-direction--row Flex-justifyContent--spaceBetween">
                ...
                <div className="ContentHeader-end Box-root Flex-flex Flex-alignItems--center Margin-left--16">
                    <div className="Box-root">
                        <RenderIfSubProjectAdmin subProjectId={props.teamMembers._id}>
                            <button
        ...
        <div className="bs-Tail bs-Tail--separated bs-Tail--short">
            ...
            <ShouldRender if={props.team.teamdelete.error}>
                <div className="bs-Tail-copy">
                    <div className="Box-root Flex-flex Flex-alignItems--stretch Flex-direction--row Flex-justifyContent--flexStart" style={{ marginTop: '10px' }}>
                        ...
                        <div className="Box-root">
                            <span style={{ color: 'red' }}>{props.team.teamdelete.error}</span>
                        </div>
            ...
            <ShouldRender if={props.team.teamUpdateRole.error}>
                <div className="bs-Tail-copy">
                    <div className="Box-root Flex-flex Flex-alignItems--stretch Flex-direction--row Flex-justifyContent--flexStart" style={{ marginTop: '10px' }}>
                        ...
                        <div className="Box-root">
                            <span style={{ color: 'red' }}>{props.team.teamUpdateRole.error}</span>
                        </div>
            ...
            <ShouldRender if={!props.team.teamdelete.error && !props.team.teamUpdateRole.error}>
                <div className="bs-Tail-copy">
                    <span>
