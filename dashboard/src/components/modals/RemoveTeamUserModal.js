...
class RemoveTeamUserModal extends Component {
  ...
  render() {
    const { teamUserDelete, closeModal, data, resetTeamDelete, deleting } = this.props
    return (
              ...
              <div className='bs-Modal-header'>
                ...
                <div className='bs-Modal-messages'>
                  <ShouldRender if={teamUserDelete.error}>
                    <p className='bs-Modal-message'>{teamUserDelete.error}</p>
                  </ShouldRender>
                </div>
              </div>
              <div className='bs-Modal-content'>
                <span className='Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--24 Text-typeface--base Text-wrap--wrap'>
                  Are you sure you want to remove {data.displayName ? data.displayName : 'this user'} from the team?
                </span>
              </div>
              <div className='bs-Modal-footer'>
                <div className='bs-Modal-footer-actions'>
                  ...
                  <button
                    ...
                    disabled={deleting}
                    type='button'
                    onClick={() => data.removeTeamMember(data.values)}>
...
const mapStateToProps = (state, props) => {
  const userId = props.data && props.data.values && props.data.values.userId ? props.data.values.userId : null
  return {
...
export default connect(mapStateToProps, mapDispatchToProps)(RemoveTeamUserModal)
