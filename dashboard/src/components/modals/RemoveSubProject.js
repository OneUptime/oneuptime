						...
						<div className="bs-Modal bs-Modal--medium">
							...
							<div className="bs-Modal-footer">
								<div className="bs-Modal-footer-actions">
									...
									<button id="removeSubProject" className="bs-Button bs-DeprecatedButton bs-Button--red" type="button" onClick={this.props.confirmThisDialog}>
										<span>Remove</span>
									</button>
								</div>
							</div>
...
export default RemoveSubProject;