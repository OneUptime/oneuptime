...
const mapStateToProps = (state, ownProps) => {
    return {
		...
		initialValues: state.monitorCategories.monitorCategoryList ?
			state.monitorCategories.monitorCategoryList.monitorCategories.filter(obj => obj._id === ownProps.data.monitorCategoryId)[0] : {}
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateMonitorCategoryForm);
