							...
							<div className="bs-Modal-header">
								<div className="bs-Modal-header-copy">
									<span className="Text-color--inherit Text-display--inline Text-fontSize--20 Text-fontWeight--medium Text-lineHeight--24 Text-typeface--base Text-wrap--wrap">
										<span>Add an extra seat to continue.</span>
									</span>
								</div>
							</div>
							<div className="bs-Modal-content">
								<span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--24 Text-typeface--base Text-wrap--wrap">
									You have reached the maximum limit of monitors that can be added with this plan.
									To add more monitors you have to add an extra seat which will cost you an extra user&apos;s cost.
									Press confirm to add a seat.
								</span>
							</div>
							<div className="bs-Modal-footer">
								<div className="bs-Modal-footer-actions">
									<ShouldRender if={this.props.error && !this.props.requesting}>
									...
									>
										{!this.props.requesting && <span>Confirm</span>}
										{this.props.requesting && <FormLoader />}
									</button>
								</div>
							</div>
						</div>
