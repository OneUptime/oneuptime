...
class EditIncidentPriority extends Component {
  ...
  submitForm(values) {
    ...
    this.props.updateIncidentPriority(this.props.currentProject._id, {
            ...
            <div className="bs-Modal bs-Modal--medium">
              ...
              <div className="bs-Modal-footer">
                <div className="bs-Modal-footer-actions">
                  <ShouldRender
                    if={
                      this.props.editIncidentPriority.error
                    }
                  >
...
export default connect(mapStateToProps, mapDispatchToProps)(EditIncidentPriorityForm);