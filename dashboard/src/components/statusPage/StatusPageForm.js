                            ...
                            <div className="ModalLayer-contents" tabIndex={-1} style={{ marginTop: 40 }}>
                                ...
                                <div className="bs-Modal-header">
                                    ...
                                    <div className="bs-Modal-messages">
                                        <ShouldRender if={this.props.statusPage.newStatusPage.error}>
                                            <p className="bs-Modal-message">{this.props.statusPage.newStatusPage.error}</p>
                                        </ShouldRender>
                                    </div>
                                </div>
                                <div className="bs-Modal-body">
                                    ...
                                    <div className="bs-Modal-footer">
                                        <div className="bs-Modal-footer-actions">
                                            <button
                                                className={`bs-Button bs-DeprecatedButton ${this.props.statusPage.newStatusPage.requesting && 'bs-is-disabled'}`}
                                                type="button"
                                            ...
                                            <button
                                                ...
                                                className={`bs-Button bs-DeprecatedButton bs-Button--blue ${this.props.statusPage.newStatusPage.requesting && 'bs-is-disabled'}`}
                                                type="save"
                                                disabled={this.props.statusPage.newStatusPage.requesting}
                                            >
                                                <ShouldRender if={this.props.statusPage.newStatusPage.requesting}>
                                                    <Spinner />
                                                </ShouldRender>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateStatusPageForm);
