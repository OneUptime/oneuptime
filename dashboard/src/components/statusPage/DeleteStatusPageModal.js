...
export function DeleteStatusPageModal(props) {
...
const mapStateToProps = state => {
    return {
        isRequesting: state.statusPage && state.statusPage.deleteStatusPage && state.statusPage.deleteStatusPage.requesting,
        error: state.statusPage && state.statusPage.deleteStatusPage && state.statusPage.deleteStatusPage.error,
    }
}
