        ...
        <div className="ContentHeader Box-root Box-background--white Box-divider--surface-bottom-1 Flex-flex Flex-direction--column Padding-horizontal--20 Padding-vertical--16">
                ...
                <div className="Box-root Flex-flex Flex-direction--row Flex-justifyContent--spaceBetween">
                    ...
                    <div className="ContentHeader-end Box-root Flex-flex Flex-alignItems--center Margin-left--16">
                        <div className="Box-root">
                            <RenderIfSubProjectAdmin subProjectId={props.subProjectStatusPage._id}>
                                <button id={`btnCreateStatusPage_${props.subProjectName}`} onClick={()=>{props.openModal({
                                            id: props.statusPageModalId,
                                            content: DataPathHoC(StatusPageForm, { projectId: props.subProjectStatusPage._id })
                ...
                <div className="Box-root Flex-flex Flex-alignItems--stretch Flex-direction--row Flex-justifyContent--flexStart">
                    <div className="Box-root Margin-right--8">
                        <button
                            ...
                            type="button"
                            onClick={()=>props.prevClicked(props.subProjectStatusPage._id, props.skip, props.limit)}
                        >
                    ...
                    <div className="Box-root">
                        <button
                            ...
                            type="button"
                            onClick={()=>props.nextClicked(props.subProjectStatusPage._id, props.skip, props.limit)}
                        >
                            <div className="Button-fill bs-ButtonLegacy-fill Box-root Box-background--white Flex-inlineFlex Flex-alignItems--center Flex-direction--row Padding-horizontal--8 Padding-vertical--4">
                                <span className="Button-label Text-color--default Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--noWrap">
                                    <span>Next</span>
