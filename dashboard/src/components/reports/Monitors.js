...
class Monitors extends Component {
  ...
  componentDidMount() {
    const { getActiveMonitors, currentProject, startDate, endDate } = this.props;
  ...
  UNSAFE_componentWillReceiveProps(nextProps, prevState) {
    ...
    if (startDate !== this.props.startDate || endDate !== this.props.endDate) {
      getActiveMonitors(currentProject, startDate, endDate, this.state.skip, 10);
    }
  ...
  handleNext(event) {
    ...
    const { currentProject, startDate, endDate, getActiveMonitors } = this.props;
  ...
  render() {
    let canNext = (this.props.activeMonitors && this.props.activeMonitors.count) && (this.props.activeMonitors.count > (this.state.skip + this.state.limit)) ? true : false;
    let canPrev = (this.props.activeMonitors && this.state.skip <= 0) ? false : true;

    if (this.props.activeMonitors && (this.props.activeMonitors.requesting || !this.props.activeMonitors.members)) {
      canNext = false;
      canPrev = false;
    }
        ...
        <div className="Box-root Flex-flex Flex-alignItems--center Flex-justifyContent--spaceBetween">
          <div className="Box-root Flex-flex Flex-alignItems--center Padding-all--20">
            <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">
              <span>
                <span className="Text-color--inherit Text-display--inline Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-typeface--base Text-wrap--wrap">{this.props.activeMonitors && this.props.activeMonitors.count ? this.props.activeMonitors.count + (this.props.activeMonitors && this.props.activeMonitors.count > 1 ? ' Monitors' : ' Monitor') : null}</span>
              </span>
            </span>
          </div>
