    ...
    render() {
        const subProject =
            ...
            this.props.subProjects.filter(
                subProject => subProject._id === this.props.incident.projectId._id // The Id is being looked for during filtering. What is was seeing is an object that contains the ID
            )[0];            
