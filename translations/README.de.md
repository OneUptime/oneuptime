...
- **VMware** — vCenter, ESXi-Hosts, virtuelle Maschinen, Datastores, Cluster, Ressourcenpools und vSAN. [Dokumentation →](/App/FeatureSet/Docs/Content/en/telemetry/vmware.md)
