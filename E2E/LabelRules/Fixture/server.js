/* Offline fixture server for the actual label rule pages. No app/API server needed. */
const fs = require("fs");
...
const output = path.join(
  repository,
  "output/playwright/label-rule-import-export/fixture",
);
const port = Number(process.env.LABEL_RULE_FIXTURE_PORT || 4207);
const config = createConfig({
  serviceName: "label-rule-fixture",
  publicPath: "/dist/",
...
async function main() {
  ...
  server.listen(port, "127.0.0.1", () => {
    console.log(
      `Label rule fixture ready at http://127.0.0.1:${port}/dashboard/10000000-0000-4000-8000-000000000001/network-devices/settings/label-rules`,
    );
  });
